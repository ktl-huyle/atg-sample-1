...
public class generateApiKeyForTestAutomation {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on button GenerateAPIKey"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_GenerateAPIKey'))
