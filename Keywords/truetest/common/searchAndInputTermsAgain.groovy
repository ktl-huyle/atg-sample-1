...
public class searchAndInputTermsAgain {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on input SearchTerm"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_AjaxOrderItemDisplayView/input_SearchTerm'))
        
        "Step 2: Enter input value in input SearchTerm -> Navigate to page '/SearchDisplay'"
        
        WebUI.setText(findTestObject('AI-Generated/Page_AjaxOrderItemDisplayView/input_SearchTerm'), data['input_SearchTerm'])
        
        "Step 3: Click on input SearchTerm"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_SearchDisplay/input_SearchTerm'))
        
        "Step 4: Enter input value in input SearchTerm"
