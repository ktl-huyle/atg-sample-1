...
public class fillShippingDetailsAndCompleteOrder {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 3: Click on button ContinueToShipping -> Navigate to page 'shipping-address checkout#checkout/shipping-address'"
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_shipping_address_checkout/input_FirstName'), data['input_FirstName'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_shipping_address_checkout/input_LastName'), data['input_LastName'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_shipping_address_checkout/input_Address'), data['input_Address'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_shipping_address_checkout/input_ZipCode'), data['input_ZipCode'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_shipping_address_checkout/input_City'), data['input_City'])
        
        "Step 14: Click on input State"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_shipping_address_checkout/input_State'))
        
        "Step 15: Enter input value in input State"
        
        WebUI.setText(findTestObject('AI-Generated/Page_shipping_address_checkout/input_State'), data['input_State'])
        
        "Step 16: Click on input Phone"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_shipping_address_checkout/input_Phone'))
        
        "Step 17: Enter input value in input Phone"
        
        WebUI.setText(findTestObject('AI-Generated/Page_shipping_address_checkout/input_Phone'), data['input_Phone'])
        
        "Step 18: Click on button ContinueToPayment -> Navigate to page 'payment checkout#checkout/payment'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_shipping_address_checkout/button_ContinueToPayment'))
        
        "Step 19: Click on button CompleteOrder"
