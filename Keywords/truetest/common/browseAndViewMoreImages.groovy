...
public class browseAndViewMoreImages {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/image_productImages_2', ['image_productImages_nthChild': data['image_productImages_nthChild'], 'image_productImages_class': data['image_productImages_class'], 'image_productImages_internalRoleImgName': data['image_productImages_internalRoleImgName']]))
        
        "Step 2: Click on image productImages (ProductImage3)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/image_productImages_2"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/image_productImages_2', ['image_productImages_nthChild': data['image_productImages_nthChild_1'], 'image_productImages_class': data['image_productImages_class_1'], 'image_productImages_internalRoleImgName': data['image_productImages_internalRoleImgName_1']]))
        
        "Step 3: Click on image productImages (ProductImage2)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/image_productImages_2"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/image_productImages_2', ['image_productImages_nthChild': data['image_productImages_nthChild_2'], 'image_productImages_class': data['image_productImages_class_2'], 'image_productImages_internalRoleImgName': data['image_productImages_internalRoleImgName_2']]))
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/image_productImages', ['image_productImages_nthChild': data['image_productImages_nthChild_3'], 'image_productImages_class': data['image_productImages_class_3'], 'image_productImages_divNthChild': data['image_productImages_divNthChild']]))
        
        "Step 6: Click on image productImages (ProductMainImage5)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_home/image_productImages"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_home/image_productImages', ['image_productImages_nthChild': data['image_productImages_nthChild_4'], 'image_productImages_class': data['image_productImages_class_4'], 'image_productImages_divNthChild': data['image_productImages_divNthChild_1']]))
    }
