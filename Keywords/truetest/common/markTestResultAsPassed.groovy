...
public class markTestResultAsPassed {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 3: Click on button testResultActions (TestResultDetails9) -> Navigate to page 'team/*/project/*/executions/*/test-result/*'"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/button_testResultActions"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/button_testResultActions', ['button_testResultActions_class': data['button_testResultActions_class_2'], 'button_testResultActions_internalRoleButtonName': data['button_testResultActions_internalRoleButtonName_2']]))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        data['button_testResultActions_class_2'] = testData.getValue('button_testResultActions_class_2', rowIndex)
        ...
        data['button_testResultActions_internalRoleButtonName_2'] = testData.getValue('button_testResultActions_internalRoleButtonName_2', rowIndex)
    ...
    private static def execute_without_data_source() {
        ...
        data['button_testResultActions_class_2'] = 'default_data'
        ...
        data['button_testResultActions_internalRoleButtonName_2'] = 'default_data'
        execute_functional_method(data)
    }
