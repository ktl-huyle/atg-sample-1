...
public class scheduleTestRunForTeamProject {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 3: Click on link testManagementOptions (ScriptRepositories3)"
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testManagementOptions', ['link_testManagementOptions_nthChild': data['link_testManagementOptions_nthChild'], 'link_testManagementOptions_internalRoleLinkName': data['link_testManagementOptions_internalRoleLinkName']]))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        data['link_testManagementOptions_internalRoleLinkName'] = testData.getValue('link_testManagementOptions_internalRoleLinkName', rowIndex)
        data['link_testManagementOptions_nthChild'] = testData.getValue('link_testManagementOptions_nthChild', rowIndex)
    ...
    private static def execute_without_data_source() {
        ...
        data['link_testManagementOptions_internalRoleLinkName'] = 'default_data'
        data['link_testManagementOptions_nthChild'] = 'default_data'
