...
public class navigateThumbnailImagesAndCloseErrors {
    ...
    private static def execute_functional_method(Map data) {
        ...
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/image_thumbnail"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/image_thumbnail', ['image_thumbnail_internalRoleImgName': data['image_thumbnail_internalRoleImgName']]))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['image_thumbnail_internalRoleImgName'] = testData.getValue('image_thumbnail_internalRoleImgName', rowIndex)
        execute_functional_method(data)
    }
    
    private static def execute_without_data_source() {
        Map data = [:]
        data['image_thumbnail_internalRoleImgName'] = 'default_data'
        execute_functional_method(data)
    }
