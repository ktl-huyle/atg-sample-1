...
public class scheduleTestRunAndConfigureEnvironment {
    ...
    private static def execute_functional_method(Map data) {
        ...
        "Step 25: Click on button closeAction (Close3)"
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/button_closeAction', ['button_closeAction_class': data['button_closeAction_class']]))
        
        "Step 26: Click on button closeAction (AlertClose)"
        
        // Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/button_closeAction"
        WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/button_closeAction', ['button_closeAction_class': data['button_closeAction_class_1']]))
    ...
    private static def execute_with_data_source(String datasource, int rowIndex) {
        ...
        Map data = [:]
        data['button_closeAction_class'] = testData.getValue('button_closeAction_class', rowIndex)
        data['button_closeAction_class_1'] = testData.getValue('button_closeAction_class_1', rowIndex)
    ...
    private static def execute_without_data_source() {
        Map data = [:]
        data['button_closeAction_class'] = 'default_data'
        data['button_closeAction_class_1'] = 'default_data'
