...
public class editTeamProjectDescription {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on button object -> Navigate to page 'team/*/project/*/test-project/*'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_setup/button_object'))
        
        "Step 2: Click on link scriptRepositories -> Navigate to page 'team/*/project/*/*'"
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_katalonDemoProject'))
