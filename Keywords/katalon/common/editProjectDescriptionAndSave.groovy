...
public class editProjectDescriptionAndSave {
    
    private static def execute_functional_method(Map data) {
        
        "Step 1: Click on button alert -> Navigate to page 'team/*/project/*/test-project/*'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_git_test_project_setup/button_alert'))
        ...
        "Step 3: Click on link teamProjectTestProject -> Navigate to page 'team/*/project/*/test-project/*'"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_project/link_teamProjectTestProject_1'))
