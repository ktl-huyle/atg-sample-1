...
public class connectRepositoryForTesting {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_settings_test_environment_installation/input_object'))
        
        "Step 5: Click on input object"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_settings_test_environment_installation/input_object'))
        
        "Step 6: Click on button connect"
        
        WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_settings_test_environment_installation/button_connect'))
        
        "Step 7: Click on button connect"
