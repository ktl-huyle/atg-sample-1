...
import katalon.common.createApiKeyForIntegration
...
"Step 6: Create a new API key for integration with the application"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Create and Copy API Keys for Application Integration_visual_checkpoint')
