...
"Step 2: Create a new API key for integration with the application"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Generate New API Key for Application Integration_visual_checkpoint')
