...
import truetest.common.generateApiKeyForAccess
...
generateApiKeyForAccess.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Manage Multiple API Keys in User Settings_visual_checkpoint')
