...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 4-Click on link executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 5-Click on link executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 6-Click on link schedules - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 7-Click on link settings.png')

"Step 8: Click on link testEnvironments"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_testEnvironments'))

WebUI.takeScreenshot(reportLocation + '/TC46/Step 8-Click on link testEnvironments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 9-Click on link scriptRepositories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 10-Click on link executions - Navigate to page teamprojecttest-runs.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC46-Navigate and Verify Team Project Test Runs_visual_checkpoint')
