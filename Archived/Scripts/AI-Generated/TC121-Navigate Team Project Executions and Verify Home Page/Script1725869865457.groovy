...
WebUI.takeScreenshot(reportLocation + '/TC121/Step 4-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC121/Step 5-Click on link requests - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC121/Step 6-Click on item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC121/Step 7-Click on item object2 - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC121-Navigate Team Project Executions and Verify Home Page_visual_checkpoint')
