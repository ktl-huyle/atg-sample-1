...
"Step 3: Click on input filterByName"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_grid/input_filterByName'))

WebUI.takeScreenshot()

"Step 4: Enter input value in input filterByName"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_team_project_grid/input_filterByName'), input_filterByName)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC51-Filter Test Runs by Name_visual_checkpoint')
