...
"Step 4: Click on item testCasesNth2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-reports/test-maintenance/active?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_reports_test_maintenance_active/item_testCasesNth2'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Navigate Through Test Cases and Defects_visual_checkpoint')
