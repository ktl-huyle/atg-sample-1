...
WebUI.takeScreenshot(reportLocation + '/TC111/Step 4-Click on link katalonStudioLicenses - Navigate to page userlicense.png')
...
WebUI.takeScreenshot(reportLocation + '/TC111/Step 5-Click on td kseNodeLocked.png')
...
WebUI.takeScreenshot(reportLocation + '/TC111/Step 6-Click on span kseNodeLocked.png')
...
WebUI.takeScreenshot(reportLocation + '/TC111/Step 7-Click on td kseNodeLocked2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC111/Step 8-Click on link subscribe - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC111-Manage User Settings and Katalon Studio Licenses_visual_checkpoint')
