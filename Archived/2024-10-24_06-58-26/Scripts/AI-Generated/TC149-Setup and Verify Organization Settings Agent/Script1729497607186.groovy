...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 4-Click on link AgentSetup2 - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 5-Click on link TestEnvironments - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 6-Click on link agentSettings MyAgent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 8-Click on link AgentSetup - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 9-Click on link TestEnvironments - Navigate to page organizationsettingsagent.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC149-Setup and Verify Organization Settings Agent_visual_checkpoint')
