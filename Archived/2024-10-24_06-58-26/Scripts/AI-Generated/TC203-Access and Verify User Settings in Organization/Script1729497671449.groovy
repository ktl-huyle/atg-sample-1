...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 4-Click on div WelcomeToThermoFisher.png')
...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 5-Click on div WelcomeToThermoFisher.png')
...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 6-Click on div GridContainer.png')

"Step 7: Click on span organizationSelect (SelectOrganization)"
...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 7-Click on span organizationSelect SelectOrganization.png')

"Step 8: Click on span organizationSelect (SelectOrganizationChina)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/span_organizationSelect'))

WebUI.takeScreenshot(reportLocation + '/TC203/Step 8-Click on span organizationSelect SelectOrganizationChina.png')
...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 9-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 10-Click on div Backdrop.png')

"Step 11: Click on button userButtons (Sabrina)"
...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 11-Click on button userButtons Sabrina.png')
...
WebUI.takeScreenshot(reportLocation + '/TC203/Step 12-Click on link UserSettings - Navigate to page usersettings.png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC203-Access and Verify User Settings in Organization_visual_checkpoint')
