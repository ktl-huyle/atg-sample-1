...
"Step 4: Click on pre failedTestCase (ErrorSendMessage)"
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 4-Click on pre failedTestCase ErrorSendMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 8-Click on div InfoSidebarCloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 9-Click on div UnderTopNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 10-Click on button organizationSelection SelectOrganization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 11-Click on div UnderTopNavbar - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC47-Manage Failed Test Case Thumbnails in Team Project_visual_checkpoint')
