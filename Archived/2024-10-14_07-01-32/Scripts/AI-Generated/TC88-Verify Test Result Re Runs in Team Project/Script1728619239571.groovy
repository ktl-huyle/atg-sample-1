...
WebUI.takeScreenshot(reportLocation + '/TC88/Step 4-Click on button TestResultDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC88/Step 5-Click on button TestResultDetails2 - Navigate to page teamprojectexecutionstest-result.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC88-Verify Test Result Re Runs in Team Project_visual_checkpoint')
