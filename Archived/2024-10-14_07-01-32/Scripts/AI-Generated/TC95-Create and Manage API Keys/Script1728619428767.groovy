...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 4-Click on button apiKeyActions CellButton2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 5-Click on button apiKeyActions ShowApiKey2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 6-Click on button copyToClipboard CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 7-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 9-Click on button apiKeyActions ShowApiKey3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 10-Click on button copyToClipboard CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 11-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 12-Click on button NidhiKachhadiya.png')
...
WebUI.takeScreenshot(reportLocation + '/TC95/Step 13-Click on link SignOut - Navigate to page logout.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC95-Create and Manage API Keys_visual_checkpoint')
