...
"Step 4: Click on pre failedTestCase (FailedTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on pre failedTestCase FailedTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 8-Click on button Close - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC30-Verify Team Project Executions with Failed Test Cases_visual_checkpoint')
