...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 4-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 5-Click on link RunFrequency2 - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 6-Click on button TestExecutionFrequency.png')
...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 7-Click on link Dashboard - Navigate to page teamproject.png')

"Step 8: Click on link Reports7 -> Navigate to page 'team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Reports3'))

WebUI.takeScreenshot(reportLocation + '/TC103/Step 8-Click on link Reports7 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 9-Click on link RunFrequency2 - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC103-View and Verify Test Execution Reports_visual_checkpoint')
