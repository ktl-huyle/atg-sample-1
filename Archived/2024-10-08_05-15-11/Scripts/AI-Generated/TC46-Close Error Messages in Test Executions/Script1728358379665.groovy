...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 4-Click on pre errorMessages ErrorSendMessage.png')

"Step 5: Click on div ThumbnailImage"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_ThumbnailImage_2'))

WebUI.takeScreenshot(reportLocation + '/TC46/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 8-Click on div InfoSidebarCloseButton.png')

"Step 9: Click on div UnderTopNavbar"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_UnderTopNavbar'))

WebUI.takeScreenshot(reportLocation + '/TC46/Step 9-Click on div UnderTopNavbar.png')

"Step 10: Click on button organizationSelection (SelectOrganization)"
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 10-Click on button organizationSelection SelectOrganization.png')

"Step 11: Click on div UnderTopNavbar -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_UnderTopNavbar'))

WebUI.takeScreenshot(reportLocation + '/TC46/Step 11-Click on div UnderTopNavbar - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC46-Close Error Messages in Test Executions_visual_checkpoint')
