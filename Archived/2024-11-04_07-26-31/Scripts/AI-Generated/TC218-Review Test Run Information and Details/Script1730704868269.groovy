...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 4-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 5-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 6-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 7-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 8-Click on div testRunCells UntitledTestRun4053.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 9-Click on div testRunCells UntitledTestRun4054.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 10-Click on header testRunHeaders UntitledTestRun4054.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 11-Click on button Details.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 12-Click on button Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 13-Click on div dynamicObject PopoverBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 14-Click on div untitledTestRunLabel UntitledTestRunLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 15-Click on div untitledTestRunLabel UntitledTestRunLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 16-Click on div untitledTestRunLabel UntitledTestRunLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 17-Click on div Paper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 18-Click on div Paper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 19-Click on button Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 20-Click on div dynamicObject PopoverBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 21-Click on div Paper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 22-Click on button SessionsTab.png')
...
WebUI.takeScreenshot(reportLocation + '/TC218/Step 23-Click on button FailedTestResultsTab - Navigate to page .png')

"Step 24: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC218-Review Test Run Information and Details_visual_checkpoint')
