...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 4-Click on link projectLinks BhtIp - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 5-Click on link Tests3 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 6-Click on div testCases UploadedData.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 7-Click on span treeSwitchers CaretDown.png')

"Step 8: Click on span treeSwitchers (TreeSwitcher4)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers', ['span_treeSwitchers_class': span_treeSwitchers_class_1, 'span_treeSwitchers_nthChild': span_treeSwitchers_nthChild, 'span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC233/Step 8-Click on span treeSwitchers TreeSwitcher4.png')

"Step 9: Click on span treeSwitchers (TreeSwitcher5)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers', ['span_treeSwitchers_class': span_treeSwitchers_class_2, 'span_treeSwitchers_nthChild': span_treeSwitchers_nthChild_1, 'span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild_1]))

WebUI.takeScreenshot(reportLocation + '/TC233/Step 9-Click on span treeSwitchers TreeSwitcher5.png')

"Step 10: Click on span treeSwitchers (TreeSwitcher6)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers', ['span_treeSwitchers_class': span_treeSwitchers_class_3, 'span_treeSwitchers_nthChild': span_treeSwitchers_nthChild_2, 'span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild_2]))

WebUI.takeScreenshot(reportLocation + '/TC233/Step 10-Click on span treeSwitchers TreeSwitcher6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 11-Click on div testCases CountyDemographics.png')

"Step 12: Click on link testCaseDetails (InsuranceDemographics) -> Navigate to page 'team/*/project/*/test-design/test-cases/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/link_testCaseDetails', ['link_testCaseDetails_internalRoleLinkName': link_testCaseDetails_internalRoleLinkName, 'link_testCaseDetails_team_id': link_testCaseDetails_team_id, 'link_testCaseDetails_test_cases_id': link_testCaseDetails_test_cases_id, 'link_testCaseDetails_project_id': link_testCaseDetails_project_id]))

WebUI.takeScreenshot(reportLocation + '/TC233/Step 12-Click on link testCaseDetails InsuranceDemographics - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 13-Click on link Reports2 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 14-Click on link TestRuns5 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 15-Click on link executionLinks Execution - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 16-Click on button PushToXray.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 17-Click on div SelectOptions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 18-Click on button CloseDialog.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 19-Click on link tests Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 20-Click on link Reports2 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC233/Step 21-Click on link TestRuns5 - Navigate to page teamprojectexecutions.png')

"Step 22: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC233-View Test Case Details and Reports_visual_checkpoint')
