...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 4-Click on link Reports2 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 5-Click on link TestRuns5 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 6-Click on button SelectOrganization - Navigate to page teamproject.png')

"Step 7: Click on link Reports3 -> Navigate to page 'team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Reports3_2'))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 7-Click on link Reports3 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 8-Click on link TestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 9-Click on button CustomFields.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 10-Click on div TestOptions.png')

"Step 11: Click on button rowActions (Row591)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/button_rowActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/button_rowActions', ['button_rowActions_trNthChild': button_rowActions_trNthChild, 'button_rowActions_internalRoleRowName': button_rowActions_internalRoleRowName]))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 11-Click on button rowActions Row591.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 12-Click on link executionLinks Execution591.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 13-Click on input SearchTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 14-Click on link Overview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 15-Click on link Executions7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 16-Click on body object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 17-Click on item Running.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 18-Click on input Executor.png')

"Step 19: Click on div historyInfo (HistorySchedule)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/div_historyInfo"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_historyInfo', ['div_historyInfo_internalText': div_historyInfo_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 19-Click on div historyInfo HistorySchedule.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 20-Click on input DateRange.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 21-Click on button gridCellActions GridCell20.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 22-Click on input DateRange.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 23-Click on button gridCellActions GridCell1.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions', ['button_gridCellActions_class': button_gridCellActions_class_2, 'button_gridCellActions_nth': button_gridCellActions_nth_1, 'button_gridCellActions_internalRoleGridcellName': button_gridCellActions_internalRoleGridcellName_1]))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 24-Click on button gridCellActions GridCell20.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 25-Click on input SelectAllRows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 26-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 27-Click on button Confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 28-Click on input DateRange2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 29-Click on button monthNavigation PreviousMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 30-Click on button monthNavigation PreviousMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 31-Click on button gridCellActions GridCell12.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions', ['button_gridCellActions_class': button_gridCellActions_class_4, 'button_gridCellActions_nth': button_gridCellActions_nth_2, 'button_gridCellActions_internalRoleGridcellName': button_gridCellActions_internalRoleGridcellName_2]))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 32-Click on button gridCellActions GridCell202.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 33-Click on input SelectAllRows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 34-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 35-Click on button Confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 36-Click on link Reports4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 37-Click on link TestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 38-Click on link Executions7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 39-Click on input SelectRow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 40-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 41-Click on button Confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 42-Click on header testRunHeaders UntitledTestRun.png')

"Step 43: Click on button closeAlerts (CloseAlert)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/button_closeAlerts"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/button_closeAlerts', ['button_closeAlerts_class': button_closeAlerts_class]))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 43-Click on button closeAlerts CloseAlert.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 44-Click on link Reports3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 45-Click on link TestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 46-Click on button SelectOrganization - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 47-Click on link Executions8 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 48-Click on i TimeIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 49-Click on button monthNavigation PreviousMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 50-Click on button monthNavigation PreviousMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 51-Click on button gridCellActions GridCell12.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 52-Click on button monthNavigation NextMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 53-Click on button monthNavigation NextMonth.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions', ['button_gridCellActions_class': button_gridCellActions_class_6, 'button_gridCellActions_nth': button_gridCellActions_nth_3, 'button_gridCellActions_internalRoleGridcellName': button_gridCellActions_internalRoleGridcellName_3]))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 54-Click on button gridCellActions GridCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 55-Click on input Executor.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 56-Click on body object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 57-Click on div RunningStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 58-Click on input SelectAllRows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 59-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 60-Click on button Confirm.png')

"Step 61: Click on link dynamicLinks (Calendar)"
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 61-Click on link dynamicLinks Calendar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 62-Click on link moreOptions MoreDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 63-Click on span ImportingStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 64-Click on link Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 65-Click on link TestResults5 - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 66-Click on link Files2 - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 67-Click on link Reports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 68-Click on span OrganizationName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 69-Click on link BOrganization - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 70-Click on link Reports3 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 71-Click on link TestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 73-Click on button SelectOrganization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 74-Click on link BOrganizationIP - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 75-Click on link Executions8 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 76-Click on input DateRange.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/button_gridCellActions', ['button_gridCellActions_class': button_gridCellActions_class_7, 'button_gridCellActions_nth': button_gridCellActions_nth_4, 'button_gridCellActions_internalRoleGridcellName': button_gridCellActions_internalRoleGridcellName_4]))

WebUI.takeScreenshot(reportLocation + '/TC244/Step 77-Click on button gridCellActions GridCell2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 78-Click on body object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 79-Click on div dynamicObject object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 80-Click on i ExecutorIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 81-Click on button OpenDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 82-Enter input value in input Executor.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 83-Click on div UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 84-Click on header testRunHeaders UntitledTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 85-Click on button Icon2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 86-Click on link Executions9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 87-Click on link Executions9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 88-Click on link Reports2 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 89-Click on link TestRuns5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 91-Click on button AugustDate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 92-Click on button AugustDate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 93-Click on button ApplyFilter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 94-Click on div TestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 95-Click on link Executions - Navigate to page teamproject.png')

"Step 96: Click on link dynamicLinks (Calendar)"
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 96-Click on link dynamicLinks Calendar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 97-Click on link moreOptions MoreDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 98-Click on div GridBackground.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 99-Click on link moreOptions MoreDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 100-Click on link Reports2 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC244/Step 101-Click on link TestRuns5 - Navigate to page teamprojectexecutions.png')

"Step 102: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC244-View Statistical Data for Test Runs_visual_checkpoint')
