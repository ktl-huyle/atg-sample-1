...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 4-Click on button userActions NidhiKachhadiya.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 5-Click on link ViewProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 6-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 7-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 8-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 9-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 10-Click on link testOpsHomepage TestOpsHomepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 11-Click on div organizationLinks OrganizationLink - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 12-Click on link Executions3 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 13-Click on link Settings2 - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 14-Click on link Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC206/Step 15-Click on button NotificationAction - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC206-View User Profile and Settings in Organization Home_visual_checkpoint')
