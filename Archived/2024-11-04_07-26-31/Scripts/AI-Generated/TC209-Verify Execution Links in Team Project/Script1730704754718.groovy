...
WebUI.takeScreenshot(reportLocation + '/TC209/Step 4-Click on link executionLinks Execution20350.png')
...
WebUI.takeScreenshot(reportLocation + '/TC209/Step 5-Click on link executionLinks Execution20348.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC209-Verify Execution Links in Team Project_visual_checkpoint')
