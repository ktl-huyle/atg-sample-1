...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 4-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 5-Click on link Reports - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 6-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 7-Click on link Reports - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 8-Click on link TestRuns3 - Navigate to page teamprojectexecutions.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC211-Verify Test Design and Reports_visual_checkpoint')
