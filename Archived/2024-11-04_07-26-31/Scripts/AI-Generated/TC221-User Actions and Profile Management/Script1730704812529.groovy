...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 4-Click on div qualityEngineer QualityEngineer - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 5-Click on button userActions AR.png')
...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 6-Click on div ModalBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 7-Click on div ModalBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 8-Click on div ModalBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 9-Click on div EmailAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 10-Click on div EmailAddress.png')
...
WebUI.takeScreenshot(reportLocation + '/TC221/Step 11-Click on div Backdrop - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC221-User Actions and Profile Management_visual_checkpoint')
