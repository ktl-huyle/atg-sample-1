...
WebUI.takeScreenshot(reportLocation + '/TC241/Step 4-Click on button runActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC241/Step 5-Click on span R5Maintenance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC241/Step 6-Click on button runActions Run.png')
...
WebUI.takeScreenshot(reportLocation + '/TC241/Step 7-Click on link Reports - Navigate to page teamproject.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC241-Run Actions in Team Project_visual_checkpoint')
