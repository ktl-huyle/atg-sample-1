...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 4-Click on div historyInfo historyInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 5-Click on div historyInfo historyInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 6-Click on link showDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 7-Click on div sessionInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 8-Click on div sessionInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 9-Click on div dynamicObject popoverBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 10-Click on link showDetails.png')

"Step 11: Click on p sessionCount (sessions)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/p_sessionCount"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/p_sessionCount', ['p_sessionCount_class': p_sessionCount_class]))

WebUI.takeScreenshot(reportLocation + '/TC263/Step 11-Click on p sessionCount sessions.png')

"Step 12: Click on p sessionCount (sessionCount)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/p_sessionCount"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/p_sessionCount', ['p_sessionCount_class': p_sessionCount_class_1]))

WebUI.takeScreenshot(reportLocation + '/TC263/Step 12-Click on p sessionCount sessionCount.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 13-Click on div dynamicObject popoverBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 15-Click on link gitRepository - Navigate to page teamprojecttest-projectgitedit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 16-Click on div branchInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 17-Click on div branchReference.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 18-Click on button save.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 19-Click on button closeDialog - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 20-Click on link testEnvironments - Navigate to page teamprojectagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 21-Click on link testCloud - Navigate to page team1515252project1534644agenttest-cloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 22-Click on div mainBody.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 23-Click on link executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 24-Click on link schedules - Navigate to page teamprojectgrid.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 25-Click on button scheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 26-Click on div nameLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 27-Enter input value in input name.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 28-Click on div testSuiteInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 29-Click on div testSuiteIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 30-Click on div testSuiteIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 31-Click on button closeDialog.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 32-Click on button scheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 33-Click on link refreshDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 34-Click on link refreshDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 35-Click on div selectIndicator.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 36-Click on div testSuiteInfo2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 37-Click on link refreshDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 38-Click on link refreshDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 39-Click on button testSuiteCollection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 40-Click on button testSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 41-Click on div customSelectValue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 42-Click on div KatalonCloudOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 43-Click on div SelectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 44-Click on div customSelectValue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 45-Click on div EHSTestAutomation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 46-Click on input TextInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 47-Click on div testSuiteInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 48-Click on small SelectExistingScript - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 49-Click on link gitRepository - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 50-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 51-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 52-Click on button Edit - Navigate to page teamprojecttest-projectgitedit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 53-Click on link Integrations - Navigate to page teamprojectintegrations.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 54-Click on div integrationTools CodelessAutomationTool.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationTools_3', ['div_integrationTools_class': div_integrationTools_class]))

WebUI.takeScreenshot(reportLocation + '/TC263/Step 55-Click on div integrationTools CodelessAutomationTool2.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationTools_3"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationTools_3', ['div_integrationTools_class': div_integrationTools_class_1]))

WebUI.takeScreenshot(reportLocation + '/TC263/Step 56-Click on div integrationTools CICDPipeline.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 57-Click on div AzureDevOpsPipelines.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 58-Click on input ReportFolder.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 59-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 60-Click on div ApiKeyControl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 61-Click on div CollapseWrapper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 62-Click on div Docker.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 63-Click on pre CodeBlock.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 64-Click on link TestEnvironments - Navigate to page teamprojectagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 65-Click on link TestCloudTunnels - Navigate to page teamprojecttestCloudTunnel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 66-Click on link CustomFields - Navigate to page teamprojectcustom-fields.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 67-Click on button Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC263/Step 68-Click on link OrganizationManagement - Navigate to page .png')

"Step 69: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC263-Configure Test Cloud Settings_visual_checkpoint')
