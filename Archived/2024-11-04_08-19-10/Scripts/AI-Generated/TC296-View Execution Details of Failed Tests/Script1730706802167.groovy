...
WebUI.takeScreenshot(reportLocation + '/TC296/Step 4-Click on div CCCareContinuityPortals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC296/Step 5-Click on link executionDetails Execution3826 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC296/Step 6-Click on link CoordinatorCore.png')

"Step 7: Click on pre errorMessages (FailedVerifyFaxReceived) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC296/Step 7-Click on pre errorMessages FailedVerifyFaxReceived - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC296-View Execution Details of Failed Tests_visual_checkpoint')
