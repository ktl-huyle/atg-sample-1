...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 4-Click on div sortingInfo SortIdDescending.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 5-Click on span Started.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 6-Click on div sortingInfo SortIdDescending2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 7-Click on div FlexGrow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 8-Click on div regressionDetails SP3TORRegression.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 9-Click on td Loading.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 10-Click on link executionLinks Execution3791.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 11-Click on div TestCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 12-Click on link executionLinks Execution3791 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 13-Click on div FailedTestResults.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 14-Click on td testCases TestCasesSP3TOR.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 15-Click on div TestCasesSP3TOR - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 16-Click on div AllTestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC295/Step 17-Click on div AllTestRuns.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionLinks', ['link_executionLinks_trNthChild': link_executionLinks_trNthChild_2, 'link_executionLinks_internalRoleLinkName': link_executionLinks_internalRoleLinkName_2, 'link_executionLinks_project_id': link_executionLinks_project_id_2, 'link_executionLinks_executions_id': link_executionLinks_executions_id_2, 'link_executionLinks_team_id': link_executionLinks_team_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC295/Step 18-Click on link executionLinks Execution3791.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionLinks', ['link_executionLinks_trNthChild': link_executionLinks_trNthChild_3, 'link_executionLinks_internalRoleLinkName': link_executionLinks_internalRoleLinkName_3, 'link_executionLinks_project_id': link_executionLinks_project_id_3, 'link_executionLinks_executions_id': link_executionLinks_executions_id_3, 'link_executionLinks_team_id': link_executionLinks_team_id_3]))

WebUI.takeScreenshot(reportLocation + '/TC295/Step 19-Click on link executionLinks Execution3791 - Navigate to page teamprojectexecutions.png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC295-Verify Test Executions and Results_visual_checkpoint')
