...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 4-Click on link testSuites TestSuitesCPACDECPreapprovalBind - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 5-Click on link testSuiteDetails testSuiteDetails - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 6-Click on link testResults - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 7-Click on div failedTestSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 8-Click on button TestResultDetails - Navigate to page teamprojectexecutions.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC253-View Test Suite Details in Executions_visual_checkpoint')
