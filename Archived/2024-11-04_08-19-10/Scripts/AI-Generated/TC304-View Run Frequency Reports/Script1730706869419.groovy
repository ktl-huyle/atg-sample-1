...
WebUI.takeScreenshot(reportLocation + '/TC304/Step 4-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC304/Step 5-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC304/Step 6-Click on button DatePicker.png')
...
WebUI.takeScreenshot(reportLocation + '/TC304/Step 7-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC304/Step 8-Click on link Reports - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC304/Step 9-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC304-View Run Frequency Reports_visual_checkpoint')
