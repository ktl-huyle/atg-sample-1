...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 4-Click on link agentSettings agentSettings - Navigate to page organizationsettingsagentlocal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 5-Click on link agentSettingsOverview - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 6-Click on link kubernetesSettings - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 7-Click on link circleCISettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 8-Click on link localSettings - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 9-Click on button navigation - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 10-Click on link projectLinks firstProjectExecution - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 11-Click on link tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 12-Click on link executions - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 13-Click on link tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 14-Click on link executions - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 15-Click on link reports2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 16-Click on link tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 17-Click on link testSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 18-Click on link testObjects - Navigate to page teamprojecttest-designtest-objects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 19-Click on button notification.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 20-Click on div backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 21-Click on link testCases - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 22-Click on button firstProject.png')

"Step 23: Click on div navigationLinks (topNavbar)"
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 23-Click on div navigationLinks topNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 24-Click on link settings - Navigate to page teamproject.png')

"Step 25: Click on link testLinks (scriptRepositories)"
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 25-Click on link testLinks scriptRepositories.png')

"Step 26: Click on link testLinks (testEnvironments)"
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 26-Click on link testLinks testEnvironments.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_agentLocalSettings', ['link_agentLocalSettings_organization_id': link_agentLocalSettings_organization_id, 'link_agentLocalSettings_local_id': link_agentLocalSettings_local_id]))

WebUI.takeScreenshot(reportLocation + '/TC312/Step 27-Click on link agentLocalSettings agentLocalSettings - Navigate to page organizationsettingsagentlocal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 28-Click on link executionDetails - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 29-Click on link requirements - Navigate to page teamprojecttest-reportstest-designrequirement-test-run-coverage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 30-Click on link testCases - Navigate to page teamprojecttest-reportstest-maintenance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 31-Click on link defects defects - Navigate to page teamproject.png')

"Step 32: Click on link testLinks (visualTesting)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_testLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testLinks', ['link_testLinks_internalRoleLinkName': link_testLinks_internalRoleLinkName_2]))

WebUI.takeScreenshot(reportLocation + '/TC312/Step 32-Click on link testLinks visualTesting.png')

"Step 33: Click on link testLinks (testRuns)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_testLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testLinks', ['link_testLinks_nthChild': link_testLinks_nthChild_2]))

WebUI.takeScreenshot(reportLocation + '/TC312/Step 33-Click on link testLinks testRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 34-Click on link tests2 - Navigate to page teamprojecttest-designtest-cases.png')

"Step 35: Click on div navigationLinks (dashboard)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_dashboardComponents'))

WebUI.takeScreenshot(reportLocation + '/TC312/Step 35-Click on div navigationLinks dashboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 36-Click on link testSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 37-Click on link dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 38-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC312/Step 39-Click on link projectManagement - Navigate to page .png')

"Step 40: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC312-Access Organization Settings and Verify Home Page_visual_checkpoint')
