...
WebUI.takeScreenshot(reportLocation + '/TC250/Step 4-Click on link projectLinks FirstProject - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC250/Step 5-Click on link Executions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC250-Schedule Multiple Test Runs in Team Project_visual_checkpoint')
