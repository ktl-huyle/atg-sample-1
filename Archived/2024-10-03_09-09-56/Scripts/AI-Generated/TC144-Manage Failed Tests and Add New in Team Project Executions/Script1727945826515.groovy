...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 4-Click on div ReviewSortInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 5-Click on pre failedTests FailedC2772372.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 6-Click on div CustomFields.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 7-Click on link AddNew.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 8-Click on input DisplayName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 9-Click on button Close3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 10-Click on button Open.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 11-Click on link AddNew.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 12-Click on input DisplayName2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 13-Click on div failedTests FailedC2772372.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 14-Click on button Open2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 15-Click on span errorDetails CheckPassTeam.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 16-Click on div InputContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 17-Click on button Open3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 18-Click on list ProjectTeam.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 19-Click on item TATeam.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 20-Click on button Add.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 21-Click on link AddNew.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 22-Click on input DisplayName3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 23-Click on span errorDetails ErrorType.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 24-Click on div InputContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 25-Click on div InputContainer2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 26-Click on button Open3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 27-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 28-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 29-Click on input Value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 30-Click on span errorDetails ObiectError.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 31-Click on button Add2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 33-Click on label FunctionsUpdates.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 34-Click on button Submit.png')

"Step 35: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC144-Manage Failed Tests and Add New in Team Project Executions_visual_checkpoint')
