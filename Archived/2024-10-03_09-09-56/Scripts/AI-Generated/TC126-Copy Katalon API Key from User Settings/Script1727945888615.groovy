...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 4-Click on button teamMembers NawwarahYusof.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 5-Click on link UserSettings - Navigate to page usersettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 6-Click on button dynamicObject NawwarahYusof.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 7-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 8-Click on link KatalonAPIKey - Navigate to page user.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 9-Click on button CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 10-Click on button CopyToClipboard2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 11-Click on button CopyToClipboard - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC126-Copy Katalon API Key from User Settings_visual_checkpoint')
