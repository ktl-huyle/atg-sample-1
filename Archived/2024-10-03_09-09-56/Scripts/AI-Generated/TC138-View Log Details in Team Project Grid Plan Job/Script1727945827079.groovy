...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 4-Click on link ProjectLink - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 5-Click on pre logDetails LogOutput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 6-Click on pre logDetails LogOutput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 7-Click on pre logDetails LogOutput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 8-Click on pre logDetails LogOutput - Navigate to page teamprojectgridplanjob.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC138-View Log Details in Team Project Grid Plan Job_visual_checkpoint')
