...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 4-Click on div WelcomeMessage2.png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC141-Verify Welcome Page After Login_visual_checkpoint')
