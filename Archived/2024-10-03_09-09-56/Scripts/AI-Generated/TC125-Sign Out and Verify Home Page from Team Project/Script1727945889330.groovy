...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 4-Click on button dynamicObject AlbertoBeba.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 5-Click on font Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 6-Click on div UserInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 7-Click on link signOut Desconectar - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 8-Click on button teamMembers AlbertoBeba.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 9-Click on div Backdrop2 - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC125-Sign Out and Verify Home Page from Team Project_visual_checkpoint')
