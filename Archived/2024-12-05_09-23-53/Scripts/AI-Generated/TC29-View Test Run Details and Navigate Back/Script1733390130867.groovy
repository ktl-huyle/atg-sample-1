...
"Step 4: Click on div testRunDetails (object)"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 4-Click on div testRunDetails object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 5-Click on div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 6-Click on div testRunDetails UntitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 7-Click on div untitledTestRuns UntitledTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 8-Click on div object2 - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC29-View Test Run Details and Navigate Back_visual_checkpoint')
