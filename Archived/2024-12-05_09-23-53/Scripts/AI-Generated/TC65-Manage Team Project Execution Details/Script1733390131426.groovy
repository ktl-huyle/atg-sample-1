...
"Step 4: Click on link Executions6 -> Navigate to page 'team/*/project/*/test-runs'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Executions6'))

WebUI.takeScreenshot(reportLocation + '/TC65/Step 4-Click on link Executions6 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 10-Click on div MyOrganization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 12-Click on div CurrentReadyTechJob.png')
...
"Step 14: Click on span Settings3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/span_Settings3'))

WebUI.takeScreenshot(reportLocation + '/TC65/Step 14-Click on span Settings3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 15-Click on link OrganizationManagementEdit - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 18-Enter input value in input UserEmail2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 23-Click on span Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 24-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 26-Enter input value in input UserEmail2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 27-Click on div TeamReadyCase - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC65-Manage Team Project Execution Details_visual_checkpoint')
