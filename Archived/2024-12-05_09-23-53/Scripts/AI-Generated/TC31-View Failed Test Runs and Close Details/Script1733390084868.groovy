...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 4-Click on pre failedTestRuns FailedE2EFlow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 8-Click on button Close - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC31-View Failed Test Runs and Close Details_visual_checkpoint')
