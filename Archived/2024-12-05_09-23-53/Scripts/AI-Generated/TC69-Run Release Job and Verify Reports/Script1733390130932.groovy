...
WebUI.takeScreenshot(reportLocation + '/TC69/Step 4-Click on button LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC69/Step 5-Click on span R5 15 1MayMaintenance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC69/Step 6-Click on button Run.png')
...
WebUI.takeScreenshot(reportLocation + '/TC69/Step 7-Click on link Reports - Navigate to page teamproject.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC69-Run Release Job and Verify Reports_visual_checkpoint')
