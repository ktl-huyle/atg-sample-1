...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 4-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 5-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 6-Click on button DateLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 7-Click on link Dashboard - Navigate to page teamproject.png')

"Step 8: Click on link reportsAndSettings (Reports) -> Navigate to page 'team/*/project/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 8-Click on link reportsAndSettings Reports - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 9-Click on link RunFrequency2 - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC36-Access Test Execution Frequency Reports_visual_checkpoint')
