...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 4-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 5-Click on link SPRINT - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 6-Click on link TestRuns - Navigate to page teamprojectreleasesexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 7-Click on link 4077 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 8-Click on link TestResults7 - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 9-Click on div PassedTestCase.png')

"Step 10: Close multiple thumbnail images in the interface"
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 11-Click on link Planning - Navigate to page teamprojectreleases.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC169-Manage Test Runs and Verify Releases_visual_checkpoint')
