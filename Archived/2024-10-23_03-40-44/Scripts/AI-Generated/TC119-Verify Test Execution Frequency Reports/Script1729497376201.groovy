...
WebUI.takeScreenshot(reportLocation + '/TC119/Step 4-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC119/Step 5-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC119/Step 6-Click on button TestExecutionFrequency.png')
...
WebUI.takeScreenshot(reportLocation + '/TC119/Step 7-Click on link Dashboard - Navigate to page teamproject.png')

"Step 8: Click on link Reports3 -> Navigate to page '/team/*/project/*/overview'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Reports3'))

WebUI.takeScreenshot(reportLocation + '/TC119/Step 8-Click on link Reports3 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC119/Step 9-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC119-Verify Test Execution Frequency Reports_visual_checkpoint')
