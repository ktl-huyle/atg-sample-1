...
WebUI.takeScreenshot(reportLocation + '/TC123/Step 4-Click on link Executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC123/Step 5-Click on link Executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC123/Step 6-Click on link Schedules - Navigate to page teamprojectgrid.png')
...
WebUI.takeScreenshot(reportLocation + '/TC123/Step 7-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC123/Step 8-Click on link TestEnvironments - Navigate to page teamprojectagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC123/Step 9-Click on link ScriptRepositories - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC123/Step 10-Click on link Executions2 - Navigate to page teamprojecttest-runs.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC123-Access Test Runs and Verify Project Settings_visual_checkpoint')
