...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 4-Click on pre failedTests ErrorSendMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 8-Click on div InfoSidebarCloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 9-Click on div UnderTopNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 10-Click on button organizationSelection SelectOrganization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC142/Step 11-Click on div UnderTopNavbar - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC142-Review Failed Tests and Navigate to Home_visual_checkpoint')
