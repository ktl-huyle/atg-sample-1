...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 4-Click on div SidebarMainContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 5-Click on div Toolbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 6-Click on pre failedTests FailedKundensonderpreise.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 8-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 9-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 10-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 11-Click on span FailedRechnungSpeichern.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 12-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 13-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC193/Step 14-Click on div ThumbnailImage.png')

"Step 15: Click on button Close3 -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/button_Close3'))

WebUI.takeScreenshot(reportLocation + '/TC193/Step 15-Click on button Close3 - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC193-Review Failed Tests and Navigate to Home_visual_checkpoint')
