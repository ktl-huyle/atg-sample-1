...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 4-Click on link projectLinks OracleJDE - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 5-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 6-Click on link ScriptRepositories2 - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 7-Click on link testProjects OracleJDE - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 8-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 10-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 11-Click on span treeSwitcherIcons TreeSwitcher3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 12-Click on span treeSwitcherIcons KatalonStudioTestCases.png')

"Step 13: Click on div testCases (TestCasesSection)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCases'))

WebUI.takeScreenshot(reportLocation + '/TC135/Step 13-Click on div testCases TestCasesSection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 14-Click on input TestCaseCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 15-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 16-Click on link ScriptRepositories2 - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 17-Click on link testProjects OracleJDE - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 18-Click on button ScheduleTestRun.png')

"Step 19: Run a test suite with advanced configuration options"
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 20-Click on div SuccessMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 21-Click on div UnderTopNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 22-Click on link testRunViews ViewTestRun - Navigate to page teamprojecttest-runs.png')

"Step 23: Click on div testRunCells (TestRunCell2)"
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 23-Click on div testRunCells TestRunCell2.png')

"Step 24: Click on div testRunCells (TestRunCell2) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 24-Click on div testRunCells TestRunCell2 - Navigate to page .png')

"Step 25: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC135-Schedule Test Run and Verify Success Message_visual_checkpoint')
