...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 4-Click on button deleteExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 5-Click on button deleteExecution2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 6-Click on button alertClose.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 7-Click on button userName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 8-Click on div customCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 9-Click on label failedTests failedTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 10-Click on label failedTests failedTest2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 11-Click on button deleteExecution3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC132/Step 12-Click on button deleteExecution4.png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC132-Delete Execution Entries in Team Project_visual_checkpoint')
