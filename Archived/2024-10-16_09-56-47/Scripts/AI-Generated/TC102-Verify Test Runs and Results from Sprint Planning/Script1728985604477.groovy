...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 4-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 5-Click on link SPRINT - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 6-Click on link TestRuns - Navigate to page teamprojectreleasesexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 7-Click on link 4077 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 8-Click on link TestResults - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 9-Click on div PassedTestCase.png')

"Step 10: View and close thumbnail images in sequence"
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 11-Click on link Planning - Navigate to page teamprojectreleases.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC102-Verify Test Runs and Results from Sprint Planning_visual_checkpoint')
