...
WebUI.takeScreenshot(reportLocation + '/TC96/Step 4-Click on div testRunDetails UntitledTestRun.png')

"Step 5: Click on div testRuns (UntitledTestRun2)"
...
WebUI.takeScreenshot(reportLocation + '/TC96/Step 5-Click on div testRuns UntitledTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC96/Step 6-Click on div TopNavbar - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC96-Access Test Run Details from Team Project_visual_checkpoint')
