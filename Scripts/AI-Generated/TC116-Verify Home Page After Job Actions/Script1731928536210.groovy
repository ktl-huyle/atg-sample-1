...
"Step 2: Click on button jobActions (linkToARelease)"
...
"Step 4: Click on button jobActions (run2) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC116-Verify Home Page After Job Actions_visual_checkpoint')
