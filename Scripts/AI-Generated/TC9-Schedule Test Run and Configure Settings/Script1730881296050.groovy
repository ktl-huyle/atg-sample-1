...
"Step 52: Click on div integrationDetails (CodelessAutomationTool)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationDetails', ['div_integrationDetails_internalRoleTreeitemName': div_integrationDetails_internalRoleTreeitemName]))

WebUI.takeScreenshot()

"Step 53: Click on div integrationDetails (CodelessAutomationTool2)"
...
"Step 54: Click on div integrationDetails (CICDPipeline)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationDetails_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationDetails_1', ['div_integrationDetails_class': div_integrationDetails_class_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Schedule Test Run and Configure Settings_visual_checkpoint')
