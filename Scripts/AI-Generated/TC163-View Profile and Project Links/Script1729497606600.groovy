...
"Step 4: Click on button userButtons (AI2)"
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 4-Click on button userButtons AI2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 5-Click on link ViewProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 6-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 7-Click on div TopNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 8-Click on button organizationActions OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 9-Click on button organizationActions OrganizationAdmin2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 10-Click on div TopLeftNavbar2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 11-Click on button organizationActions OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 12-Click on link organizationLinks OrganizationAdminIbpaas.png')
...
WebUI.takeScreenshot(reportLocation + '/TC163/Step 13-Click on link ViewAllProjects - Navigate to page .png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC163-View Profile and Project Links_visual_checkpoint')
