...
WebUI.takeScreenshot(reportLocation + '/TC78/Step 4-Click on link Executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC78/Step 5-Click on link Executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC78/Step 6-Click on link Schedules - Navigate to page teamproject.png')

"Step 7: Click on link settingsReports (Settings19)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_settingsReports"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_settingsReports', ['link_settingsReports_nthChild': link_settingsReports_nthChild, 'link_settingsReports_internalRoleLinkName': link_settingsReports_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC78/Step 7-Click on link settingsReports Settings19.png')
...
WebUI.takeScreenshot(reportLocation + '/TC78/Step 8-Click on link testEnvironments TestEnvironments39.png')
...
WebUI.takeScreenshot(reportLocation + '/TC78/Step 9-Click on link testEnvironments TestEnvironments39.png')
...
WebUI.takeScreenshot(reportLocation + '/TC78/Step 10-Click on link Executions - Navigate to page teamprojecttest-runs.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC78-Manage Executions in Team Project Test Runs_visual_checkpoint')
