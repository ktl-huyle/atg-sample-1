...
"Step 5: Click on link reportFiles (FileReport2)"
...
WebUI.takeScreenshot(reportLocation + '/TC88/Step 5-Click on link reportFiles FileReport2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC88-Verify File Access and Re run Functionality in Test Execution_visual_checkpoint')
