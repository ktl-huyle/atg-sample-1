...
"Step 4: Click on span failedItems"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_failedItems'))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on span failedItems.png')

"Step 5: Click on span failedItems"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_failedItems'))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Click on span failedItems.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on button externalLinks externalLinks.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 11-Click on span logItems logItems - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-View Failed Test Results and Details in Sauce Demo_visual_checkpoint')
