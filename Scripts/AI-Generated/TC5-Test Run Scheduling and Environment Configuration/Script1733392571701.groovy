...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 4-Click on div HistorySubscribed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on div HistorySubscribed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 11-Click on p sessionDetails Sessions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 12-Click on p sessionDetails Sessions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Test Run Scheduling and Environment Configuration_visual_checkpoint')
