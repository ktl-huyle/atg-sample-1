...
"Step 4: Click on div currentDivisiInfo (CurrentDDDivisi)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_organization_home/div_currentDivisiInfo"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/div_currentDivisiInfo', ['div_currentDivisiInfo_internalHasText': div_currentDivisiInfo_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on div currentDivisiInfo CurrentDDDivisi.png')
...
"Step 7: Click on header testRunInfo (UntitledTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on header testRunInfo UntitledTestRun.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-View Test Run Duration and Details_visual_checkpoint')
