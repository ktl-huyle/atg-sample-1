...
"Step 4: Click on link testCases (fpFirstProjectThereIsNoDataToDisplay) -> Navigate to page 'team/*/project/*'"
...
"Step 12: Click on div dynamicObject (object2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_dynamicObject_4'))
...
"Step 23: Click on div dynamicObject (object2)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC36-Verify Test Design Test Cases from Team Project_visual_checkpoint')
