...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 4-Click on button externalLinks externalLinks2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 5-Click on button externalLinks externalLinks3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 6-Click on button testResultActions testResultActions - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 9-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 12-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 15-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 18-Click on button Submit32 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 19-Click on button externalLinks externalLinks4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 20-Click on button externalLinks externalLinks5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 21-Click on button externalLinks externalLinks6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 22-Click on button externalLinks externalLinks7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 23-Click on button externalLinks externalLinks8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 24-Click on button externalLinks externalLinks9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 25-Click on button testResultActions testResultActions2 - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 28-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 31-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 34-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 37-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 41-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 44-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 47-Click on button Submit32 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 48-Click on button externalLinks externalLinks10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 49-Click on button externalLinks externalLinks11.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 50-Click on button InsightlyAutomation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 54-Click on button Submit3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 57-Click on button Submit33 - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 58-Click on link ExecutionDetails1879.png')

"Step 59: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC28-Mark Test Results and Verify Home Page_visual_checkpoint')
