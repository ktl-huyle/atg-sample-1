...
import truetest.common.generateApiKeyForTestAutomation
...
"Step 2: Click on button CellAction2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_CellAction2'))
...
"Step 6: Generate an API key for test automation and manage key settings"

generateApiKeyForTestAutomation.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Generate Multiple API Keys and Manage Settings_visual_checkpoint')
