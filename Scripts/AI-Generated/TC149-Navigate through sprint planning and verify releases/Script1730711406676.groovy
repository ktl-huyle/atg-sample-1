...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 4-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 5-Click on link Sprint - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 6-Click on link TestRuns - Navigate to page teamprojectreleasesexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 7-Click on link Execution4077 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 8-Click on link TestResults4 - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 9-Click on div PassedTestCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC149/Step 11-Click on link Planning - Navigate to page teamprojectreleases.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC149-Navigate through sprint planning and verify releases_visual_checkpoint')
