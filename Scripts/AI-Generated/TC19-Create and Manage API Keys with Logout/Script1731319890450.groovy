...
"Step 2: Click on button apiKeyActions (Object2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_apiKeyActions_1'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_apiKeyActions_2'))
...
"Step 10: Click on button apiKeyActions (ShowAPIKey3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_apiKeyActions_3'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Create and Manage API Keys with Logout_visual_checkpoint')
