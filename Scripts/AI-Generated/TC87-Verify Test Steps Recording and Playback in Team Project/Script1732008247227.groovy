...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 4-Click on link executionDetails FPTestCase - Navigate to page teamprojectexecutions.png')
...
"Step 12: Click on input objectActions (ObjectInput)"
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 12-Click on input objectActions ObjectInput.png')

"Step 13: Click on div unknownContent (UnknownContent)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases/.*/edit?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/div_unknownContent'))

WebUI.takeScreenshot(reportLocation + '/TC87/Step 13-Click on div unknownContent UnknownContent.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/input_objectActions"
WebUI.setText(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/input_objectActions', ['input_objectActions_internalAttrPlaceholder': input_objectActions_internalAttrPlaceholder_1]), input_objectActions)

WebUI.takeScreenshot(reportLocation + '/TC87/Step 18-Enter input value in input objectActions SelectAction.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/input_objectActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/input_objectActions', ['input_objectActions_internalAttrPlaceholder': input_objectActions_internalAttrPlaceholder_2]))

WebUI.takeScreenshot(reportLocation + '/TC87/Step 21-Click on input objectActions DropdownObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 26-Click on input checkboxes Checkbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 27-Click on input checkboxes Checkbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 28-Click on input checkboxes Checkbox3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 29-Click on input checkboxes Checkbox4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 30-Click on input checkboxes Checkbox5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 31-Click on input checkboxes Checkbox6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 32-Click on input checkboxes Checkbox7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 33-Click on input checkboxes Checkbox8.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/input_checkboxes"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/input_checkboxes', ['input_checkboxes_internalRoleButtonName': input_checkboxes_internalRoleButtonName_8]))

WebUI.takeScreenshot(reportLocation + '/TC87/Step 34-Click on input checkboxes Checkbox9.png')
...
"Step 36: Click on div objectActions (object3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases/.*/edit?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/div_objectActions_1'))

WebUI.takeScreenshot(reportLocation + '/TC87/Step 36-Click on div objectActions object3.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC87-Verify Test Steps Recording and Playback in Team Project_visual_checkpoint')
