...
"Step 6: Create a new API key for access and manage settings."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Manage API Key and Log Out Successfully_visual_checkpoint')
