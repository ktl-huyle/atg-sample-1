...
"Step 7: Click on div backdropElements (PopoverBackdrop)"
...
"Step 9: Click on p sessionInfo (Sessions)"
...
"Step 10: Click on p sessionInfo (SessionsCount)"
...
"Step 11: Click on div backdropElements (PopoverBackdrop)"
...
"Step 55: Click on div pipelineElements (CodelessAutomationTool)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineElements"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineElements', ['div_pipelineElements_class': div_pipelineElements_class]))

WebUI.takeScreenshot()

"Step 56: Click on div pipelineElements (CICDPipeline)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineElements"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineElements', ['div_pipelineElements_class': div_pipelineElements_class_1]))

WebUI.takeScreenshot()

"Step 57: Click on div devOpsIntegration (AzureDevOpsPipelines)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_devOpsIntegration'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Schedule Test Runs and Verify Home Page_visual_checkpoint')
