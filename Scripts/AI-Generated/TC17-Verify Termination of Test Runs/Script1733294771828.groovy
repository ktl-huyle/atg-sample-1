...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 4-Click on input rowSelection SelectRow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 5-Click on input rowSelection SelectRow2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 8-Click on input rowSelection SelectRow3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 9-Click on input rowSelection SelectRow4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 10-Click on input rowSelection SelectRow5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 13-Click on input rowSelection SelectRow6.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Verify Termination of Test Runs_visual_checkpoint')
