...
"Step 2: Click on div object5 -> Navigate to page 'team/*/project/*'"
...
"Step 4: Click on link truetestUserJourneys"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/settings?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_settings/link_truetestUserJourneys'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC45-Verify Team Project Agent Settings_visual_checkpoint')
