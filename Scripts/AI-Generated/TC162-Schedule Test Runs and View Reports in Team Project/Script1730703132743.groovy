...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 4-Click on link projectLinks executionDetails2 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 5-Click on link executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 7-Click on link tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 8-Click on link testSuites2 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 9-Click on div testSuites gitRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 10-Click on div testSuites testSuites2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 11-Click on div testSuites katalonCloud2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 12-Click on div testSuites uploadedData.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 13-Click on div testSuites testSuites3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 14-Click on link executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC162/Step 16-Click on link reports - Navigate to page teamprojectoverview.png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC162-Schedule Test Runs and View Reports in Team Project_visual_checkpoint')
