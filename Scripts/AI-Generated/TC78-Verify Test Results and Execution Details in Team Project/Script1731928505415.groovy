...
"Step 2: Click on h2 dynamicObject (object14)"
...
"Step 4: Click on div dynamicObject (object77)"
...
"Step 6: Click on button failedTestResults0"
...
"Step 8: Click on button sessions03"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/button_sessions03'))

WebUI.takeScreenshot()

"Step 9: Click on div dynamicObject (object77)"
...
"Step 10: Click on div dynamicObject (object78)"
...
"Step 12: Click on div dynamicObject (object79)"
...
"Step 14: Click on div dynamicObject (object79)"
...
"Step 16: Click on div dynamicObject (object79)"
...
"Step 18: Click on link testResults7 -> Navigate to page 'team/*/project/*/executions/*/test-runs'"
...
"Step 23: Click on div dynamicObject (object10)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_runs/div_dynamicObject'))
...
"Step 25: Click on button externalLink (externalLinkButton2) -> Navigate to page 'team/*/project/*/executions/*/test-result/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/div_dynamicObject', ['div_dynamicObject_class': div_dynamicObject_class_3]))

WebUI.takeScreenshot()

"Step 27: Click on div object2"
...
"Step 28: Click on div dynamicObject (object3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/div_dynamicObject_1'))

WebUI.takeScreenshot()

"Step 29: Click on div dynamicObject (object)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/div_dynamicObject"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/div_dynamicObject', ['div_dynamicObject_class': div_dynamicObject_class_4]))
...
"Step 33: Click on div dynamicObject (object3)"
...
"Step 34: Click on div dynamicObject (object4)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/div_dynamicObject_2'))

WebUI.takeScreenshot()

"Step 35: Click on link requests -> Navigate to page 'team/*/project/*/executions/*/test-result/*/requests'"
...
"Step 36: Click on link testObjects -> Navigate to page 'team/*/project/*/executions/*/test-result/*/test-objects'"
...
"Step 37: Click on link similarFailures -> Navigate to page 'team/*/project/*/executions/*/test-result/*/similar-failures'"
...
"Step 38: Click on link comments -> Navigate to page 'team/*/project/*/executions/*/test-result/*/comments'"
...
"Step 39: Click on link reRuns -> Navigate to page 'team/*/project/*/executions/*/test-result/*/re-runs'"
...
"Step 40: Click on time 082220240157500300"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*/re-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions_test_result_re_runs/time_082220240157500300'))
...
"Step 42: Click on div dynamicObject (object2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*/re-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result_re_runs/div_dynamicObject'))

WebUI.takeScreenshot()

"Step 43: Click on div object3"
...
"Step 45: Click on div dynamicObject (object5)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*/re-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result_re_runs/div_dynamicObject_1'))

WebUI.takeScreenshot()

"Step 46: Click on div dynamicObject (object5)"
...
"Step 47: Click on div dynamicObject (object2)"
...
"Step 48: Click on link result -> Navigate to page 'team/*/project/*/executions/*/test-result/*'"
...
"Step 50: Click on label object -> Navigate to page 'team/*/project/*/executions/*/test-runs'"
...
"Step 52: Click on link object -> Navigate to page 'team/*/project/*/executions/*/test-result/*'"
...
"Step 56: Click on div dynamicObject (object9) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/div_dynamicObject"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/div_dynamicObject', ['div_dynamicObject_class': div_dynamicObject_class_5]))

WebUI.takeScreenshot()

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC78-Verify Test Results and Execution Details in Team Project_visual_checkpoint')
