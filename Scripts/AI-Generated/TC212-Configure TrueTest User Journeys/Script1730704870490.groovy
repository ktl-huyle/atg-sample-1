...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 4-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 5-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 6-Click on link TrueTest45 - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 7-Click on link projectLinks LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 8-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 9-Click on div UserJourneyGraph.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 10-Click on input ControlledCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 11-Click on button navigationActions ExpandGraph.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 12-Click on button ExportAllFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 13-Click on link DownloadCSV.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 14-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 15-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 16-Click on link TrueTest45 - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 17-Click on div QA JamaicaFlow.png')

"Step 18: Click on div dynamicObject (URLLink)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/settings/truetest/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_settings_truetest/div_dynamicObject'))

WebUI.takeScreenshot(reportLocation + '/TC212/Step 18-Click on div dynamicObject URLLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 19-Click on p InstallTrueTest.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_organization_settings_truetest/link_projectLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_settings_truetest/link_projectLinks', ['link_projectLinks_internalRoleLinkName': link_projectLinks_internalRoleLinkName_1, 'link_projectLinks_project_id': link_projectLinks_project_id_1, 'link_projectLinks_team_id': link_projectLinks_team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC212/Step 20-Click on link projectLinks LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 21-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeys.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 22-Click on button viewDetails ViewDetails - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 23-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 24-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 25-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 26-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 27-Click on p userJourneySteps VerifyNavigationToHome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 28-Click on button navigationActions GoToNextPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 29-Click on p userJourneySteps VerifyInternetBundles.png')

"Step 30: Click on button dynamicActions (ShowDetails)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_dynamicActions', ['button_dynamicActions_class': button_dynamicActions_class, 'button_dynamicActions_divNthChild': button_dynamicActions_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC212/Step 30-Click on button dynamicActions ShowDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 31-Click on button navigationActions GoToNextPage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 32-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 33-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 34-Click on p userJourneySteps NavigateAndInteract.png')

"Step 35: Click on button dynamicActions (ShowDetailFlowPanel)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/truetest/user-journeys/.*/aut/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_dynamicActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_dynamicActions', ['button_dynamicActions_class': button_dynamicActions_class_1]))

WebUI.takeScreenshot(reportLocation + '/TC212/Step 35-Click on button dynamicActions ShowDetailFlowPanel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 36-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC212/Step 37-Enter input value in input SearchFlows.png')

"Step 38: Click on button dynamicActions (ShowDetailFlowPanel2) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/truetest/user-journeys/.*/aut/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_dynamicActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_dynamicActions', ['button_dynamicActions_class': button_dynamicActions_class_2]))

WebUI.takeScreenshot(reportLocation + '/TC212/Step 38-Click on button dynamicActions ShowDetailFlowPanel2 - Navigate to page .png')

"Step 39: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC212-Configure TrueTest User Journeys_visual_checkpoint')
