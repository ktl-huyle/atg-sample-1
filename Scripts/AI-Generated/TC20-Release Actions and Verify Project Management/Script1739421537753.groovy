...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 2-Click on button releaseActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on button releaseActions Run - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Release Actions and Verify Project Management_visual_checkpoint')
