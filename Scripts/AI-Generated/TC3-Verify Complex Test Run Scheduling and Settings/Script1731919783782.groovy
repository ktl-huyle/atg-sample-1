...
"Step 2: Click on div historyInfo (HistorySubscribed)"
...
"Step 3: Click on div historyInfo (HistorySubscribed)"
...
"Step 55: Click on div pipelineComponents (CodelessAutomationTool)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineComponents"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineComponents', ['div_pipelineComponents_class': div_pipelineComponents_class]))

WebUI.takeScreenshot()

"Step 56: Click on div pipelineComponents (CICDPipeline)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineComponents"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_pipelineComponents', ['div_pipelineComponents_class': div_pipelineComponents_class_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Complex Test Run Scheduling and Settings_visual_checkpoint')
