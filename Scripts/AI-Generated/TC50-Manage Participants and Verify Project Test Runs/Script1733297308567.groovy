...
"Step 4: Click on link participantManagement (ForumPosting) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 4-Click on link participantManagement ForumPosting - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 5-Click on link TestRuns - Navigate to page teamproject.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC50-Manage Participants and Verify Project Test Runs_visual_checkpoint')
