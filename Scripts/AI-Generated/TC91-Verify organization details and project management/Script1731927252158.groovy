...
WebUI.takeScreenshot(reportLocation + '/TC91/Step 5-Click on button organizationSelection DivisiDDB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC91/Step 6-Click on div currentOrganizationDetails CurrentDD.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC91-Verify organization details and project management_visual_checkpoint')
