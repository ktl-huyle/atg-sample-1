...
"Step 6: Click on div regressionIssues (PenTestIssuesSprintA)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_regressionIssues'))

WebUI.takeScreenshot(reportLocation + '/TC51/Step 6-Click on div regressionIssues PenTestIssuesSprintA.png')
...
"Step 10: Click on div regressionIssues (PenTestIssuesSprintA)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_regressionIssues'))

WebUI.takeScreenshot(reportLocation + '/TC51/Step 10-Click on div regressionIssues PenTestIssuesSprintA.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC51-Review Regression and Pen Test Issues in Executions_visual_checkpoint')
