...
"Step 58: Click on link executionSummary"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/link_executionSummary'))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 58-Click on link executionSummary.png')

"Step 59: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Test Result Marking and Submission Process_visual_checkpoint')
