...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 5-Click on link reports - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 7-Click on link reports - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 8-Click on link testRuns - Navigate to page teamprojectexecutions.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Access Reports from Test Design and Execution_visual_checkpoint')
