...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 4-Click on pre failedTests ErrorMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 8-Click on div CloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 9-Click on div Navbar.png')

"Step 10: Click on button dynamicActions (CareContinuity)"
...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 10-Click on button dynamicActions CareContinuity.png')
...
WebUI.takeScreenshot(reportLocation + '/TC242/Step 11-Click on div Navbar - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC242-Navigate and Close Failed Tests_visual_checkpoint')
