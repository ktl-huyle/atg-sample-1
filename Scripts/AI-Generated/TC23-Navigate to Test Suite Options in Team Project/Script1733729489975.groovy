...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 4-Click on link CPACPreapproval - Navigate to page teamprojecttest-designtest-suites.png')

"Step 5: Click on link testSuiteOptions (CPACPreapproval) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 5-Click on link testSuiteOptions CPACPreapproval - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Navigate to Test Suite Options in Team Project_visual_checkpoint')
