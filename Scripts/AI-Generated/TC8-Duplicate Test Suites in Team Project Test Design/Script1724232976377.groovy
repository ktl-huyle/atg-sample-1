...
import katalon.common.duplicateTestSuitesAndNavigate
...
"Step 5: Click on link teamProjectTestDesignTestSuites"
...
"Step 6: Duplicate selected test suites in the project"

duplicateSelectedTestSuites.execute()

"Step 7: Duplicate test suites and navigate through the project"

duplicateTestSuitesAndNavigate.execute()

"Step 8: Click on link teamProjectTestDesignTestSuites -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/262587/project/375002/test-design/test-suites?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_teamprojecttest_design_test_suites/link_teamProjectTestDesignTestSuites_1'))

WebUI.takeScreenshot()

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Duplicate Test Suites in Team Project Test Design_visual_checkpoint')
