...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 4-Click on link testExecution Sample Test Case - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 5-Click on button AddTestCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 6-Click on button RecordTestSteps - Navigate to page team project editteamprojectedit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 7-Click on span dragSelect dragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 8-Click on span dragSelect dragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 9-Click on span dragSelect dragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 10-Click on button addNewTestStep.png')

"Step 11: Click on div selectValueActions (clickOnObject)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}/{.*}/{.*}/edit?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_edit/div_selectValueActions'))

WebUI.takeScreenshot(reportLocation + '/TC50/Step 11-Click on div selectValueActions clickOnObject.png')

"Step 12: Click on input autocompleteActions (selectObject)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}/{.*}/{.*}/edit?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_edit/input_autocompleteActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_edit/input_autocompleteActions', ['input_autocompleteActions_internalAttrPlaceholder': input_autocompleteActions_internalAttrPlaceholder]))

WebUI.takeScreenshot(reportLocation + '/TC50/Step 12-Click on input autocompleteActions selectObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 13-Click on div objectInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 14-Click on div captureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 15-Click on button save.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 16-Click on div contextMenu.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 17-Click on button addNewTestStep.png')

"Step 18: Enter input value in input autocompleteActions (autocompleteAction)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}/{.*}/{.*}/edit?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_edit/input_autocompleteActions'), input_autocompleteActions)

WebUI.takeScreenshot(reportLocation + '/TC50/Step 18-Enter input value in input autocompleteActions autocompleteAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 19-Click on div selectValueActions selectValueDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 20-Click on input value.png')

"Step 21: Click on input autocompleteActions (dropdownObject)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}/{.*}/{.*}/edit?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_edit/input_autocompleteActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_edit/input_autocompleteActions', ['input_autocompleteActions_internalAttrPlaceholder': input_autocompleteActions_internalAttrPlaceholder_1]))

WebUI.takeScreenshot(reportLocation + '/TC50/Step 21-Click on input autocompleteActions dropdownObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 22-Click on div captureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 23-Click on input value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 24-Enter input value in input value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 25-Click on button save2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 26-Click on input dragSelectCheckboxes checkbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 27-Click on input dragSelectCheckboxes dragSelectCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 28-Click on input dragSelectCheckboxes dragSelectCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 29-Click on input dragSelectCheckboxes dragSelectCheckbox3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 30-Click on input dragSelectCheckboxes dragSelectCheckbox4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 31-Click on input dragSelectCheckboxes dragSelectCheckbox5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 32-Click on input dragSelectCheckboxes dragSelectCheckbox6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 33-Click on input dragSelectCheckboxes dragSelectCheckbox7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 34-Click on input dragSelectCheckboxes dragSelectCheckbox8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 35-Click on span deleteSelectedSteps.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 36-Click on div recordPlayback.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 37-Click on button playback.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 38-Click on span dragSelect dragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 39-Click on span dragSelect dragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 40-Click on span dragSelect dragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 41-Click on span dragSelect dragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 42-Click on button edit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 43-Click on input value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 44-Click on input value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 45-Enter input value in input value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 46-Click on button save3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC50/Step 47-Click on button playback - Navigate to page .png')

"Step 48: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC50-Record and Playback Test Steps in Team Project_visual_checkpoint')
