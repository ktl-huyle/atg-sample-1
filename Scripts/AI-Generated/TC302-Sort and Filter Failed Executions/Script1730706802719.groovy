...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 4-Click on button SortIDAscending.png')
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 5-Click on span StartedAscending.png')

"Step 6: Click on div failedExecutionDetails (FailedED1451)"
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 6-Click on div failedExecutionDetails FailedED1451.png')
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 7-Click on div FailedED2364.png')
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 8-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 9-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 10-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 11-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC302/Step 12-Click on link Page2 - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC302-Sort and Filter Failed Executions_visual_checkpoint')
