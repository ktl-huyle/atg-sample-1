...
"Step 3: Click on link testDetails (TestDetails) -> Navigate to page 'team project executions#team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_organization_home/link_testDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/link_testDetails', ['link_testDetails_nthChild': link_testDetails_nthChild, 'link_testDetails_class': link_testDetails_class, 'link_testDetails_internalRoleLinkName': link_testDetails_internalRoleLinkName, 'team_id': team_id, 'executions_id': executions_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC25/Step 3-Click on link testDetails TestDetails - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuiteResults', ['link_testSuiteResults_internalRoleRowName': link_testSuiteResults_internalRoleRowName, 'team_id': team_id_2, 'executions_id': executions_id_1, 'project_id': project_id_2]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC25-View Test Suite Results and Pass Details_visual_checkpoint')
