...
WebUI.takeScreenshot(reportLocation + '/TC176/Step 4-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC176/Step 5-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC176/Step 6-Click on button DatePicker.png')
...
WebUI.takeScreenshot(reportLocation + '/TC176/Step 7-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC176/Step 8-Click on link Reports - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC176/Step 9-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC176-Verify test execution frequency report_visual_checkpoint')
