...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 4-Click on div firstProject - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 5-Click on link settings - Navigate to page team project settingsteamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 6-Click on link settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 7-Click on link testEnvironments - Navigate to page team project agentteamprojectagent.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC164-Verify Project Settings and Test Environments_visual_checkpoint')
