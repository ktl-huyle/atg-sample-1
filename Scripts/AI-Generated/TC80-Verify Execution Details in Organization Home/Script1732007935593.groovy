...
"Step 4: Click on div portalDetails (CCCareContinuityPortals)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/div_portalDetails'))

WebUI.takeScreenshot(reportLocation + '/TC80/Step 4-Click on div portalDetails CCCareContinuityPortals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC80/Step 5-Click on link executionDetails Execution3826 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC80-Verify Execution Details in Organization Home_visual_checkpoint')
