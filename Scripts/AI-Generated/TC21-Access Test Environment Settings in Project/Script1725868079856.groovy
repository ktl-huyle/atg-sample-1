...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 4-Click on div fpFirstProject30m42s - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 5-Click on link settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 6-Click on link settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 7-Click on link testEnvironments - Navigate to page teamprojectagent.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC21-Access Test Environment Settings in Project_visual_checkpoint')
