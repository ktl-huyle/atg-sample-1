...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 4-Click on button EditUser.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 5-Click on select UserRole.png')
...
WebUI.takeScreenshot(reportLocation + '/TC135/Step 6-Click on button Save - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC135-Edit User Roles in Team Project Settings_visual_checkpoint')
