...
"Step 4: Schedule and run a test with environment selection"
...
"Step 13: Schedule and run a test with environment selection"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Schedule and Run Tests with Environment Selection_visual_checkpoint')
