...
"Step 10: Click on link executionDetails (ExecutionDetails2)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName, 'executions_id': executions_id, 'project_id': project_id, 'team_id': team_id]))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 10-Click on link executionDetails ExecutionDetails2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 14-Click on td Object.png')
...
"Step 18: Click on link executionDetails (ExecutionDetails2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_2, 'executions_id': executions_id_2, 'project_id': project_id_2, 'team_id': team_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 18-Click on link executionDetails ExecutionDetails2.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails', ['link_executionDetails_trNthChild': link_executionDetails_trNthChild_1, 'link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_3, 'executions_id': executions_id_3, 'project_id': project_id_3, 'team_id': team_id_3]))
