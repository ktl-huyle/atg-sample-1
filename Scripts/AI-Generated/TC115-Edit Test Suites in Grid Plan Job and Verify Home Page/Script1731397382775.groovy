...
"Step 4: Configure test suites and save settings"

configureTestSuitesAndSaveSettings.execute()

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC115-Edit Test Suites in Grid Plan Job and Verify Home Page_visual_checkpoint')
