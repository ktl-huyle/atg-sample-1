...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 4-Click on button failed809UateastReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 5-Click on button deleteExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 6-Click on button delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 7-Click on button failed809UateastReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 8-Click on button deleteExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 9-Click on button delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 10-Click on div doneTheExecution809Is.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 11-Click on div dashboardNth2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 12-Click on div leftNavbarCollapseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 13-Click on div dashboardNth0.png')
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 14-Click on div dashboardNth1.png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC31-Delete Failed Test Executions from Team_visual_checkpoint')
