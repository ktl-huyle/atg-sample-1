...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 2-Click on button executionActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Click on button executionActions Run.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Execute Actions in Project Management and Verify Overview_visual_checkpoint')
