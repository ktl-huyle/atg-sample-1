...
"Step 2: Create a new API key for application access and manage settings"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Manage API Key for Application Access_visual_checkpoint')
