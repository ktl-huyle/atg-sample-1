...
"Step 3: Click on link userSettings -> Navigate to page 'user/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/link_katalonApiKey'))

WebUI.takeScreenshot()

"Step 5: Click on link teamProjectSettings -> Navigate to page 'team/*/project/*/settings'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_teamProjectSettings'))
...
"Step 54: Click on link organizationSetup -> Navigate to page 'organization/*/settings/*'"
...
"Step 55: Click on link agentSetup"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_settings/div_defaultApiKey'))

WebUI.takeScreenshot()

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Setup Katalon API Keys for Various Frameworks in Team Project_visual_checkpoint')
