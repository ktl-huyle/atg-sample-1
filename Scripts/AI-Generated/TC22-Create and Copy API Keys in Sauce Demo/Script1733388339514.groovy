...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 4-Click on button apiKeyActions apiKeyActions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 5-Click on button apiKeyActions apiKeyActions3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 12-Click on button apiKeyActions apiKeyActions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 15-Click on button NK.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 16-Click on link SignOut22 - Navigate to page logout.png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Create and Copy API Keys in Sauce Demo_visual_checkpoint')
