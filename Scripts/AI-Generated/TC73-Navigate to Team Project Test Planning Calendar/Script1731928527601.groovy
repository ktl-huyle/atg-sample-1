...
"Step 3: Click on div dynamicObject (object45) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC73-Navigate to Team Project Test Planning Calendar_visual_checkpoint')
