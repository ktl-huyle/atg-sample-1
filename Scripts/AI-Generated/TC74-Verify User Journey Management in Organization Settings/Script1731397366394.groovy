...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_settings_truetest/link_llaDigitalJamaicaECommerceFlow'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_settings_truetest/div_httpsFlsitjamDiscoverflowLlaDigital'))
...
"Step 29: Click on button keyboardarrowrighticon2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/truetest/user-journeys/.*/aut/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_truetest_user_journeys_aut/button_keyboardarrowrighticon2'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC74-Verify User Journey Management in Organization Settings_visual_checkpoint')
