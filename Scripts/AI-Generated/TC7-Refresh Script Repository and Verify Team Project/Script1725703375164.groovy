...
import katalon.common.scheduleTestRunForAllFeatures
...
"Step 5: Schedule a test run for all features in the test suite."

scheduleTestRunForAllFeatures.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 11: Click on link testRuns -> Navigate to page 'team/*/project/*/test-runs'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Refresh Script Repository and Verify Team Project_visual_checkpoint')
