...
"Step 4: Click on button userProfile (userProfile)"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on button userProfile userProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on span settingsButton.png')

"Step 7: Click on link navigation (navigation) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on link navigation navigation - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-User Profile Navigation and Settings Access in Sauce Demo_visual_checkpoint')
