...
WebUI.takeScreenshot(reportLocation + '/TC289/Step 4-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC289/Step 5-Click on link Reports - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC289/Step 6-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC289/Step 7-Click on link Reports - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC289/Step 8-Click on link TestRuns2 - Navigate to page teamprojectexecutions.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC289-Verify Test Design Navigation from Reports_visual_checkpoint')
