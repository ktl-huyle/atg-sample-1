...
"Step 2: Mark test results as passed after reviewing details"

markTestResultsAsPassed.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 12: Click on button testResultDetails (GoToTestResultDetails)"
...
"Step 13: Click on button testResultDetails (GoToTestResultDetails2)"
...
"Step 14: Click on button testResultDetails (GoToTestResultDetails3)"
...
"Step 15: Click on button testResultDetails (GoToTestResultDetails4)"
...
"Step 16: Mark test results as passed after reviewing details"

markTestResultsAsPassed.execute(data_path_1, Integer.valueOf(index_1))
...
"Step 36: Click on button testResultDetails (GoToTestResultDetails5)"
...
"Step 37: Click on button testResultDetails (GoToTestResultDetails6)"
...
"Step 39: Click on link insightlyHome (InsightlyHome) -> Navigate to page 'team/*/project/*/executions/*/test-result/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_insightlyHome"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_insightlyHome', ['link_insightlyHome_organization_id': link_insightlyHome_organization_id]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Verify Test Execution Details from Organization Home_visual_checkpoint')
