...
WebUI.takeScreenshot(reportLocation + '/TC147/Step 4-Click on link Files - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC147/Step 5-Click on link executionFiles HTMLFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC147/Step 6-Click on button ReRun - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC147-Re run Execution Files in Team Project_visual_checkpoint')
