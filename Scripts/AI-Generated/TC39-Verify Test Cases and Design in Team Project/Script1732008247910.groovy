...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 7-Click on span settings DownloadKatalonPackage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 11-Click on div testCases UploadedData.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 21-Click on div testCases UploadedData.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC39-Verify Test Cases and Design in Team Project_visual_checkpoint')
