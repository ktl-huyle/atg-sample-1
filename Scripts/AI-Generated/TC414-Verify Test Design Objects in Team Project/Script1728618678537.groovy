...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 4-Click on link OfflineAgentSettings - Navigate to page organizationsettingsagentlocal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 5-Click on link AgentSettings - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 6-Click on link Kubernetes - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 7-Click on link CircleCI.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 8-Click on link Local - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 9-Click on button Navigation - Navigate to page organizationhome.png')

"Step 10: Click on link projectExecutions (FirstProject) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 10-Click on link projectExecutions FirstProject - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 11-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 12-Click on link Executions - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 13-Click on link Tests3 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 14-Click on link Executions - Navigate to page teamproject.png')

"Step 15: Click on link executionReports (Reports2)"
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 15-Click on link executionReports Reports2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 16-Click on link Tests3 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 17-Click on link TestSuites - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC414/Step 18-Click on link TestObjects - Navigate to page teamprojecttest-designtest-objects.png')

"Step 19: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC414-Verify Test Design Objects in Team Project_visual_checkpoint')
