...
"Step 5: Click on link projectManagement (ProjectManagement) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Organization Home and Access Project Management Settings_visual_checkpoint')
