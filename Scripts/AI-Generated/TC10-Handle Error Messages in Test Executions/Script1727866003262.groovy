...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on pre errorMessages FailedTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8-Click on button Close - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Handle Error Messages in Test Executions_visual_checkpoint')
