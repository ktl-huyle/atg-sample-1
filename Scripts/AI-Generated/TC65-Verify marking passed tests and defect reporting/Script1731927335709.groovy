...
"Step 5: Click on div defectMarking (ReportDefectMarkAs)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_defectMarking'))

WebUI.takeScreenshot(reportLocation + '/TC65/Step 5-Click on div defectMarking ReportDefectMarkAs.png')
...
"Step 11: Click on span failedTestDetails (FailedTest2)"
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 11-Click on span failedTestDetails FailedTest2.png')
...
"Step 16: Click on span failedTestDetails (FailedTest3)"
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 16-Click on span failedTestDetails FailedTest3.png')
...
"Step 20: Click on div failedTestDetails (FailedTest2)"
...
WebUI.takeScreenshot(reportLocation + '/TC65/Step 20-Click on div failedTestDetails FailedTest2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC65-Verify marking passed tests and defect reporting_visual_checkpoint')
