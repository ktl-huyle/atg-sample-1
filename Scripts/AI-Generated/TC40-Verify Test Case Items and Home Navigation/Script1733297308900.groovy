...
"Step 5: Click on button testCaseAction (TestCaseAction2) -> Navigate to page 'team/*/project/*/test-design/test-cases'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/button_testCaseAction'))

WebUI.takeScreenshot(reportLocation + '/TC40/Step 5-Click on button testCaseAction TestCaseAction2 - Navigate to page teamprojecttest-designtest-cases.png')
...
"Step 7: Click on span treeSwitcher (TreeSwitcher7)"
...
WebUI.takeScreenshot(reportLocation + '/TC40/Step 7-Click on span treeSwitcher TreeSwitcher7.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems', ['span_objectItems_class': span_objectItems_class_3, 'span_objectItems_nthChild': span_objectItems_nthChild_3, 'span_objectItems_divNthChild': span_objectItems_divNthChild_3]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems', ['span_objectItems_class': span_objectItems_class_4, 'span_objectItems_nthChild': span_objectItems_nthChild_4, 'span_objectItems_divNthChild': span_objectItems_divNthChild_4]))

WebUI.takeScreenshot(reportLocation + '/TC40/Step 13-Click on span objectItems treeSwitcher4.png')

"Step 14: Click on span treeSwitcher (TreeSwitcher7)"
...
WebUI.takeScreenshot(reportLocation + '/TC40/Step 14-Click on span treeSwitcher TreeSwitcher7.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems', ['span_objectItems_class': span_objectItems_class_5, 'span_objectItems_nthChild': span_objectItems_nthChild_5, 'span_objectItems_divNthChild': span_objectItems_divNthChild_5]))
