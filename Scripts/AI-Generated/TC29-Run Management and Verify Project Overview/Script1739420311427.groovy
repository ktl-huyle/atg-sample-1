...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 2-Click on button runManagement LinkToRelease.png')
...
"Step 4: Click on button runManagement (Run)"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 4-Click on button runManagement Run.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC29-Run Management and Verify Project Overview_visual_checkpoint')
