...
WebUI.takeScreenshot(reportLocation + '/TC393/Step 4-Click on button jobActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC393/Step 5-Click on div MaintenanceInfo.png')

"Step 6: Click on button jobActions (Run4) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC393/Step 6-Click on button jobActions Run4 - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC393-Access Job Maintenance Info and Verify Home Page_visual_checkpoint')
