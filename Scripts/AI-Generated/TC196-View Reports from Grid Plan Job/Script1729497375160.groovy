...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 4-Click on button gridActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 5-Click on span R5Maintenance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 6-Click on button gridActions Run3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 7-Click on link Reports - Navigate to page teamprojectoverview.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC196-View Reports from Grid Plan Job_visual_checkpoint')
