...
"Step 4: Click on link executionOptions (EEcoEHSExecution) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on link executionOptions EEcoEHSExecution - Navigate to page teamproject.png')
...
"Step 7: Click on link AllFeaturesTestSuite"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_AllFeaturesTestSuite'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on link AllFeaturesTestSuite.png')

"Step 8: Click on link AllFeaturesTestSuite2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_AllFeaturesTestSuite2'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 8-Click on link AllFeaturesTestSuite2.png')

"Step 9: Click on link RefreshTestRuns2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_RefreshTestRuns2'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 9-Click on link RefreshTestRuns2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 14-Click on div testSuites EHSTestAutomation.png')

"Step 15: Click on div testSuites (TestSuites)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 15-Click on div testSuites TestSuites.png')

"Step 16: Click on div testSuites (KatalonCloud)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 16-Click on div testSuites KatalonCloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 17-Click on div testSuites UploadedData.png')

"Step 18: Click on div testSuites (TestSuites2)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 18-Click on div testSuites TestSuites2.png')
...
"Step 21: Click on link AllFeaturesTestSuite"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_AllFeaturesTestSuite'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 21-Click on link AllFeaturesTestSuite.png')

"Step 22: Click on link AllFeaturesTestSuite3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_AllFeaturesTestSuite3'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 22-Click on link AllFeaturesTestSuite3.png')
...
"Step 44: Click on button closeAction (Close2)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 44-Click on button closeAction Close2.png')

"Step 45: Click on button closeAction (Close3)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 45-Click on button closeAction Close3.png')

"Step 46: Click on link SubscribedTestCloudSessions"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_SubscribedTestCloudSessions'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 46-Click on link SubscribedTestCloudSessions.png')
...
"Step 48: Click on p sessionInfo (Sessions)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 48-Click on p sessionInfo Sessions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Schedule Test Run for Multiple Features in Team Project_visual_checkpoint')
