...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 4-Click on link executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 5-Click on div testRunDetails parallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 6-Click on div testRunDetails parallelSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 7-Click on div testRunDetails parallelSuite3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 8-Click on div testRunDetails parallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 9-Click on button jobReady.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 10-Click on div myOrganizationButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 11-Click on link viewAllProjects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 12-Click on div currentJobButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 13-Click on link jrJobReady - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 14-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 15-Click on link organizationManagement - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 16-Click on p readyCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 17-Click on input userEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 18-Enter input value in input userEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 19-Click on div projectProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 20-Click on input timezoneConfig.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 21-Click on div enableBddReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 22-Click on div inputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 23-Click on span SettingsButton.png')

"Step 24: Click on div backdropElements (Backdrop)"
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 24-Click on div backdropElements Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 25-Click on div inputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 26-Enter input value in input userEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC440/Step 27-Click on div teamProfile - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC440-Manage User Email and Project Settings_visual_checkpoint')
