...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 2-Click on pre failedTests ErrorMessage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Download and Preview Test Resources_visual_checkpoint')
