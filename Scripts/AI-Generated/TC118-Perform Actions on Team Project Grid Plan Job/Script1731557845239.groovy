...
"Step 2: Click on button action (linkToARelease)"
...
"Step 4: Click on button action (run2) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC118-Perform Actions on Team Project Grid Plan Job_visual_checkpoint')
