...
WebUI.takeScreenshot(reportLocation + '/TC348/Step 4-Click on div RightSidebar3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC348/Step 5-Click on div ReportDefect.png')

"Step 6: Submit updates for thumbnail images in the project"

submitThumbnailImageUpdates.execute()

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC348-Submit Defect Updates from Team Project Executions_visual_checkpoint')
