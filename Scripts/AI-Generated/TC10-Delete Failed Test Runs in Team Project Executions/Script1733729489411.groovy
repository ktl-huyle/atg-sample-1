...
"Step 4: Click on link executionDetails (TeamExecution) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on link executionDetails TeamExecution - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8-Click on link TestRuns3 - Navigate to page teamprojectexecutions.png')
...
"Step 20: Click on link TestRuns4 -> Navigate to page 'team/*/project/*/executions'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/overview?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_overview/link_TestRuns4'))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 20-Click on link TestRuns4 - Navigate to page teamprojectexecutions.png')

"Step 21: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Delete Failed Test Runs in Team Project Executions_visual_checkpoint')
