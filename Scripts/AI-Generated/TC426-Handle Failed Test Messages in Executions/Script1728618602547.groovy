...
"Step 4: Click on div failedTestMessages (FailedC17094)"
...
WebUI.takeScreenshot(reportLocation + '/TC426/Step 4-Click on div failedTestMessages FailedC17094.png')

"Step 5: Click on link object -> Navigate to page 'team/*/project/*/executions/*/test-result/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/link_object_1'))

WebUI.takeScreenshot(reportLocation + '/TC426/Step 5-Click on link object - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC426/Step 6-Click on item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC426/Step 7-Click on item object2 - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC426-Handle Failed Test Messages in Executions_visual_checkpoint')
