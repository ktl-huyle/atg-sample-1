...
"Step 4: Click on link testExecutionOptions (ExecutionDetails) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 4-Click on link testExecutionOptions ExecutionDetails - Navigate to page teamprojectexecutions.png')
...
"Step 11: Click on link testRunDetails (Execution2) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 11-Click on link testRunDetails Execution2 - Navigate to page teamprojectexecutions.png')
...
"Step 22: Click on link testManagementOptions (TestRuns4)"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 22-Click on link testManagementOptions TestRuns4.png')
...
"Step 35: Click on span testCaseSwitchers (TreeSwitcher5)"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 35-Click on span testCaseSwitchers TreeSwitcher5.png')

"Step 36: Click on span testCaseSwitchers (Icon2)"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 36-Click on span testCaseSwitchers Icon2.png')

"Step 37: Click on span testCaseSwitchers (TestCases2)"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 37-Click on span testCaseSwitchers TestCases2.png')

"Step 38: Click on span testCaseSwitchers (TreeSwitcher6)"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 38-Click on span testCaseSwitchers TreeSwitcher6.png')
...
"Step 47: Click on link executionOptions (Executions) -> Navigate to page 'team/*/project/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 47-Click on link executionOptions Executions - Navigate to page teamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC28-Access Test Management Options and Verify Home Page_visual_checkpoint')
