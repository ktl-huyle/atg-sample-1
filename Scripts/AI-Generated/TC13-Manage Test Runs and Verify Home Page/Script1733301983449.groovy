...
"Step 4: Click on div historyItems (historyItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on div historyItems historyItems2.png')

"Step 5: Click on div historyItems (historyItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on div historyItems historyItems2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 9-Click on div menuItems menuItems2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 11-Click on p sessionDetails sessionDetails2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 12-Click on p sessionDetails sessionDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 13-Click on div menuItems menuItems2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 16-Click on div SelectTestSuite22 - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 51-Click on link testProjects testProjects2 - Navigate to page teamprojecttest-project.png')
...
"Step 56: Click on div iconElements (iconElements2)"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 56-Click on div iconElements iconElements2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Manage Test Runs and Verify Home Page_visual_checkpoint')
