...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/link_executionOverview', ['link_executionOverview_nthChild': link_executionOverview_nthChild, 'link_executionOverview_class': link_executionOverview_class, 'link_executionOverview_internalRoleLinkName': link_executionOverview_internalRoleLinkName, 'executions_id': executions_id, 'team_id': team_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC25/Step 3-Click on link executionOverview TestDetails - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuiteResults', ['link_testSuiteResults_internalRoleRowName': link_testSuiteResults_internalRoleRowName, 'executions_id': executions_id_1, 'team_id': team_id_2, 'project_id': project_id_2]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC25-View Test Suites and Verify Home_visual_checkpoint')
