...
"Step 5: Click on link testSuiteDetails (CPACDECPreapprovalBindTestSuite) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteDetails', ['link_testSuiteDetails_internalRoleRowName': link_testSuiteDetails_internalRoleRowName, 'project_id': project_id_1, 'executions_id': executions_id, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Click on link testSuiteDetails CPACDECPreapprovalBindTestSuite - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-View and Verify Test Suite Details in Executions_visual_checkpoint')
