...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 4-Click on button SortIDAscending.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 5-Click on span StartedAscending.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 6-Click on div dynamicObject FailedED.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 7-Click on div FailedED2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 9-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 10-Click on link Page2 - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC166-Sort and Review Project Executions_visual_checkpoint')
