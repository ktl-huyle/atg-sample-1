...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 2-Click on link executionDetails executionDetails - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-View Test Runs Overview in Team Project_visual_checkpoint')
