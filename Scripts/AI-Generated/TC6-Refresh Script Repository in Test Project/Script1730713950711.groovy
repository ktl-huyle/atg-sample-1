...
"Step 5: Schedule a test run and configure test environment settings."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Refresh Script Repository in Test Project_visual_checkpoint')
