...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_welcome/div_teamMembers', ['div_teamMembers_class': div_teamMembers_class, 'div_teamMembers_internalText': div_teamMembers_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC107/Step 4-Click on div teamMembers QualityEngineer - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 5-Click on span DownloadKatalonPackage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 6-Click on button organizationSelection MyOrganization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 7-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 8-Click on link organizationNavigation OrganizationSetup.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 9-Click on button teamMembers MA.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 10-Click on link Documentation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 11-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC107/Step 12-Click on span Settings - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC107-Download Katalon Package from Organization Home_visual_checkpoint')
