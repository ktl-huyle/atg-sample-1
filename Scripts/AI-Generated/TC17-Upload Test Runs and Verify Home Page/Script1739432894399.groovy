...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 2-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 3-Click on link RunFrequency - Navigate to page reportteamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 4-Click on button DateLabel - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Upload Test Runs and Verify Home Page_visual_checkpoint')
