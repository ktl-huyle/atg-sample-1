...
WebUI.takeScreenshot(reportLocation + '/TC447/Step 4-Click on span OrganizationButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC447/Step 5-Click on div CurrentDPButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC447/Step 6-Click on link OJOracleJDE - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC447/Step 7-Click on button OracleJDE.png')
...
WebUI.takeScreenshot(reportLocation + '/TC447/Step 8-Click on link ViewAllProjects - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC447-Navigate and View Projects in Organization_visual_checkpoint')
