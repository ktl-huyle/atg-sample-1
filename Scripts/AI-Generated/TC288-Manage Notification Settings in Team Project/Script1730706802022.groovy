...
WebUI.takeScreenshot(reportLocation + '/TC288/Step 4-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC288/Step 5-Click on link testOpsHomepage TestOpsHomepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC288/Step 6-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC288/Step 7-Click on link testOpsHomepage TestOpsHomepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC288/Step 8-Click on div organizationLinks OrganizationLink - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC288/Step 9-Click on button NotificationAction - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC288-Manage Notification Settings in Team Project_visual_checkpoint')
