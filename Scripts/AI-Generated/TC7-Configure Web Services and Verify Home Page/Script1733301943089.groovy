...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 13-Click on div integrationTools integrationTools.png')

"Step 14: Click on div iconElements (iconElements)"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 14-Click on div iconElements iconElements.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 15-Click on div testingTools testingTools.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 16-Click on div integrationTools integrationTools2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 17-Click on div testingTools testingTools2 - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Configure Web Services and Verify Home Page_visual_checkpoint')
