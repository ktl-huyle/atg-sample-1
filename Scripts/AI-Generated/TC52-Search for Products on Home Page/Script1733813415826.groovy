...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 4-Click on div SearchTermWrapper3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 5-Click on input SearchTerm3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 6-Enter input value in input SearchTerm4 - Navigate to page SearchDisplay.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC52-Search for Products on Home Page_visual_checkpoint')
