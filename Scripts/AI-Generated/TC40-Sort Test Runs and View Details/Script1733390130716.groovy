...
WebUI.takeScreenshot(reportLocation + '/TC40/Step 4-Click on button SortIDAscending.png')
...
WebUI.takeScreenshot(reportLocation + '/TC40/Step 5-Click on span StartedAscending.png')

"Step 6: Click on div failedTestRunPreRequisites (FailedTestRun3)"
...
WebUI.takeScreenshot(reportLocation + '/TC40/Step 6-Click on div failedTestRunPreRequisites FailedTestRun3.png')

"Step 7: Click on div FailedTestRun4"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_FailedTestRun4'))

WebUI.takeScreenshot(reportLocation + '/TC40/Step 7-Click on div FailedTestRun4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC40/Step 9-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC40/Step 10-Click on link Page2 - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC40-Sort Test Runs and View Details_visual_checkpoint')
