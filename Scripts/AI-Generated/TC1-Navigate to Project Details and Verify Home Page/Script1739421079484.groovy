...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Click on link details TestDetails - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Project Details and Verify Home Page_visual_checkpoint')
