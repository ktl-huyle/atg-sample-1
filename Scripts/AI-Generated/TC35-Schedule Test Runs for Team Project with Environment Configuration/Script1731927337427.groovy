...
"Step 36: Click on button alertActions (Unknown)"
...
WebUI.takeScreenshot(reportLocation + '/TC35/Step 36-Click on button alertActions Unknown.png')
...
"Step 46: Click on button alertActions (NoLicense)"
...
WebUI.takeScreenshot(reportLocation + '/TC35/Step 46-Click on button alertActions NoLicense.png')
...
"Step 49: Click on link testManagementOptions (TestCloudTunnels3)"
...
WebUI.takeScreenshot(reportLocation + '/TC35/Step 49-Click on link testManagementOptions TestCloudTunnels3.png')

"Step 50: Click on button setupActions (Setup2)"
...
WebUI.takeScreenshot(reportLocation + '/TC35/Step 50-Click on button setupActions Setup2.png')
...
"Step 54: Click on button setupActions (Setup) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC35/Step 54-Click on button setupActions Setup - Navigate to page .png')

"Step 55: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC35-Schedule Test Runs for Team Project with Environment Configuration_visual_checkpoint')
