import katalon.common.createApiKeyInSauceDemo
...
"Step 2: Create an API key by entering a name and submitting"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Create and Copy API Key in User API Key Page_visual_checkpoint')
