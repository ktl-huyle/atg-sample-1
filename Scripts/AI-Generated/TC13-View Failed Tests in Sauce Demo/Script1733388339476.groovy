...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on div failedTests FailedExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on div object.png')

"Step 6: Click on div failedTests (failedTests) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on div failedTests failedTests - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-View Failed Tests in Sauce Demo_visual_checkpoint')
