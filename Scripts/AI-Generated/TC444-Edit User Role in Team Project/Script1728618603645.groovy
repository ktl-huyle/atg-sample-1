...
WebUI.takeScreenshot(reportLocation + '/TC444/Step 4-Click on button EditUser.png')
...
WebUI.takeScreenshot(reportLocation + '/TC444/Step 5-Click on select UserTeamRole.png')
...
WebUI.takeScreenshot(reportLocation + '/TC444/Step 6-Click on button Save - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC444-Edit User Role in Team Project_visual_checkpoint')
