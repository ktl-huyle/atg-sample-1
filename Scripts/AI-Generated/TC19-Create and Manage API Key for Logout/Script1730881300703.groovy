...
"Step 6: Create a new API key for application access and management"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Create and Manage API Key for Logout_visual_checkpoint')
