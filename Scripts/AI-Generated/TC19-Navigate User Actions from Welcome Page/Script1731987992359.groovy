...
"Step 2: Click on div qualityEngineer (QualityEngineer) -> Navigate to page 'organization/*/home'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/welcome?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_welcome/div_qualityEngineer'))

WebUI.takeScreenshot()

"Step 3: Click on button userAction (AR)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Navigate User Actions from Welcome Page_visual_checkpoint')
