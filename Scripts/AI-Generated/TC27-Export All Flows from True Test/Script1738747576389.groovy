...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 25-Click on p navigationActions VerifyNavigationHome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 27-Click on p navigationActions VerifyInternetBundles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 28-Click on button detailFlowActions UnknownAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 32-Click on p navigationActions NavigateInteract.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 33-Click on button detailFlowActions ShowDetailFlow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 36-Click on button detailFlowActions ShowDetailFlow2 - Navigate to page .png')

"Step 37: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Export All Flows from True Test_visual_checkpoint')
