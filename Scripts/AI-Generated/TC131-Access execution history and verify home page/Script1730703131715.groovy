...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 5-Click on header testRunDetails EPPsAutomationTestCaseRun.png')

"Step 6: Click on button sessionActions (Sessions2)"
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 6-Click on button sessionActions Sessions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 7-Click on div historyInfo HistorySchedule.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 8-Click on header testRunDetails EPPsAutomationTestCaseRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 9-Click on header testRunDetails EPPsAutomationTestCaseRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 10-Click on button Details2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 11-Click on button Action1.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 12-Click on button actionButtons Action2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 13-Click on button actionButtons Action2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC131/Step 14-Click on button actionButtons Action3 - Navigate to page .png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC131-Access execution history and verify home page_visual_checkpoint')
