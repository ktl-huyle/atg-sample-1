...
"Step 7: Delete failed test executions from the test results"

deleteFailedTestExecutions.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Delete failed test executions from the test results"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Delete Failed Test Executions from Results_visual_checkpoint')
