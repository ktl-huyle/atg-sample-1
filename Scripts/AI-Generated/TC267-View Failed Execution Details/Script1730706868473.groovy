...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 4-Click on div failedPreRequisites FailedCreateReverse.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 5-Click on div failedExecutionDetails FailedQueryIndex.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 6-Click on div failedExecutionDetails FailedFilterClaims.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 8-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 9-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 10-Click on button Close2 - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 11-Click on link executionDetails ProjectExecutionDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 12-Click on link executionDetails JRHMParallel - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 13-Click on div failedExecutionDetails FailedCreateReverse2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 14-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 15-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 16-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC267/Step 17-Click on button Close - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC267-View Failed Execution Details_visual_checkpoint')
