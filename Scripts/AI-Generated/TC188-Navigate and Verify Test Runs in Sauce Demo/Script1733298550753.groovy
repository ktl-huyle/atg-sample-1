...
"Step 4: Click on div testRunItems (testRunItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC188/Step 4-Click on div testRunItems testRunItems2.png')

"Step 5: Click on div underTopNavbar -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_underTopNavbar'))

WebUI.takeScreenshot(reportLocation + '/TC188/Step 5-Click on div underTopNavbar - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC188-Navigate and Verify Test Runs in Sauce Demo_visual_checkpoint')
