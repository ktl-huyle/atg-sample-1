...
"Step 4: Schedule and run tests with various configurations"
...
"Step 13: Schedule and run tests with various configurations"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Schedule and Run Tests with Various Configurations_visual_checkpoint')
