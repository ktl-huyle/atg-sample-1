...
"Step 3: Click on link testResults (TestResults) -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-suites/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_design_test_suites/link_testResults'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Verify Navigation to Test Results from Team Project Executions_visual_checkpoint')
