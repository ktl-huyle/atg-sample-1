...
import truetest.common.navigateAndScheduleTestRunForProject
...
"Step 2: Navigate through project settings and schedule a test run."

navigateAndScheduleTestRunForProject.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC68-Configure Test Suite Settings in Team Project_visual_checkpoint')
