...
"Step 3: Click on link organizationHome (OrganizationHome) -> Navigate to page 'organization/*/home'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/web-services?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_web_services/link_organizationHome"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_web_services/link_organizationHome', ['link_organizationHome_organization_id': link_organizationHome_organization_id]))
...
"Step 13: Click on div testingTools (MobileDeviceTesting)"
...
"Step 15: Click on div testingTools (TestingFramework) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Verify Web Services Settings and Integrations_visual_checkpoint')
