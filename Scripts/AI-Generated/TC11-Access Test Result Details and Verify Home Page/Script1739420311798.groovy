...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 14-Click on pre failedTestCases FailedTest.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Access Test Result Details and Verify Home Page_visual_checkpoint')
