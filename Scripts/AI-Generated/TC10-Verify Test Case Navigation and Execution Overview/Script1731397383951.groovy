...
"Step 9: Click on span treeSwitcher (KatalonStudioTestCases)"
...
"Step 20: Click on div dynamicObject (MenuBackdrop)"
...
"Step 35: Click on link testSuiteOptions (TestSuiteValidationDañosMenores) -> Navigate to page 'team/*/project/*/test-design/test-suites/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-suites?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_design_test_suites/link_testSuiteOptions'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Verify Test Case Navigation and Execution Overview_visual_checkpoint')
