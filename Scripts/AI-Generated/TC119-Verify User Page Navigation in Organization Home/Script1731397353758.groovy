...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/span_object7'))

WebUI.takeScreenshot()

"Step 6: Click on span object8"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/span_object8'))
...
"Step 9: Click on button sabrina"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_sabrina'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC119-Verify User Page Navigation in Organization Home_visual_checkpoint')
