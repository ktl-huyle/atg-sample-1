...
WebUI.takeScreenshot(reportLocation + '/TC429/Step 4-Click on button runActions linkToArelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC429/Step 5-Click on span r5MaintenanceR5.png')

"Step 6: Click on button runActions (run2)"
...
WebUI.takeScreenshot(reportLocation + '/TC429/Step 6-Click on button runActions run2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC429/Step 7-Click on link reports - Navigate to page teamproject.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC429-Run Actions and View Reports in Team Project_visual_checkpoint')
