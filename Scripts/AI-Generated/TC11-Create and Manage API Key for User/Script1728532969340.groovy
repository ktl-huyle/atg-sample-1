...
"Step 2: Create a new API key for testing purposes with specified name"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Manage API Key for User_visual_checkpoint')
