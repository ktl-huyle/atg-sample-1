...
"Step 31: Click on button dynamicObject (object2)"
...
"Step 41: Click on button dynamicObject (object4)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-planning?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_planning/button_dynamicObject"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_planning/button_dynamicObject', ['button_dynamicObject_class': button_dynamicObject_class_1]))
...
"Step 45: Click on button tunnelSetup (setupTunnels2)"
...
"Step 49: Click on button tunnelSetup (setupTunnels) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC67-Manage Test Project and Configure Settings_visual_checkpoint')
