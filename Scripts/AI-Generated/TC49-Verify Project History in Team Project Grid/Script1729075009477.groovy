...
WebUI.takeScreenshot(reportLocation + '/TC49/Step 4-Click on link History - Navigate to page team projectteamproject.png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC49-Verify Project History in Team Project Grid_visual_checkpoint')
