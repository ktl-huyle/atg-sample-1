...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 2-Click on link files - Navigate to page file managementteamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 3-Click on link fileDownload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 4-Click on button reRun - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC37-Download File and Verify Home Page_visual_checkpoint')
