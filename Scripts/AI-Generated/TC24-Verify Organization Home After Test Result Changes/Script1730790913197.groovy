...
"Step 2: Mark a test result as passed and submit the status change."

manageTestResultStatus.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 16: Mark a test result as passed and submit the status change."

manageTestResultStatus.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Verify Organization Home After Test Result Changes_visual_checkpoint')
