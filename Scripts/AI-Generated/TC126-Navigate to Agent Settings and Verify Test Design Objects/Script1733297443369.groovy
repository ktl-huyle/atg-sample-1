...
"Step 4: Click on link myAgent (OfflineMyAgent) -> Navigate to page 'organization/*/settings/agent/local/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/settings/agent?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_organization_settings_agent/link_myAgent"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_settings_agent/link_myAgent', ['local_id': local_id, 'organization_id': organization_id]))

WebUI.takeScreenshot(reportLocation + '/TC126/Step 4-Click on link myAgent OfflineMyAgent - Navigate to page organizationsettingsagentlocal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 5-Click on link AgentSettings - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 6-Click on link Kubernetes - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 7-Click on link CircleCI.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 8-Click on link Local - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 9-Click on button Navigation - Navigate to page organizationhome.png')

"Step 10: Click on link projectDetails (FPFirstProject) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 10-Click on link projectDetails FPFirstProject - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 11-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 12-Click on link Executions - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 13-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 14-Click on link Executions - Navigate to page teamproject.png')

"Step 15: Click on link reportsSettings (Reports)"
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 15-Click on link reportsSettings Reports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 16-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 17-Click on link TestSuites - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 18-Click on link TestObjects - Navigate to page teamprojecttest-designtest-objects.png')

"Step 19: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC126-Navigate to Agent Settings and Verify Test Design Objects_visual_checkpoint')
