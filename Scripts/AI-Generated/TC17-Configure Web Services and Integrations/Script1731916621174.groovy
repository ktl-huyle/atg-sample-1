...
"Step 3: Click on link organizationNavigation (OrganizationHome) -> Navigate to page 'organization/*/home'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/web-services?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_web_services/link_organizationNavigation"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_web_services/link_organizationNavigation', ['link_organizationNavigation_organization_id': link_organizationNavigation_organization_id]))

WebUI.takeScreenshot()

"Step 4: Click on link dataDisplayOptions (NoDataDisplay) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Configure Web Services and Integrations_visual_checkpoint')
