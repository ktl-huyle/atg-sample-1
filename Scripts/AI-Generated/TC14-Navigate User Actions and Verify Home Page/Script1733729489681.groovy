...
"Step 5: Click on button userAction (ar)"
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 5-Click on button userAction ar.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Navigate User Actions and Verify Home Page_visual_checkpoint')
