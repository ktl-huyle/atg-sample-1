...
"Step 3: Click on button selectOrganization2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_selectOrganization2'))
...
"Step 5: Click on link sSenyum -> Navigate to page 'team/*/project/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC42-Verify Team Project Executions from Organization Home_visual_checkpoint')
