...
import katalon.common.markFailedLoginsAsPassed
...
"Step 2: Mark failed portal logins as passed based on manual tests"

markFailedLoginsAsPassed.execute()
...
"Step 16: Mark failed portal logins as passed based on manual tests"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Mark Failed Logins as Passed and Verify Page_visual_checkpoint')
