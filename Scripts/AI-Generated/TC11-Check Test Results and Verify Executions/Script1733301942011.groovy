...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 4-Click on link TestSuitesCPACDECPreapprovalBind - Navigate to page teamprojecttest-designtest-suites.png')

"Step 5: Click on link TestSuiteValidation (FailedTestSuite) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_TestSuiteValidation', ['executions_id': executions_id, 'team_id': team_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 5-Click on link TestSuiteValidation FailedTestSuite - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 8-Click on button TestResultDetails - Navigate to page teamprojectexecutions.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Check Test Results and Verify Executions_visual_checkpoint')
