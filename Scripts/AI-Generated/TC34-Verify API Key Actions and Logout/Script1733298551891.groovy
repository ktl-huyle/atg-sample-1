...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 4-Click on button apiKeyActions APIKeyCell2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 5-Click on button apiKeyActions ShowApiKey.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 6-Click on button copyActions CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 12-Click on button apiKeyActions ShowApiKey2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 13-Click on button copyActions CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 16-Click on link SignOut2 - Navigate to page logout.png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC34-Verify API Key Actions and Logout_visual_checkpoint')
