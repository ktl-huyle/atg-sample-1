...
import truetest.common.markTestResults
...
"Step 2: View and mark test results as passed in the project execution"

markTestResults.execute()
...
"Step 16: View and mark test results as passed in the project execution"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Verify Organization Home After Test Result Updates_visual_checkpoint')
