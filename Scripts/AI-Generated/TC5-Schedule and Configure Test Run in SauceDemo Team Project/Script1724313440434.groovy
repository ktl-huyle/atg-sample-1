...
import katalon.common.editProjectDetailsInSauceDemo
...
"Step 5: Click on header gitSetUpCreateNew"
...
"Step 7: Edit project details and save changes in SauceDemo"

editProjectDetailsInSauceDemo.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Click on button object -> Navigate to page '/team/320312/project/434641/test-design/test-cases'"
...
// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/320312/project/434641/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_teamprojecttest_design_test_cases/div_demoTargetDirectory'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_teamprojecttest_design_test_cases/div_testCases'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_teamprojecttest_design_test_cases/div_object'))
...
"Step 13: Click on div testSuites -> Navigate to page 'team/*/project/*/grid'"
...
"Step 16: Enter input value in input name"
...
"Step 19: Click on button katalonCommand"
...
"Step 20: Enter input value in textarea katalonCommand"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_team_project_grid/textarea_katalonCommand'), textarea_katalonCommand)
...
"Step 22: Click on item scheduleTestRunCreated"
...
"Step 23: Click on input radioButtons"
...
"Step 26: Click on button saveConfigureTs"
...
"Step 27: Click on button advancedSettings"
...
"Step 32: Click on link settings -> Navigate to page 'team/*/project/*/settings'"
...
"Step 34: Click on link demoTargetDirectory -> Navigate to page 'team/*/project/*/test-project/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_project/link_demoTargetDirectory'))

WebUI.takeScreenshot()

"Step 35: Click on button delete"
...
"Step 36: Click on button delete -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Schedule and Configure Test Run in SauceDemo Team Project_visual_checkpoint')
