...
"Step 47: Click on pre interceptedActions (ClickIntercepted)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/pre_interceptedActions'))

WebUI.takeScreenshot()

"Step 48: Click on pre interceptedActions (ClickIntercepted)"
...
"Step 49: Click on pre interceptedActions (ClickIntercepted)"
...
"Step 50: Click on pre interceptedActions (ClickIntercepted)"
...
"Step 51: Click on pre interceptedActions (ClickIntercepted)"
