...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 14-Click on div testSuiteDetails EHSTestAutomation.png')

"Step 15: Click on div testSuiteDetails (TestSuites3)"
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 15-Click on div testSuiteDetails TestSuites3.png')

"Step 16: Click on div testSuiteDetails (KatalonCloud2)"
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 16-Click on div testSuiteDetails KatalonCloud2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 17-Click on div testSuiteDetails UploadedData.png')

"Step 18: Click on div testSuiteDetails (TestSuites4)"
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 18-Click on div testSuiteDetails TestSuites4.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Schedule Test Runs and Manage Test Suites_visual_checkpoint')
