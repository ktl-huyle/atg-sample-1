...
"Step 8: Click on input testCaseCheckbox"
...
"Step 11: Click on link katalonWebsiteGit -> Navigate to page 'team/*/project/*/test-project/*'"
...
"Step 14: Click on div successMessage"
...
"Step 15: Click on div historyCalendarSchedules"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-planning?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_planning/div_historyCalendarSchedules'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC34-Schedule Multiple Test Runs in Team Project_visual_checkpoint')
