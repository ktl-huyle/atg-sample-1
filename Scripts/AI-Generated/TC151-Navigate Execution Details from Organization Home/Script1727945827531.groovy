...
"Step 4: Click on link testRunDetails (Execution561) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/link_testRunDetails', ['link_testRunDetails_class': link_testRunDetails_class, 'link_testRunDetails_nthChild': link_testRunDetails_nthChild, 'link_testRunDetails_internalRoleLinkName': link_testRunDetails_internalRoleLinkName, 'link_testRunDetails_project_id': link_testRunDetails_project_id, 'link_testRunDetails_team_id': link_testRunDetails_team_id, 'link_testRunDetails_executions_id': link_testRunDetails_executions_id]))

WebUI.takeScreenshot(reportLocation + '/TC151/Step 4-Click on link testRunDetails Execution561 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC151/Step 5-Click on link Execution2592 - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC151/Step 6-Click on link TestCloudWindowsChrome - Navigate to page teamprojectagenttest-cloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC151/Step 7-Click on link pageNavigation Page4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC151/Step 8-Click on link pageNavigation Page3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC151/Step 9-Click on link pageNavigation Page2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC151/Step 10-Click on link pageNavigation Page1.png')
...
WebUI.takeScreenshot(reportLocation + '/TC151/Step 11-Click on link pageNavigation Page2 - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC151-Navigate Execution Details from Organization Home_visual_checkpoint')
