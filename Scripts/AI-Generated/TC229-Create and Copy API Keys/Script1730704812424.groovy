...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 4-Click on button apiKeyControls CellButton2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 5-Click on button apiKeyControls ShowApiKey2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 6-Click on button copyToClipboard CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 7-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 9-Click on button apiKeyControls ShowApiKey3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 10-Click on button copyToClipboard CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 11-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 12-Click on button NidhiKachhadiya.png')
...
WebUI.takeScreenshot(reportLocation + '/TC229/Step 13-Click on link SignOut - Navigate to page logout.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC229-Create and Copy API Keys_visual_checkpoint')
