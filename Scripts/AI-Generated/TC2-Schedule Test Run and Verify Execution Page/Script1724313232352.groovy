...
"Step 3: Schedule a test run and choose the created options"

scheduleTestRunAndSelectOptions.execute()

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Schedule Test Run and Verify Execution Page_visual_checkpoint')
