...
"Step 6: Click on div penTestIssues (penTestIssues2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_penTestIssues'))

WebUI.takeScreenshot(reportLocation + '/TC38/Step 6-Click on div penTestIssues penTestIssues2.png')
...
"Step 10: Click on div penTestIssues (penTestIssues2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_penTestIssues'))

WebUI.takeScreenshot(reportLocation + '/TC38/Step 10-Click on div penTestIssues penTestIssues2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC38-Access Pen Test Issues and Verify Executions_visual_checkpoint')
