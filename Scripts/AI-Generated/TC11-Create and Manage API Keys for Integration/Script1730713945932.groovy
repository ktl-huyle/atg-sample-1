...
import truetest.common.createApiKeyForIntegration
...
"Step 2: Create a new API key for application integration."

createApiKeyForIntegration.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 7: Click on button copyAction (CopyToClipboard)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Manage API Keys for Integration_visual_checkpoint')
