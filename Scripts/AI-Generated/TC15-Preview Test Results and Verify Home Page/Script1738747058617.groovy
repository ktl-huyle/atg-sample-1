...
"Step 2: Click on pre failedTestInfo (ErrorMessage)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 2-Click on pre failedTestInfo ErrorMessage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Preview Test Results and Verify Home Page_visual_checkpoint')
