...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 9-Click on label failedTests failedTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 10-Click on label failedTests failedTest2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC39-Delete Execution and Verify Team Project Executions_visual_checkpoint')
