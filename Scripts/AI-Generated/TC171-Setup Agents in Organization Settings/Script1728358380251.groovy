...
WebUI.takeScreenshot(reportLocation + '/TC171/Step 4-Click on link AgentSetup2 - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC171/Step 5-Click on link TestEnvironments - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC171/Step 6-Click on link agentLinks MyAgent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC171/Step 8-Click on link AgentSetup - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC171/Step 9-Click on link TestEnvironments - Navigate to page organizationsettingsagent.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC171-Setup Agents in Organization Settings_visual_checkpoint')
