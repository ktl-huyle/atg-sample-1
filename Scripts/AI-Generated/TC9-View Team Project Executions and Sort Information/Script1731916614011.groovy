...
"Step 2: Click on div sortInformation (SortInfo)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_sortInformation"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_sortInformation', ['div_sortInformation_internalText': div_sortInformation_internalText]))
...
"Step 4: Click on div sortInformation (SortInfo2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_sortInformation"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_sortInformation', ['div_sortInformation_internalText': div_sortInformation_internalText_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-View Team Project Executions and Sort Information_visual_checkpoint')
