...
import truetest.common.navigateTeamProjectAndScheduleTestRun
...
"Step 2: Navigate through team project settings and schedule test run"

navigateTeamProjectAndScheduleTestRun.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC67-Manage Test Project Configurations and Verify Home Page_visual_checkpoint')
