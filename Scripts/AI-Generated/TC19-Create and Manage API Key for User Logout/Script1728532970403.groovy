...
"Step 6: Create a new API key for testing purposes with specified name"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Create and Manage API Key for User Logout_visual_checkpoint')
