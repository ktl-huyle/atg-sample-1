...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/link_participantManagement', ['link_participantManagement_nthChild': link_participantManagement_nthChild, 'link_participantManagement_class': link_participantManagement_class, 'link_participantManagement_internalRoleLinkName': link_participantManagement_internalRoleLinkName, 'executions_id': executions_id, 'team_id': team_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on link participantManagement participantManagement2 - Navigate to page teamprojectexecutions.png')

"Step 5: Click on link testItems (testItems) -> Navigate to page 'team/*/project/*/test-design/test-cases'"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Click on link testItems testItems - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 6-Click on div testCases UploadedData.png')
...
"Step 8: Click on div testSuiteItems (testSuiteItems)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 8-Click on div testSuiteItems testSuiteItems.png')

"Step 9: Click on div testSuiteItems (testSuiteItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Click on div testSuiteItems testSuiteItems2.png')

"Step 10: Click on div testSuiteItems (testSuiteItems3)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 10-Click on div testSuiteItems testSuiteItems3.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['link_testSuiteActions_internalRoleLinkName': link_testSuiteActions_internalRoleLinkName, 'team_id': team_id_2, 'test_suites_id': test_suites_id, 'project_id': project_id_2]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Navigate Test Design and Verify Test Suites_visual_checkpoint')
