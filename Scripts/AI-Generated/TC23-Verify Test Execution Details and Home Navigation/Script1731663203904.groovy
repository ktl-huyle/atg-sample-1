...
"Step 2: Navigate to test result details and mark as passed"

navigateAndMarkTestResultAsPassed.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 16: Navigate to test result details and mark as passed"

navigateAndMarkTestResultAsPassed.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Verify Test Execution Details and Home Navigation_visual_checkpoint')
