...
"Step 7: Click on button apiKeyAction (ActionButton)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_apiKeyAction'))
...
"Step 9: Click on input apiKeyCredentials (ApiKeyTextbox)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/input_apiKeyCredentials'))

WebUI.takeScreenshot()

"Step 10: Click on input apiKeyCredentials (PasswordField)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/input_apiKeyCredentials_1'))

WebUI.takeScreenshot()

"Step 11: Click on button copyToClipboard (CopyToClipboard)"
...
"Step 12: Click on button UserProfile"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Copy API Key then Sign Out_visual_checkpoint')
