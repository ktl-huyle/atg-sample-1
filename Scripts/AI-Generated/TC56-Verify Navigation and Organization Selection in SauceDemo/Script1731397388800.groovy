...
"Step 2: Click on div object3 -> Navigate to page 'organization/*/home'"
...
"Step 4: Click on button selectOrganization3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_selectOrganization3'))
...
"Step 6: Click on link organization"
...
"Step 7: Click on button mouhamedAmineBouaicha"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_mouhamedAmineBouaicha'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC56-Verify Navigation and Organization Selection in SauceDemo_visual_checkpoint')
