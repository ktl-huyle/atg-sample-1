...
"Step 4: Click on link testRunDetails (TestExecution 44) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 4-Click on link testRunDetails TestExecution 44 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 5-Click on button AddTestCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 6-Click on button RecordTestSteps - Navigate to page teamprojecttest-designtest-casesedit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 7-Click on span dragSelect DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 8-Click on span dragSelect DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 9-Click on span dragSelect DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 10-Click on button AddNewTestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 11-Click on div dynamicObject ClickOnObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 12-Click on input dynamicObject ObjectInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 13-Click on div ObjectInputContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 14-Click on div CaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 15-Click on button Save.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 16-Click on div Unknown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 17-Click on button AddNewTestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 18-Enter input value in input dynamicObject AutocompleteInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 19-Click on div dynamicObject SelectValueDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 20-Click on input ValueInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 21-Click on input dynamicObject DropdownObjectInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 22-Click on div CaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 23-Click on input ValueInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 24-Enter input value in input ValueInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 25-Click on button Save2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 26-Click on input dynamicObject Checkbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 27-Click on input dynamicObject DragSelectCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 28-Click on input dynamicObject DragSelectCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 29-Click on input dynamicObject DragSelectCheckbox3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 30-Click on input dynamicObject DragSelectCheckbox4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 31-Click on input dynamicObject DragSelectCheckbox5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 32-Click on input dynamicObject DragSelectCheckbox6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 33-Click on input dynamicObject DragSelectCheckbox7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 34-Click on input dynamicObject DragSelectCheckbox8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 35-Click on span DeleteSelectedSteps.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 36-Click on div RecordPlayback.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 37-Click on button Playback.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 38-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 39-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 40-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 41-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 42-Click on button Edit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 43-Click on input ValueInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 44-Click on input ValueInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 45-Enter input value in input ValueInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 46-Click on button Save3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC106/Step 47-Click on button Playback - Navigate to page .png')

"Step 48: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC106-Record and Edit Test Steps in Test Cases_visual_checkpoint')
