...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 4-Click on td testAutomation EncompassOpsTestAutomation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 5-Click on td testAutomation EncompassOpsTestAutomation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 6-Click on link testAutomation EncompassOpsTestAutomation - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 7-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 8-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 9-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 11-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 12-Click on link OrganizationSetupConfigure - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 13-Click on link AgentSetup - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 14-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 16-Click on link ViewEPPsAutomationTest - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC252/Step 17-Click on header testRunDetails EPPsAutomationTestCaseRun - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC252-Schedule Test Run with Configurations_visual_checkpoint')
