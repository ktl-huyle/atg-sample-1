...
"Step 4: Configure environments for test suites and save settings"

configureTestSuitesEnvironmentsAndSave.execute()

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC115-Edit Test Suites Environments and Save_visual_checkpoint')
