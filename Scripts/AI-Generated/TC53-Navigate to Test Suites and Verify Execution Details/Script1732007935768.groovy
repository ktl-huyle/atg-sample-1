...
"Step 5: Click on link executionDetails (TestExecution3827) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC53/Step 5-Click on link executionDetails TestExecution3827 - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuites', ['link_testSuites_internalRoleRowName': link_testSuites_internalRoleRowName, 'project_id': project_id_2, 'executions_id': executions_id_1, 'team_id': team_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC53/Step 8-Click on link testSuites PassedCoordinatorCore - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC53-Navigate to Test Suites and Verify Execution Details_visual_checkpoint')
