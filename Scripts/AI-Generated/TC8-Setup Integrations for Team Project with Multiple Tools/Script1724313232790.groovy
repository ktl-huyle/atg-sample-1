...
"Step 5: Click on link settings -> Navigate to page 'team/*/project/*/*'"
...
"Step 6: Click on link teamProjectTestCloudTunnel"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_teamProjectTestCloudTunnel'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/div_object_2'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Setup Integrations for Team Project with Multiple Tools_visual_checkpoint')
