...
WebUI.takeScreenshot(reportLocation + '/TC430/Step 4-Click on link files4 - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC430/Step 5-Click on link executionFiles 20240821 125108Html.png')
...
WebUI.takeScreenshot(reportLocation + '/TC430/Step 6-Click on button reRun - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC430-Re run Execution Files in Team Project_visual_checkpoint')
