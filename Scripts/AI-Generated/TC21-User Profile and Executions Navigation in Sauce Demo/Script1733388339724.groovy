...
"Step 4: Click on button userProfile (userProfile3)"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 4-Click on button userProfile userProfile3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 7-Click on span settingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 9-Click on span settingsButton.png')

"Step 10: Click on link navigation (navigation2)"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 10-Click on link navigation navigation2.png')

"Step 11: Click on div objectItems -> Navigate to page 'team/*/project/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/div_objectItems'))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 11-Click on div objectItems - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 12-Click on link Executions4 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 14-Click on link Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 15-Click on button NotificationAction - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC21-User Profile and Executions Navigation in Sauce Demo_visual_checkpoint')
