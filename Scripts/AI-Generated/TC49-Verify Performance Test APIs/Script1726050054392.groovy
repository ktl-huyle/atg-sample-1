...
WebUI.takeScreenshot(reportLocation + '/TC49/Step 4-Click on div infoSidebarWrapper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC49/Step 5-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC49/Step 6-Click on link perfTestApis01User - Navigate to page teamprojectgridplanjob.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC49-Verify Performance Test APIs_visual_checkpoint')
