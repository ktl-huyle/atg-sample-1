...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on button object.png')

"Step 5: Click on button showApikey"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_showApikey'))

WebUI.takeScreenshot(reportLocation + '/TC20/Step 5-Click on button showApikey.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 6-Click on button copyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 7-Click on button object2.png')

"Step 8: Create a new API key for application access"

createNewApiKey.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Click on button showApikey2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_showApikey2'))

WebUI.takeScreenshot(reportLocation + '/TC20/Step 9-Click on button showApikey2.png')

"Step 10: Click on button copyToClipboard"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_copyToClipboard'))

WebUI.takeScreenshot(reportLocation + '/TC20/Step 10-Click on button copyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 11-Click on button object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 12-Click on button nk.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 13-Click on link signOut - Navigate to page .png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Create and Copy API Keys for Application Access_visual_checkpoint')
