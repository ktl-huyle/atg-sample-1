...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 5-Click on link projectLinks testOpsSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 6-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 7-Click on link projectLinks testOpsSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 8-Click on div projectInfo encompassInfo - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 9-Click on button notificationAction - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Verify Project Links and Settings Navigation_visual_checkpoint')
