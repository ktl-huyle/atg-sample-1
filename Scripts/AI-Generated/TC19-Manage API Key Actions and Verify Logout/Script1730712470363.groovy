...
"Step 6: Create a new API key for testing purposes"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Manage API Key Actions and Verify Logout_visual_checkpoint')
