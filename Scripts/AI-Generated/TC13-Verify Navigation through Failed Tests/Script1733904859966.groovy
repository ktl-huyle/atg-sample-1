...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on pre failedTests FailedE2EFlow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Navigation through Failed Tests_visual_checkpoint')
