...
"Step 4: Click on div testRunInfo (testRunCell)"
...
WebUI.takeScreenshot(reportLocation + '/TC194/Step 4-Click on div testRunInfo testRunCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC194/Step 5-Click on div Navbar.png')

"Step 6: Click on div testRunInfo (TestRunCell2)"
...
WebUI.takeScreenshot(reportLocation + '/TC194/Step 6-Click on div testRunInfo TestRunCell2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC194/Step 7-Click on div testRunDetails UntitledTestRun4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC194/Step 8-Click on div Navbar - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC194-View and Verify Test Run Details_visual_checkpoint')
