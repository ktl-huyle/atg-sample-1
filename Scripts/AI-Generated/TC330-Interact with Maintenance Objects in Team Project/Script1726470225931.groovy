...
WebUI.takeScreenshot(reportLocation + '/TC330/Step 4-Click on button dynamicObject linkToArelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC330/Step 5-Click on div r5MaintenanceR5.png')

"Step 6: Click on button dynamicObject (run2) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC330/Step 6-Click on button dynamicObject run2 - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC330-Interact with Maintenance Objects in Team Project_visual_checkpoint')
