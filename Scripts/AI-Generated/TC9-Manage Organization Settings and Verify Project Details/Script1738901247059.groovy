...
"Step 9: Click on link testCases (Tests) -> Navigate to page 'team project details#team/*/project/*/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on link testCases Tests - Navigate to page team project detailsteamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Manage Organization Settings and Verify Project Details_visual_checkpoint')
