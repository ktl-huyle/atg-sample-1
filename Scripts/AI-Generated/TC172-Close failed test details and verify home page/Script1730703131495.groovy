...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 4-Click on div MainContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 5-Click on div Toolbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 6-Click on pre failedTestDetails FailedKundensonderpreise.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 8-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 9-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 10-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 11-Click on span FailedRechnungSpeichern.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 12-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 13-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 14-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC172/Step 15-Click on button Close3 - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC172-Close failed test details and verify home page_visual_checkpoint')
