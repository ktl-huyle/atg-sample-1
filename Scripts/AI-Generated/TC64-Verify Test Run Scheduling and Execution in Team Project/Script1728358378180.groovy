...
"Step 4: Click on link organizationLinks (firstProjectNoData) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 4-Click on link organizationLinks firstProjectNoData - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 5-Click on link tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 6-Click on link executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 7-Click on div testRunDetails untitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 8-Click on button Details2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 9-Click on link files - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 10-Click on div testRunDetails untitledTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 11-Click on button Details2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 12-Click on link files2 - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 13-Click on link executions.png')

"Step 14: Schedule a test run and execute the selected test suite."
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 15-Click on button sessionTabs sessionsTab.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 16-Click on div sortingInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 17-Click on div historyInfo historyInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 18-Click on div testExecutionLabel.png')

"Step 19: Click on div testRunSections (untitledTestRun3)"
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 19-Click on div testRunSections untitledTestRun3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 20-Click on button Details2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 21-Click on link files3 - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 22-Click on link executionFiles executionFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 23-Click on button downloadExecutionFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 24-Click on button compressFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 25-Click on link exportExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 26-Click on link pageLinks page2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 27-Click on link pageLinks page3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 28-Click on link executionFiles executionReport - Navigate to page .png')

"Step 29: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC64-Verify Test Run Scheduling and Execution in Team Project_visual_checkpoint')
