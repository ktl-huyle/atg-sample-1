...
"Step 3: Click on link apiV1KatalonDownloadPlatformWin64TypeKse"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_apiV1KatalonDownloadPlatformWin64TypeKse'))
...
"Step 11: Click on link apiV1KatalonDownloadPlatformWin64TypeKse -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC41-Download Katalon Studio and Setup Repository_visual_checkpoint')
