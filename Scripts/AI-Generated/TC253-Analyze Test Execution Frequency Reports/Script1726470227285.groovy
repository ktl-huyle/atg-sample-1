...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 4-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 5-Click on link runFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 6-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 7-Click on link dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 8-Click on link reports - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC253/Step 9-Click on link runFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC253-Analyze Test Execution Frequency Reports_visual_checkpoint')
