...
"Step 4: Click on link calendarDetails (calendar) -> Navigate to page 'team/*/project/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC82/Step 4-Click on link calendarDetails calendar - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC82/Step 5-Click on div testRunDetails loading - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC82-View Calendar Details in Team Project_visual_checkpoint')
