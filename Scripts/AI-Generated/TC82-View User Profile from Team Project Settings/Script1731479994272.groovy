...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_pasukanOdin'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC82-View User Profile from Team Project Settings_visual_checkpoint')
