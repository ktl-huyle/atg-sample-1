...
import truetest.common.viewAndUpdateTestResultStatus
...
"Step 2: View and update the status of test results"

viewAndUpdateTestResultStatus.execute()
...
"Step 16: View and update the status of test results"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Manage and Update Test Results in Team Project_visual_checkpoint')
