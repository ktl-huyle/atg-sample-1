...
"Step 2: Create a new API key with specified name and options"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Copy API Key from User Settings_visual_checkpoint')
