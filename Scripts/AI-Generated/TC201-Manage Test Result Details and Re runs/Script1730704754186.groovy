...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 4-Click on span failedSortAndFilter FailedSortAndFilter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 5-Click on span failedSortAndFilter FailedSortAndFilter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 6-Click on div CloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 7-Click on button testResultDetails GoToTestResult.png')
...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 8-Click on link TestResults3 - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 9-Click on link ReRuns - Navigate to page teamprojectexecutionstest-resultre-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 10-Click on link Result2 - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC201/Step 11-Click on span listenerActions CreatedWithSketchtool - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC201-Manage Test Result Details and Re runs_visual_checkpoint')
