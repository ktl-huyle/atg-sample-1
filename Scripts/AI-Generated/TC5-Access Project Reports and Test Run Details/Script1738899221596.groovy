...
"Step 5: Click on link testRunDetails (ExecutionDetail2) -> Navigate to page 'team project executions#team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on link testRunDetails ExecutionDetail2 - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Access Project Reports and Test Run Details_visual_checkpoint')
