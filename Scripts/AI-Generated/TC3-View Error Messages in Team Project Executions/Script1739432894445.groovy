...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Click on pre ErrorMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on button ShowSlide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Click on div PreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 8-Click on button close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 9-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 10-Click on button Download - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-View Error Messages in Team Project Executions_visual_checkpoint')
