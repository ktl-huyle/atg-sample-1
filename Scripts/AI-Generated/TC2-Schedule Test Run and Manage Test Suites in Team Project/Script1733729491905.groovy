...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Click on div testRunDetails APImediaFiles.png')

"Step 5: Click on div SortID"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_SortID'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 5-Click on div SortID.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 8-Click on div Select.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 11-Click on div ExecutionProfile.png')
...
"Step 13: Click on link TestSuitesTS10Product"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_TestSuitesTS10Product'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 13-Click on link TestSuitesTS10Product.png')
...
"Step 15: Click on link RefreshTestRuns"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_RefreshTestRuns'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 15-Click on link RefreshTestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 16-Click on div CustomSelectValue.png')
...
"Step 20: Click on link testProject (katalonWebsite) -> Navigate to page 'team/*/project/*/test-project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 20-Click on link testProject katalonWebsite - Navigate to page teamprojecttest-project.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Schedule Test Run and Manage Test Suites in Team Project_visual_checkpoint')
