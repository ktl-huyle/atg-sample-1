...
"Step 7: Click on link testOpsLinks (ProjectManagement) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 7-Click on link testOpsLinks ProjectManagement - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Access User Settings and Verify Home Page_visual_checkpoint')
