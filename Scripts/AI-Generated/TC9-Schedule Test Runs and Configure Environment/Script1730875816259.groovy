...
"Step 10: Click on p sessionDetails (TwoSessions)"
...
"Step 52: Click on div integrationOptions (CodelessAutomationTool)"
...
"Step 53: Click on div integrationOptions (CodelessAutomationTool2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationOptions_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationOptions_1', ['div_integrationOptions_class': div_integrationOptions_class]))

WebUI.takeScreenshot()

"Step 54: Click on div integrationOptions (CICDPipeline)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationOptions_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationOptions_1', ['div_integrationOptions_class': div_integrationOptions_class_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Schedule Test Runs and Configure Environment_visual_checkpoint')
