...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 2-Click on link projectLinks SC SynergyCareManager - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 3-Click on button EnableJiraIntegration - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 4-Click on link JiraAddOn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 5-Click on link JiraAddOn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 6-Click on div YouNeedToFillInAll.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 7-Click on div Column12.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 8-Click on input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 9-Enter input value in input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 10-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 11-Enter input value in input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 12-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 13-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 14-Click on input Username.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 15-Click on div PasswordJiraServer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 16-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 17-Click on link Planning2 - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 18-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 19-Click on div Zero.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 20-Click on div NewFailures.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 21-Click on div NewFailures.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 22-Click on link Tests4 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 23-Click on link Executions4 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 24-Click on link Planning2 - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 25-Click on link Tests3 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 26-Click on link TestSuites2 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 27-Click on span KatalonCloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 28-Click on span treeSwitchers TreeSwitcher2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 29-Click on link SettingUpScriptRepository - Navigate to page teamprojectgit-test-projectsetup.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 30-Click on div CreateNewGitRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 32-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 33-Click on span treeSwitchers TreeSwitcher16.png')

"Step 34: Click on span testCaseSwitchers (TreeSwitcher17)"
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 34-Click on span testCaseSwitchers TreeSwitcher17.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 35-Click on link TestSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 36-Click on link Reports - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 37-Click on link Planning3 - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 38-Click on link Requirements2 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 39-Click on button closeActions CloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 40-Click on div UnderTopNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 41-Click on button closeActions CloseButton2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 42-Click on div JiraIssues.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 43-Click on div JiraIssues2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 44-Click on span settings Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 45-Click on div dynamicObject MuiBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 46-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 47-Click on div ReleaseReadiness.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 48-Click on td NoDataToDisplay.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 49-Click on div DashboardRefresh.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 50-Click on link Reports5 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 51-Click on link SummaryByTestResult - Navigate to page teamprojecttest-reportstest-executiontest-performance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 52-Click on link TestRuns - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 53-Click on link RunFrequency2 - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 54-Click on link FailedTestResultsBeta - Navigate to page teamproject.png')

"Step 55: Click on link testLinks (Defects)"
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 55-Click on link testLinks Defects.png')

"Step 56: Click on link testLinks (VisualTesting)"
...
WebUI.takeScreenshot(reportLocation + '/TC309/Step 56-Click on link testLinks VisualTesting.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC309-Enable Jira Integration and Verify Project Links_visual_checkpoint')
