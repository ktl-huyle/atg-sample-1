...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 4-Click on link executionDetails FPTestCase - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 5-Click on button TestCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 6-Click on button RecordTestSteps - Navigate to page teamprojecttest-designtest-casesedit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 7-Click on span dragSelect DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 8-Click on span dragSelect DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 9-Click on span dragSelect DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 10-Click on button AddNewTestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 11-Click on div dynamicObject ClickOnObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 12-Click on input dynamicInputs ObjectInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 13-Click on div UnknownContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 14-Click on div CaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 15-Click on button Save.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 16-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 17-Click on button AddNewTestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 18-Enter input value in input dynamicInputs SelectAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 19-Click on div dynamicObject object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 20-Click on input Value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 21-Click on input dynamicInputs DropdownObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 22-Click on div CaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 23-Click on input Value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 24-Enter input value in input Value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 25-Click on button Save2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 26-Click on input checkboxes Checkbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 27-Click on input checkboxes Checkbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 28-Click on input checkboxes Checkbox3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 29-Click on input checkboxes Checkbox4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 30-Click on input checkboxes Checkbox5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 31-Click on input checkboxes Checkbox6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 32-Click on input checkboxes Checkbox7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 33-Click on input checkboxes Checkbox8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 34-Click on input checkboxes Checkbox9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 35-Click on span DeleteSelectedSteps.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 36-Click on div object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 37-Click on button Playback.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 38-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 39-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 40-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 41-Click on span dragSelect DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 42-Click on button Edit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 43-Click on input Value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 44-Click on input Value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 45-Enter input value in input Value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 46-Click on button Save3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC246/Step 47-Click on button Playback - Navigate to page .png')

"Step 48: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC246-Record and Edit Test Steps in Execution_visual_checkpoint')
