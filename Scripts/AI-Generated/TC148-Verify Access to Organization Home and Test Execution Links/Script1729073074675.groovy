...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 4-Click on link testExecution ForumPosting - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 5-Click on link TestRuns2 - Navigate to page team project overviewteamprojectoverview.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC148-Verify Access to Organization Home and Test Execution Links_visual_checkpoint')
