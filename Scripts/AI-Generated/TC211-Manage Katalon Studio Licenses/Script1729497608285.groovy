...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 4-Click on link KatalonStudioLicenses - Navigate to page userlicense.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 5-Click on td licenseDetails KSENodeLocked.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 6-Click on span KSENodeLocked.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 7-Click on td licenseDetails KSENodeLocked2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC211/Step 8-Click on link Subscribe - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC211-Manage Katalon Studio Licenses_visual_checkpoint')
