...
"Step 4: Click on link executionOverview (TeamExecution) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on link executionOverview TeamExecution - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Failed Test Status Management and Deletion_visual_checkpoint')
