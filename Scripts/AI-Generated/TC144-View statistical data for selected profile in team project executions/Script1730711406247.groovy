...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 5-Click on div TestRunByStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 6-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 7-Click on link UserManagement - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC144-View statistical data for selected profile in team project executions_visual_checkpoint')
