...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 4-Click on div infoSidebarWrapper.png')

"Step 5: Click on button object -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_grid/button_object'))

WebUI.takeScreenshot(reportLocation + '/TC37/Step 5-Click on button object - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC37-View Team Project Grid Information_visual_checkpoint')
