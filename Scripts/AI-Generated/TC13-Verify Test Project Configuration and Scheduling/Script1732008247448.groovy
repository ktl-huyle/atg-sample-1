...
"Step 8: Click on link testResources (ScriptRepositories2)"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 8-Click on link testResources ScriptRepositories2.png')
...
"Step 24: Click on link viewTestRuns (ViewSGDP)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_viewTestRuns"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_viewTestRuns', ['link_viewTestRuns_internalRoleLinkName': link_viewTestRuns_internalRoleLinkName, 'project_id': project_id_2, 'team_id': team_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 24-Click on link viewTestRuns ViewSGDP.png')

"Step 25: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Test Project Configuration and Scheduling_visual_checkpoint')
