...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 5-Click on div testRunCells ParallelSuite751.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 6-Click on div testRunCells ParallelSuite749.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 7-Click on div testRunCells ParallelSuite750.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 8-Click on div testRunCells ParallelSuite751.png')
...
"Step 14: Click on span settings (Settings)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 14-Click on span settings Settings.png')
...
"Step 21: Click on div enableOptions (EnableBDDReports)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_enableOptions'))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 21-Click on div enableOptions EnableBDDReports.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/span_settings"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/span_settings', ['span_settings_internalRoleButtonName': span_settings_internalRoleButtonName_1]))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 23-Click on span settings Settings.png')

"Step 24: Click on div testOptions (MuiBackdrop)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 24-Click on div testOptions MuiBackdrop.png')
...
"Step 27: Click on div teamReady (TeamReadyCase) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_teamReady'))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 27-Click on div teamReady TeamReadyCase - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify User Management and Project Actions_visual_checkpoint')
