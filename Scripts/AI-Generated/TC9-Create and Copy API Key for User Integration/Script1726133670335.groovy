...
"Step 6: Create a new API key for integration with external services."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Create and Copy API Key for User Integration_visual_checkpoint')
