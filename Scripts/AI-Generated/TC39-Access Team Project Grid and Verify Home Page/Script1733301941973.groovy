...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 4-Click on div infoSidebar.png')

"Step 5: Click on button PerfTest -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_grid/button_PerfTest'))

WebUI.takeScreenshot(reportLocation + '/TC39/Step 5-Click on button PerfTest - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC39-Access Team Project Grid and Verify Home Page_visual_checkpoint')
