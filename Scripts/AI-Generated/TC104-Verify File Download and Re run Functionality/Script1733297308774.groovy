...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 4-Click on link Files - Navigate to page teamprojectexecutionsfiles.png')

"Step 5: Click on link fileDownload (HTMLFile)"
...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 5-Click on link fileDownload HTMLFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 6-Click on button ReRun - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC104-Verify File Download and Re run Functionality_visual_checkpoint')
