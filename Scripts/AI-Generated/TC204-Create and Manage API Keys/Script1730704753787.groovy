...
WebUI.takeScreenshot(reportLocation + '/TC204/Step 5-Click on button apiKeyControls CellButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC204/Step 6-Click on button ShowApiKey.png')
...
WebUI.takeScreenshot(reportLocation + '/TC204/Step 7-Click on input userInputs TextInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC204/Step 8-Click on input userInputs PasswordInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC204/Step 9-Click on button copyToClipboard CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC204/Step 10-Click on button NidhiKachhadiya.png')
...
WebUI.takeScreenshot(reportLocation + '/TC204/Step 11-Click on link SignOut - Navigate to page organizationhome.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC204-Create and Manage API Keys_visual_checkpoint')
