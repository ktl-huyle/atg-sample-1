...
import truetest.common.updateTestResultStatusToPassed
...
"Step 2: Change the status of test result to passed"

updateTestResultStatusToPassed.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 16: Change the status of test result to passed"

updateTestResultStatusToPassed.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Verify Organization Home after Marking Tests as Passed_visual_checkpoint')
