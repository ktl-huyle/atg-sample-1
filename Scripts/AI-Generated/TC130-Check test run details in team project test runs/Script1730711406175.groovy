...
"Step 4: Click on div testRunDetails (testRunCell)"
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 4-Click on div testRunDetails testRunCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 5-Click on div Navbar.png')

"Step 6: Click on div testRunDetails (TestRunCell2)"
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 6-Click on div testRunDetails TestRunCell2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 7-Click on div testRunDetails UntitledTestRun4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 8-Click on div Navbar - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC130-Check test run details in team project test runs_visual_checkpoint')
