...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Click on div testSuites ParallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on div testSuites ParallelSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on div testSuites ParallelSuite3.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Manage Project Settings and Verify Home Page_visual_checkpoint')
