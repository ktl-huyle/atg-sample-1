import truetest.common.createApiKeyInSauceDemo
...
"Step 6: Create a new API key in the SauceDemo application"

createApiKeyInSauceDemo.execute(data_path_0, Integer.valueOf(index_0))
