...
"Step 8: Click on link testopsHomepage2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/link_testopsHomepage2'))

WebUI.takeScreenshot()

"Step 9: Click on div object5 -> Navigate to page 'team/*/project/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TestCase-088_visual_checkpoint')
