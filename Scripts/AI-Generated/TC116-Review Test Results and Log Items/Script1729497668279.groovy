...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 4-Click on header testRunTitles UntitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 5-Click on button Details2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 6-Click on link TestResults - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 7-Click on td PassedLogin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 8-Click on div InfoSidebarCloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 9-Click on button testResultActions ExternalLink - Navigate to page teamprojectexecutionstest-result.png')

"Step 10: Click on span logItems (LogItemIcon)"
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 10-Click on span logItems LogItemIcon.png')

"Step 11: Click on span logItemImages (LogItemImage)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/span_logItemImages', ['span_logItemImages_nthChild': span_logItemImages_nthChild, 'span_logItemImages_class': span_logItemImages_class, 'span_logItemImages_internalHasText': span_logItemImages_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC116/Step 11-Click on span logItemImages LogItemImage.png')

"Step 12: Click on span logItems (LogItemIcon2)"
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 12-Click on span logItems LogItemIcon2.png')

"Step 13: Click on span logItems (LogItemImage2)"
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 13-Click on span logItems LogItemImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 14-Click on span testCaseStatus TestCaseCreated.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 15-Click on span testCaseStatus ListSubheaderIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 16-Click on span testCaseStatus TestCaseCreated - Navigate to page .png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC116-Review Test Results and Log Items_visual_checkpoint')
