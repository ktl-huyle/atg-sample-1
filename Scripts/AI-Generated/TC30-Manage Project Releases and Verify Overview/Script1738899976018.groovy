...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 2-Click on button releaseActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on button releaseActions Run.png')
