...
"Step 4: Click on button teamActions (AlbertoBeba)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/button_teamActions', ['button_teamActions_nthChild': button_teamActions_nthChild, 'button_teamActions_internalRoleButtonName': button_teamActions_internalRoleButtonName]))

WebUI.takeScreenshot(reportLocation + '/TC369/Step 4-Click on button teamActions AlbertoBeba.png')
...
WebUI.takeScreenshot(reportLocation + '/TC369/Step 5-Click on font Email.png')
...
WebUI.takeScreenshot(reportLocation + '/TC369/Step 6-Click on div UserInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC369/Step 7-Click on link signOut Desconectar - Navigate to page organizationhome.png')

"Step 8: Click on button organizationMembers (AlbertoBeba)"
...
WebUI.takeScreenshot(reportLocation + '/TC369/Step 8-Click on button organizationMembers AlbertoBeba.png')
...
WebUI.takeScreenshot(reportLocation + '/TC369/Step 9-Click on div Backdrop2 - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC369-Sign Out from Team Project and Verify Home Page_visual_checkpoint')
