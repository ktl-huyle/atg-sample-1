...
WebUI.takeScreenshot(reportLocation + '/TC61/Step 6-Click on link executionDetails TestRun4 - Navigate to page teamprojectexecutions.png')

"Step 7: Click on div testCase (TestCase)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_testCase'))

WebUI.takeScreenshot(reportLocation + '/TC61/Step 7-Click on div testCase TestCase.png')

"Step 8: Click on div testCase (TestCase)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_testCase'))

WebUI.takeScreenshot(reportLocation + '/TC61/Step 8-Click on div testCase TestCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC61/Step 13-Click on link executionDetails TestRun4 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC61-Explore Execution Details and Test Results_visual_checkpoint')
