...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 4-Click on div sortingInfo sortingInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 6-Click on div sortingInfo sortingInfo2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 7-Click on div cardBody.png')

"Step 8: Click on div executionDetails (cellSP3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_executionDetails_1'))

WebUI.takeScreenshot(reportLocation + '/TC167/Step 8-Click on div executionDetails cellSP3.png')
...
"Step 10: Click on link executionLinks (Executions4)"
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 10-Click on link executionLinks Executions4.png')
...
"Step 12: Click on link executionLinks (Executions4) -> Navigate to page '/team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 12-Click on link executionLinks Executions4 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 14-Click on td testCases testCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 15-Click on div testCaseDetails - Navigate to page teamprojectexecutions.png')
...
"Step 18: Click on link executionLinks (Executions4)"
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 18-Click on link executionLinks Executions4.png')

"Step 19: Click on link executionLinks (Executions4) -> Navigate to page '/team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC167/Step 19-Click on link executionLinks Executions4 - Navigate to page teamprojectexecutions.png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC167-Access and Verify Team Project Executions Dashboard_visual_checkpoint')
