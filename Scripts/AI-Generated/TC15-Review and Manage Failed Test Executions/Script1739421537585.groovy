...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 3-Click on pre failedTests FailedTestCase.png')
...
"Step 10: Click on div failedTests (FailedTestCaseInfo)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 10-Click on div failedTests FailedTestCaseInfo.png')

"Step 11: Click on div failedTests (FailedPreRequisiteBranchOpen)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 11-Click on div failedTests FailedPreRequisiteBranchOpen.png')
...
"Step 15: Click on div failedTests (FailedPreRequisiteBranchOpen3)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 15-Click on div failedTests FailedPreRequisiteBranchOpen3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 18-Click on pre failedTests FailedPreRequisiteBranchOpen.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 19-Click on div failedTests FailedPreRequisiteBranchOpen4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 20-Click on div failedTests FailedPreRequisiteBranchOpen5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 21-Click on pre failedTests FailedPreRequisiteBranchOpen2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Review and Manage Failed Test Executions_visual_checkpoint')
