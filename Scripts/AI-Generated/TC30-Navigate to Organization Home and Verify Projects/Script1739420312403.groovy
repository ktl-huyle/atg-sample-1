...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 3-Click on div currentDivisi CurrentDP.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on link dynamicObject OJOracleJDE - Navigate to page team projectteamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC30-Navigate to Organization Home and Verify Projects_visual_checkpoint')
