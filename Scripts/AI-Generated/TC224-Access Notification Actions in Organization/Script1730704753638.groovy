...
WebUI.takeScreenshot(reportLocation + '/TC224/Step 4-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC224/Step 5-Click on link testOpsHomepage TestOpsHomepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC224/Step 6-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC224/Step 7-Click on link testOpsHomepage TestOpsHomepage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC224/Step 8-Click on div organizationLinks OrganizationLink - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC224/Step 9-Click on button NotificationAction - Navigate to page .png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC224-Access Notification Actions in Organization_visual_checkpoint')
