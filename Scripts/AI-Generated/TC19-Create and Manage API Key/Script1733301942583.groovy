...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 9-Click on button apiKeyActions apiKeyActions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 11-Click on input apiKeyInputs apiKeyInputs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 12-Click on input apiKeyInputs apiKeyInputs2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 13-Click on button CopyToClipboard CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 15-Click on link SignOut2 - Navigate to page organizationhome.png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Create and Manage API Key_visual_checkpoint')
