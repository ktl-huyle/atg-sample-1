...
"Step 4: Click on link Execution -> Navigate to page 'team/*/project/*/executions/*'"
...
"Step 6: Click on span Regresi"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_Regresi'))
...
"Step 11: Click on span Regresi -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Generate Reports from Team Project Releases_visual_checkpoint')
