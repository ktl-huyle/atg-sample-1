...
import katalon.common.filterTeamProjectExecutions
...
"Step 4: Filter and view details of team project executions."

filterTeamProjectExecutions.execute(data_path_0, Integer.valueOf(index_0))

"Step 5: Filter and view details of team project executions."

filterTeamProjectExecutions.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC46-Filter and View Team Project Executions in SauceDemo_visual_checkpoint')
