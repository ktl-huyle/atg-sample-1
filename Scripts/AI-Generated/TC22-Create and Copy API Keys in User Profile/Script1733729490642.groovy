...
"Step 4: Click on button apiKeyActions (UserObject2)"
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 4-Click on button apiKeyActions UserObject2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 5-Click on button apiKeyActions ShowAPIKey2.png')

"Step 6: Click on button copyAction (CopyToClipboard)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_user/button_copyAction'))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 6-Click on button copyAction CopyToClipboard.png')
...
"Step 12: Click on button apiKeyActions (ShowAPIKey3)"
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 12-Click on button apiKeyActions ShowAPIKey3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 13-Click on button copyAction CopyToClipboard.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Create and Copy API Keys in User Profile_visual_checkpoint')
