...
"Step 2: Click on div failedExecutionReports (FailedTest)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutionReports', ['div_failedExecutionReports_class': div_failedExecutionReports_class, 'div_failedExecutionReports_internalRoleButtonName': div_failedExecutionReports_internalRoleButtonName]))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 2-Click on div failedExecutionReports FailedTest.png')
...
"Step 9: Click on link testRunDetails (TestRunDetails)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_testRunDetails"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 9-Click on link testRunDetails TestRunDetails.png')

"Step 10: Click on link testRunDetails (TestRunDetails2) -> Navigate to page 'team project executions#team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_testRunDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_testRunDetails', ['link_testRunDetails_trNthChild': link_testRunDetails_trNthChild_1, 'link_testRunDetails_internalRoleLinkName': link_testRunDetails_internalRoleLinkName_1, 'team_id': team_id_1, 'project_id': project_id_1, 'executions_id': executions_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 10-Click on link testRunDetails TestRunDetails2 - Navigate to page team project executionsteamprojectexecutions.png')
...
"Step 13: Click on link testRunDetails (TestRunDetails3) -> Navigate to page 'team project executions#team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_testRunDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_testRunDetails', ['link_testRunDetails_trNthChild': link_testRunDetails_trNthChild_2, 'link_testRunDetails_internalRoleLinkName': link_testRunDetails_internalRoleLinkName_2, 'team_id': team_id_2, 'project_id': project_id_2, 'executions_id': executions_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC10/Step 13-Click on link testRunDetails TestRunDetails3 - Navigate to page team project executionsteamprojectexecutions.png')

"Step 14: Click on pre failedTestReports (FailedTest)"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 14-Click on pre failedTestReports FailedTest.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Review Failed Test Reports and Results_visual_checkpoint')
