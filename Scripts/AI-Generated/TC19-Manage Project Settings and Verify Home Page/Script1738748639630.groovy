...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 2-Click on button projectManagementActions LinkToRelease.png')
...
"Step 4: Click on button projectManagementActions (Run) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 4-Click on button projectManagementActions Run - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Manage Project Settings and Verify Home Page_visual_checkpoint')
