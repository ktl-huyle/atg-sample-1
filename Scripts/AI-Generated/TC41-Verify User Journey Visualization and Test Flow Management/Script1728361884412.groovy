...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 4-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 5-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 6-Click on link Execution - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 7-Click on link projectLinks LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 8-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 9-Click on div UserJourneyVisualization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 10-Click on input Checkbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 11-Click on button navigationActions ExpandGraph.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 12-Click on button ExportAllFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 13-Click on link DownloadCSV.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 14-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 15-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 16-Click on link Execution - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 17-Click on div QA JamaicaFlow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 18-Click on div gridCells GridCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 19-Click on p InstallTrueTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 20-Click on link projectLinks LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 21-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeys.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 22-Click on button viewDetails ViewDetails - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 23-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 24-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 25-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 26-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 27-Click on p userJourneySteps VerifyNavigationHome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 28-Click on button navigationActions GoToNextPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 29-Click on p userJourneySteps VerifyInternetBundles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 30-Click on button detailFlowPanels NavigateInteract.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 31-Click on button navigationActions GoToNextPage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 32-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 33-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 34-Click on p userJourneySteps NavigateInteract.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 35-Click on button detailFlowPanels ShowDetailFlowPanel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 36-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 37-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 38-Click on button detailFlowPanels ShowDetailFlowPanel2 - Navigate to page .png')

"Step 39: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC41-Verify User Journey Visualization and Test Flow Management_visual_checkpoint')
