...
WebUI.takeScreenshot(reportLocation + '/TC113/Step 4-Click on div firstProject - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC113/Step 6-Click on link settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC113/Step 7-Click on link testEnvironments - Navigate to page teamprojectagent.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC113-Verify Test Environment Settings in Team Project_visual_checkpoint')
