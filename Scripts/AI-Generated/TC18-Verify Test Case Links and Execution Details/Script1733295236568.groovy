...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 6-Click on div testCaseItems UploadedData.png')
...
"Step 11: Click on div testCaseItems (CountyDemographics)"
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 11-Click on div testCaseItems CountyDemographics.png')

"Step 12: Click on link caseLinks (InsuranceDemographics) -> Navigate to page 'team/*/project/*/test-design/test-cases/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/link_caseLinks', ['link_caseLinks_internalRoleLinkName': link_caseLinks_internalRoleLinkName, 'project_id': project_id_1, 'test_cases_id': test_cases_id, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC18/Step 12-Click on link caseLinks InsuranceDemographics - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_testItems', ['project_id': project_id_3, 'team_id': team_id_3]))
