...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 4-Click on span settingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 5-Click on link navigation navigation2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 6-Click on span settingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 7-Click on link navigation navigation2.png')

"Step 8: Click on div objectItems (objectItems2) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 8-Click on div objectItems objectItems2 - Navigate to page teamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC29-Manage Notifications and Verify Home Page_visual_checkpoint')
