...
"Step 12: Schedule and run test suites in the SauceDemo application"
...
"Step 52: Click on div integrationComponents (CodelessAutomationTool)"
...
"Step 53: Click on div integrationComponents (CodelessAutomationTool2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationComponents_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationComponents_1', ['div_integrationComponents_class': div_integrationComponents_class]))

WebUI.takeScreenshot()

"Step 54: Click on div integrationComponents (CICDPipeline)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationComponents_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationComponents_1', ['div_integrationComponents_class': div_integrationComponents_class_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Navigate Team Project Test Runs and Schedule Tests_visual_checkpoint')
