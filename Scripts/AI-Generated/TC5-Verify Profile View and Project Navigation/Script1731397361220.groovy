...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_userAction_2'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Profile View and Project Navigation_visual_checkpoint')
