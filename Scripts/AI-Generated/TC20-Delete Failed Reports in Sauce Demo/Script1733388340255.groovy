...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on button FailedReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 6-Click on button Delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 7-Click on button FailedReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 9-Click on button Delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 10-Click on div ExecutionDoneMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 12-Click on div LeftNavbarImage - Navigate to page .png')

"Step 13: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Delete Failed Reports in Sauce Demo_visual_checkpoint')
