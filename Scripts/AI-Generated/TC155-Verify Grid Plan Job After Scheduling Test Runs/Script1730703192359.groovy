...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunLinks', ['link_testRunLinks_trNthChild': link_testRunLinks_trNthChild, 'link_testRunLinks_internalRoleLinkName': link_testRunLinks_internalRoleLinkName, 'link_testRunLinks_plan_id': link_testRunLinks_plan_id, 'link_testRunLinks_project_id': link_testRunLinks_project_id, 'link_testRunLinks_team_id': link_testRunLinks_team_id]))

WebUI.takeScreenshot(reportLocation + '/TC155/Step 4-Click on link testRunLinks UntitledTestRun - Navigate to page teamprojectgridplanjob.png')

"Step 5: Click on link testRunLinks (TestExecution) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_testRunLinks', ['link_testRunLinks_internalRoleLinkName': link_testRunLinks_internalRoleLinkName_1, 'link_testRunLinks_executions_id': link_testRunLinks_executions_id, 'link_testRunLinks_project_id': link_testRunLinks_project_id_1, 'link_testRunLinks_team_id': link_testRunLinks_team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC155/Step 5-Click on link testRunLinks TestExecution - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionLinks_2', ['link_executionLinks_internalRoleLinkName': link_executionLinks_internalRoleLinkName, 'link_executionLinks_plan_id': link_executionLinks_plan_id, 'link_executionLinks_team_id': link_executionLinks_team_id, 'link_executionLinks_job_id': link_executionLinks_job_id, 'link_executionLinks_project_id': link_executionLinks_project_id]))

WebUI.takeScreenshot(reportLocation + '/TC155/Step 6-Click on link executionLinks TestExecution - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 7-Click on link Calendar - Navigate to page teamprojecttest-planning.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 8-Click on item Calendar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 9-Click on link History - Navigate to page teamprojecttest-runs.png')

"Step 10: Click on div testRunDetails (UntitledTestRun5)"
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 10-Click on div testRunDetails UntitledTestRun5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 11-Click on button ShowMore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 12-Click on button GoToDetails - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 13-Click on div ThumbnailImage3 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 14-Click on button Close2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 15-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 16-Click on link Settings2 - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 17-Click on link ScriptRepositories2 - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 19-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 20-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 21-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 22-Click on div testCases TestCases3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 23-Click on link TestCasesINDI1040SS.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 24-Click on tr SelectFailedINDI1040SS.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 25-Click on div testCaseSummary TestCaseSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 26-Click on link Executions3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 28-Click on link ViewUntitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 29-Click on div testRunDetails UntitledTestRun11.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 30-Click on div testRunDetails UntitledTestRun10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 31-Click on button ShowMore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 32-Click on div IND1040SS.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 33-Click on div ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 34-Click on div ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 35-Click on div ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 36-Click on div testRunDetails UntitledTestRun10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 37-Click on div testRunDetails UntitledTestRun10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 38-Click on button GoToDetails - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 39-Click on pre ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 40-Click on pre ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 41-Click on pre ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 42-Click on pre ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 43-Click on pre ElementClickIntercepted.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 44-Click on image testRunImages TestRunImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 45-Click on image testRunImages TestRunImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 46-Click on image testRunImages TestRunImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 47-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 48-Click on link Executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 49-Click on div testRunDetails UntitledTestRun112.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 50-Click on button ShowMore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 51-Click on button Close2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 52-Click on div testRunDetails UntitledTestRun112.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 53-Click on header testRunDetails UntitledTestRun11.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 54-Click on header testRunDetails UntitledTestRun11.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 55-Click on div testRunDetails UntitledTestRun112.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 56-Click on button GoToDetails - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 57-Click on div ThumbnailImage3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 58-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 59-Click on div InputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 60-Click on input FailureReasonSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 61-Click on div FailureReasonBeta.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 62-Click on span listenerActions LogItemContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 63-Click on div ShadowNone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 64-Click on div thumbnailImages ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 65-Click on button Close - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 66-Click on button Close2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 68-Click on header testRunDetails EdgeOpen1040SSTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 69-Click on div testRunDetails EdgeOpen1040SSTest12.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 70-Click on button testRunActions TestRunButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 71-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 72-Click on div testRunDetails EdgeOpen1040SSTest122.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 73-Click on div EdgeOpen1040SSTestImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 74-Click on div PersonIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 75-Click on div testRunDetails EdgeOpen1040SSTest122.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 76-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 77-Click on link Schedules - Navigate to page teamprojectgrid.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunLinks', ['link_testRunLinks_trNthChild': link_testRunLinks_trNthChild_1, 'link_testRunLinks_internalRoleLinkName': link_testRunLinks_internalRoleLinkName_2, 'link_testRunLinks_plan_id': link_testRunLinks_plan_id_1, 'link_testRunLinks_project_id': link_testRunLinks_project_id_2, 'link_testRunLinks_team_id': link_testRunLinks_team_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC155/Step 78-Click on link testRunLinks EdgeOpen1040SSTest - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 79-Click on div testRunDetails EdgeOpen1040SSTest.png')

"Step 80: Click on link testRunLinks (Execution12) -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid/plan/.*/job?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_testRunLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_testRunLinks', ['link_testRunLinks_internalRoleLinkName': link_testRunLinks_internalRoleLinkName_3, 'link_testRunLinks_executions_id': link_testRunLinks_executions_id_1, 'link_testRunLinks_project_id': link_testRunLinks_project_id_3, 'link_testRunLinks_team_id': link_testRunLinks_team_id_3]))

WebUI.takeScreenshot(reportLocation + '/TC155/Step 80-Click on link testRunLinks Execution12 - Navigate to page teamprojectexecutions.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionLinks_2"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionLinks_2', ['link_executionLinks_internalRoleLinkName': link_executionLinks_internalRoleLinkName_1, 'link_executionLinks_plan_id': link_executionLinks_plan_id_1, 'link_executionLinks_team_id': link_executionLinks_team_id_1, 'link_executionLinks_job_id': link_executionLinks_job_id_1, 'link_executionLinks_project_id': link_executionLinks_project_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC155/Step 81-Click on link executionLinks Execution10 - Navigate to page teamprojectgridplanjob.png')

"Step 82: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC155-Verify Grid Plan Job After Scheduling Test Runs_visual_checkpoint')
