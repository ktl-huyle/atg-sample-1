...
WebUI.takeScreenshot(reportLocation + '/TC232/Step 4-Click on div CCCareContinuityPortals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC232/Step 5-Click on link executionDetails Execution3826 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC232/Step 6-Click on link CoordinatorCore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC232/Step 7-Click on pre failedTests FailedVerifyFaxReceived - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC232-View Execution Details and Failed Tests_visual_checkpoint')
