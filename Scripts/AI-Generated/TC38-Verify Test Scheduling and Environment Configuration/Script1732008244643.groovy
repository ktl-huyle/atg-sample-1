...
"Step 4: Click on div historyInfo (HistorySubscribed)"
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 4-Click on div historyInfo HistorySubscribed.png')

"Step 5: Click on div historyInfo (HistorySubscribed)"
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 5-Click on div historyInfo HistorySubscribed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 24-Click on div MainBody.png')
...
"Step 56: Click on div integrationIcons (codelessAutomationToolIcon)"
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 56-Click on div integrationIcons codelessAutomationToolIcon.png')

"Step 57: Click on div integrationTools (codelessAutomationTool)"
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 57-Click on div integrationTools codelessAutomationTool.png')

"Step 58: Click on div integrationTools (ciCdPipeline)"
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 58-Click on div integrationTools ciCdPipeline.png')

"Step 59: Click on div azureDevOps (azureDevOpsPipelines)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_azureDevOps'))

WebUI.takeScreenshot(reportLocation + '/TC38/Step 59-Click on div azureDevOps azureDevOpsPipelines.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC38-Verify Test Scheduling and Environment Configuration_visual_checkpoint')
