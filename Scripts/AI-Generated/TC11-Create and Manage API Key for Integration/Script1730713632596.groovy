...
"Step 2: Create a new API key for integration purposes."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Manage API Key for Integration_visual_checkpoint')
