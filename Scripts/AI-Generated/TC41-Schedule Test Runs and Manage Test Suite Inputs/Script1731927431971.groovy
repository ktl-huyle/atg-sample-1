...
"Step 55: Click on div testRunDetails (CellPrivateLocal)"
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 55-Click on div testRunDetails CellPrivateLocal.png')

"Step 56: Click on div testRunDetails (CellAPI)"
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 56-Click on div testRunDetails CellAPI.png')

"Step 57: Click on div testRunDetails (CellPrivateLocal)"
...
WebUI.takeScreenshot(reportLocation + '/TC41/Step 57-Click on div testRunDetails CellPrivateLocal.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC41-Schedule Test Runs and Manage Test Suite Inputs_visual_checkpoint')
