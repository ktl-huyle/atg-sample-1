...
WebUI.takeScreenshot(reportLocation + '/TC413/Step 4-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC413/Step 5-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC413/Step 6-Click on button TestExecutionFrequency.png')
...
WebUI.takeScreenshot(reportLocation + '/TC413/Step 7-Click on link Dashboard - Navigate to page teamproject.png')

"Step 8: Click on link reportLinks (Reports) -> Navigate to page 'team/*/project/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC413/Step 8-Click on link reportLinks Reports - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC413/Step 9-Click on link RunFrequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC413-Verify Test Execution Frequency Reports_visual_checkpoint')
