...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 4-Click on div MainContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 5-Click on div Toolbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 6-Click on pre failedTests FailedTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 7-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 8-Click on button Close.png')

"Step 9: Click on span FailedTestRun"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_FailedTestRun'))

WebUI.takeScreenshot(reportLocation + '/TC29/Step 9-Click on span FailedTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 10-Click on div ImageFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 11-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 12-Click on span FailedTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 17-Click on pre failedTests FailedTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 18-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 19-Click on button Close2 - Navigate to page .png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC29-Verify Failed Test Run Navigation and Home Return_visual_checkpoint')
