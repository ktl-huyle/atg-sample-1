...
"Step 4: Click on div objectItems (objectItems) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on div objectItems objectItems - Navigate to page teamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Access Team Project Settings and Verify Agent_visual_checkpoint')
