...
"Step 4: Click on div failedTestCases (FailedED)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCases_2', ['div_failedTestCases_class': div_failedTestCases_class, 'div_failedTestCases_internalRoleButtonName': div_failedTestCases_internalRoleButtonName]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on div failedTestCases FailedED.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Sort and View Failed Test Cases in Executions_visual_checkpoint')
