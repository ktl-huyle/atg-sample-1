...
"Step 4: Click on span failedItems (FailedSortAndFilter)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 4-Click on span failedItems FailedSortAndFilter.png')

"Step 5: Click on span failedItems (FailedSortAndFilter)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 5-Click on span failedItems FailedSortAndFilter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 7-Click on button externalLinks ExternalLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 11-Click on span logItems CreatedWithSketchtool - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify Test Result Logs and ReRuns_visual_checkpoint')
