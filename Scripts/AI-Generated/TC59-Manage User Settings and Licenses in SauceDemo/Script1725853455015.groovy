...
"Step 2: Click on div developer -> Navigate to page 'organization/*/home'"
...
"Step 3: Click on button pn"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_pn'))

WebUI.takeScreenshot()

"Step 4: Click on link viewProfile"
...
"Step 13: Click on link userSettings -> Navigate to page 'user/settings'"
...
"Step 14: Click on link katalonApiKey -> Navigate to page 'user/apikey'"
...
"Step 15: Click on link katalonStudioLicenses -> Navigate to page 'user/license'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/apikey?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user_apikey/link_katalonStudioLicenses'))

WebUI.takeScreenshot()

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC59-Manage User Settings and Licenses in SauceDemo_visual_checkpoint')
