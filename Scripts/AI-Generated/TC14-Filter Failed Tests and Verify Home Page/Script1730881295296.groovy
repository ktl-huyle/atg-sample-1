...
"Step 9: Click on span logDetails (SketchToolImage) -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Filter Failed Tests and Verify Home Page_visual_checkpoint')
