...
WebUI.takeScreenshot(reportLocation + '/TC82/Step 4-Click on div WelcomeMessage2.png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC82-View Welcome Message in Application_visual_checkpoint')
