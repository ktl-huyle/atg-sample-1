...
"Step 7: Click on header testRunTitles (UntitledTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on header testRunTitles UntitledTestRun.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-View Test Run Details and Project Overview_visual_checkpoint')
