...
"Step 4: Click on div testRunItems (UntitledTestRun5)"
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 4-Click on div testRunItems UntitledTestRun5.png')
...
"Step 6: Click on div testRunItems (UntitledTestRun6)"
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 6-Click on div testRunItems UntitledTestRun6.png')

"Step 7: Click on div untitledTestRuns (UntitledTestRun7)"
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 7-Click on div untitledTestRuns UntitledTestRun7.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC37-Verify Test Runs and Home Navigation_visual_checkpoint')
