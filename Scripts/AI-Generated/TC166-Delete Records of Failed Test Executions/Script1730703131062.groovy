...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 4-Click on link executionDetails ExecutionDetails - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 5-Click on div LoadingSpinner.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 6-Click on div LoadingSpinner.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 7-Click on link TestRuns3 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 8-Click on link TestRuns4 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 9-Click on label failedExecutions FailedExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 10-Click on label failedExecutions FailedExecution2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 11-Click on label failedExecutions FailedExecution3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 12-Click on button Delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 14-Click on link TestRuns4 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 15-Click on link TestRuns4 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC166/Step 16-Click on button DeleteExecution.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC166-Delete Records of Failed Test Executions_visual_checkpoint')
