...
import truetest.common.scheduleTestRunForTeamProject
...
"Step 4: Schedule a test run for the selected team project"

scheduleTestRunForTeamProject.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 63: Click on span testCaseSwitchers (TreeSwitcher4)"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 63-Click on span testCaseSwitchers TreeSwitcher4.png')

"Step 64: Click on span testCaseSwitchers (TestCases)"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 64-Click on span testCaseSwitchers TestCases.png')

"Step 65: Click on div testCaseDetails (TestCases)"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 65-Click on div testCaseDetails TestCases.png')
...
"Step 68: Click on link testManagementOptions (ScriptRepositories3)"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 68-Click on link testManagementOptions ScriptRepositories3.png')
...
"Step 95: Click on link testRunViews (ViewTestRun)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_testRunViews"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testRunViews', ['link_testRunViews_internalRoleLinkName': link_testRunViews_internalRoleLinkName, 'project_id': project_id_1, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC56/Step 95-Click on link testRunViews ViewTestRun.png')

"Step 96: Click on div testRunDetails (TestRunCell)"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 96-Click on div testRunDetails TestRunCell.png')

"Step 97: Click on div testRunDetails (TestRunCell) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC56/Step 97-Click on div testRunDetails TestRunCell - Navigate to page .png')

"Step 98: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC56-Configure Test Environment and Schedule Test Runs_visual_checkpoint')
