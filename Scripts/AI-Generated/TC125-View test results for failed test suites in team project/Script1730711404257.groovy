...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 4-Click on link testSuites TestSuitesCPACDECPreapprovalBind - Navigate to page teamprojecttest-designtest-suites.png')

"Step 5: Click on link testSuiteActions (testSuiteDetails) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['link_testSuiteActions_internalRoleRowName': link_testSuiteActions_internalRoleRowName, 'link_testSuiteActions_project_id': link_testSuiteActions_project_id, 'link_testSuiteActions_executions_id': link_testSuiteActions_executions_id, 'link_testSuiteActions_team_id': link_testSuiteActions_team_id]))

WebUI.takeScreenshot(reportLocation + '/TC125/Step 5-Click on link testSuiteActions testSuiteDetails - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 6-Click on link testResults - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 7-Click on div failedTestSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 8-Click on button TestResultDetails - Navigate to page teamprojectexecutions.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC125-View test results for failed test suites in team project_visual_checkpoint')
