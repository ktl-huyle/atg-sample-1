...
"Step 2: Click on pre dynamicObject (object)"
...
"Step 6: Click on button object4 -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC43-Perform Actions on Team Project Executions and Verify Home_visual_checkpoint')
