...
"Step 6: Click on div objectElements (Object2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_objectElements'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-View Team Project Executions and Sort Information_visual_checkpoint')
