...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 4-Click on link Calendar - Navigate to page teamproject.png')

"Step 5: Click on div testRunStatus (Loading) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 5-Click on div testRunStatus Loading - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC26-Check Test Run Status from Grid Plan Job_visual_checkpoint')
