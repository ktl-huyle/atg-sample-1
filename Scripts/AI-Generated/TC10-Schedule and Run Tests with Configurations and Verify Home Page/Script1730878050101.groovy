...
"Step 12: Schedule and run a test with various configurations"
...
"Step 52: Click on div testManagementTools (CodelessAutomationTool)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_testManagementTools"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_testManagementTools', ['div_testManagementTools_internalRoleTreeitemName': div_testManagementTools_internalRoleTreeitemName]))

WebUI.takeScreenshot()

"Step 53: Click on div integrationTools (CodelessAutomationTool2)"
...
"Step 54: Click on div integrationTools (CICDPipeline)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Schedule and Run Tests with Configurations and Verify Home Page_visual_checkpoint')
