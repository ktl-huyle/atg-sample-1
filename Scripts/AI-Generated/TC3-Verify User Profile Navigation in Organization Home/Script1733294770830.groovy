...
"Step 7: Click on link navigation (ProjectManagement) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on link navigation ProjectManagement - Navigate to page .png')
