...
"Step 4: Click on button userButtons (NidhiKachhadiya)"
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 4-Click on button userButtons NidhiKachhadiya.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 5-Click on link ViewProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 6-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 7-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 8-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 9-Click on span SettingsButton.png')

"Step 10: Click on link organizationLinks (TestOpsHomepage2)"
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 10-Click on link organizationLinks TestOpsHomepage2.png')

"Step 11: Click on div organizationDetails (OrganizationLink) -> Navigate to page '/team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 11-Click on div organizationDetails OrganizationLink - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 12-Click on link Executions3 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 13-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 14-Click on link Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC164/Step 15-Click on button NotificationAction - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC164-Update Notification Settings and Verify_visual_checkpoint')
