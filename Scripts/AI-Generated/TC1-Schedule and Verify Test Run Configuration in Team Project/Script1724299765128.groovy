...
import katalon.common.scheduleTestRunAndConfigureSettings
...
"Step 2: Schedule a test run and configure advanced settings"

scheduleTestRunAndConfigureSettings.execute(data_path_0, Integer.valueOf(index_0))
