...
"Step 6: Create an API key by entering a name and submitting"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Create and Copy Multiple API Keys_visual_checkpoint')
