...
"Step 26: Click on link settings (reports) -> Navigate to page 'team/*/project/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 26-Click on link settings reports - Navigate to page teamproject.png')
...
"Step 33: Click on link testRunDetails (executionDetails) -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_testRunDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testRunDetails', ['link_testRunDetails_trNthChild': link_testRunDetails_trNthChild, 'link_testRunDetails_internalRoleLinkName': link_testRunDetails_internalRoleLinkName, 'project_id': project_id, 'executions_id': executions_id, 'team_id': team_id]))

WebUI.takeScreenshot(reportLocation + '/TC64/Step 33-Click on link testRunDetails executionDetails - Navigate to page teamprojectexecutions.png')
...
"Step 35: Click on span testKatalonDetails (testKatalon)"
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 35-Click on span testKatalonDetails testKatalon.png')
...
"Step 40: Click on link testRunDetails (executionDetails2) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 40-Click on link testRunDetails executionDetails2 - Navigate to page teamprojectexecutions.png')
...
"Step 42: Click on span testKatalonDetails (testKatalon2)"
...
WebUI.takeScreenshot(reportLocation + '/TC64/Step 42-Click on span testKatalonDetails testKatalon2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC64-Create and Manage Test Releases for Team Project_visual_checkpoint')
