...
"Step 4: Click on pre failedTestRuns (FailedE2EFlow)"
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 4-Click on pre failedTestRuns FailedE2EFlow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 5-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 6-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 7-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC87/Step 8-Click on button Close - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC87-View Failed Test Runs in Team Project Executions_visual_checkpoint')
