...
"Step 4: Click on td agentSettings (EncompassOpsTestAutomation)"
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Click on td agentSettings EncompassOpsTestAutomation.png')

"Step 5: Click on td agentSettings (EncompassOpsTestAutomation)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_project/td_agentSettings"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_project/td_agentSettings', ['td_agentSettings_internalRoleCellName': td_agentSettings_internalRoleCellName_1]))

WebUI.takeScreenshot(reportLocation + '/TC20/Step 5-Click on td agentSettings EncompassOpsTestAutomation.png')

"Step 6: Click on link organizationSettings (EncompassOpsTestAutomation) -> Navigate to page 'team/*/project/*/test-project/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_project/link_organizationSettings', ['link_organizationSettings_trNthChild': link_organizationSettings_trNthChild, 'link_organizationSettings_internalRoleLinkName': link_organizationSettings_internalRoleLinkName, 'team_id': team_id, 'test_project_id': test_project_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC20/Step 6-Click on link organizationSettings EncompassOpsTestAutomation - Navigate to page teamprojecttest-project.png')
...
"Step 34: Click on button alertActions (CloseButton)"
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 34-Click on button alertActions CloseButton.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Schedule Test Runs and Configure Test Environment_visual_checkpoint')
