...
"Step 3: Click on div failedExecutions (FailedQuery)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutions', ['div_failedExecutions_class': div_failedExecutions_class, 'div_failedExecutions_internalRoleButtonName': div_failedExecutions_internalRoleButtonName]))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 3-Click on div failedExecutions FailedQuery.png')

"Step 4: Click on div failedExecutions (FailedFilterClaims)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutions', ['div_failedExecutions_class': div_failedExecutions_class_1, 'div_failedExecutions_internalRoleButtonName': div_failedExecutions_internalRoleButtonName_1]))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on div failedExecutions FailedFilterClaims.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutions_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutions_1', ['div_failedExecutions_internalRoleButtonName': div_failedExecutions_internalRoleButtonName_2]))
...
"Step 17: Click on link executionLinks (ExecutionDetails2) -> Navigate to page 'team project executions#team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 17-Click on link executionLinks ExecutionDetails2 - Navigate to page team project executionsteamprojectexecutions.png')

"Step 18: Click on div failedExecutions (FailedCreateReverse3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedExecutions', ['div_failedExecutions_class': div_failedExecutions_class_2, 'div_failedExecutions_internalRoleButtonName': div_failedExecutions_internalRoleButtonName_3]))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 18-Click on div failedExecutions FailedCreateReverse3.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Handle Multiple Failed Executions in Team Project_visual_checkpoint')
