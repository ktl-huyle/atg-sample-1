...
"Step 4: Click on div recentProjects (FPFirstProject) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC43/Step 4-Click on div recentProjects FPFirstProject - Navigate to page teamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC43-Access Test Environments Settings in Team Project_visual_checkpoint')
