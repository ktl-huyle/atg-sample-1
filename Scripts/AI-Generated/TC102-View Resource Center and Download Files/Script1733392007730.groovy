...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 4-Click on pre failedTestRuns ErrorSendMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 5-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 6-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 7-Click on button ShowSlide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 8-Click on div FilePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 9-Click on div ThumbnailImage3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 10-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 11-Click on div ThumbnailImage3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 12-Click on button Download.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 13-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 14-Click on div ResourceCenter.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 15-Click on pre Timestamp.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 16-Click on div CloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 17-Click on div UnderTopNavbar.png')

"Step 18: Click on button projectActions (CareContinuityPortals)"
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 18-Click on button projectActions CareContinuityPortals.png')
...
WebUI.takeScreenshot(reportLocation + '/TC102/Step 19-Click on div UnderTopNavbar - Navigate to page .png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC102-View Resource Center and Download Files_visual_checkpoint')
