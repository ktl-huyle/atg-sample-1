...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 4-Click on div SidebarMainContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 5-Click on div Toolbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 6-Click on pre failedTests FailedKundensonderpreise.png')
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 8-Click on span FailedRechnungSpeichern.png')

"Step 9: Interact with thumbnail images and handle errors"
...
WebUI.takeScreenshot(reportLocation + '/TC130/Step 10-Click on button Close2 - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC130-Handle Failed Tests and Verify Home Navigation_visual_checkpoint')
