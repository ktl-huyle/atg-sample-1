...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 2-Click on button Shamika.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 3-Click on link SignOut - Navigate to page user actionlogout.png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC25-Sign Out from Team Project_visual_checkpoint')
