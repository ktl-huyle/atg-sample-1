...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 4-Click on td testProjectDetails TestProject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 5-Click on td testProjectDetails TestProject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 6-Click on link testProjects TestProject - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 7-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 8-Click on button AlertButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 9-Click on button ScheduleTestRun.png')

"Step 10: Run a test suite with advanced configuration options"
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 11-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 12-Click on link OrganizationSetup - Navigate to page organizationsettingsagent.png')

"Step 13: Click on link AgentSetup -> Navigate to page '/team/*/project/*/test-planning'"
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 13-Click on link AgentSetup - Navigate to page teamprojecttest-planning.png')
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 14-Click on button ScheduleTestRun.png')

"Step 15: Run a test suite with advanced configuration options"

runTestSuiteWithAdvancedSettings.execute(data_path_1, Integer.valueOf(index_1))

"Step 16: Click on link testRunViews (ViewEPPs) -> Navigate to page '/team/*/project/*/test-runs'"
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 16-Click on link testRunViews ViewEPPs - Navigate to page teamprojecttest-runs.png')

"Step 17: Click on header testRunTitles (EPPsAutomationTest) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC129/Step 17-Click on header testRunTitles EPPsAutomationTest - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC129-Schedule Test Run with Advanced Configuration_visual_checkpoint')
