...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on link participantManagement TestExecution - Navigate to page teamprojectexecutions.png')
...
"Step 7: Click on div failedTests (FailedVerifyFax) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 7-Click on div failedTests FailedVerifyFax - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Participant Management and Test Failures_visual_checkpoint')
