import katalon.common.editProjectDetailsInKatalonDemo
import internal.GlobalVariable
import static com.kms.katalon.core.testobject.ObjectRepository.findTestObject
import katalon.common.scheduleTestRunAndSaveConfigurations
...
"Step 7: Edit project details in Katalon demo project repository"

editProjectDetailsInKatalonDemo.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 11: Click on div object -> Navigate to page '/team/320312/project/434641/test-design/test-suites'"
...
// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/320312/project/434641/test-design/test-suites?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_teamprojecttest_design_test_suites/div_demoTargetDirectory'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_teamprojecttest_design_test_suites/div_testSuites'))

WebUI.takeScreenshot()

"Step 14: Schedule a test run and save configurations in Katalon"

scheduleTestRunAndSaveConfigurations.execute(data_path_1, Integer.valueOf(index_1))
...
"Step 16: Click on link scriptRepositories -> Navigate to page 'team/*/project/*/test-project'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Connect Git Repository and Schedule Test Run in Katalon_visual_checkpoint')
