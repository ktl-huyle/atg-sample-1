...
"Step 3: Click on div failedQueries (FailedQueryIndex)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on div failedQueries FailedQueryIndex.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Review Failed Executions and Navigate Back to Team Project Executions_visual_checkpoint')
