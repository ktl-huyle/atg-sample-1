...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_apiKeyAction_1'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_apiKeyAction_2'))
...
"Step 10: Click on button apiKeyAction (ShowApiKey3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_apiKeyAction_3'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Manage API Key Actions and Logout_visual_checkpoint')
