...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_teamMemberAction_2'))
...
"Step 8: Click on link navigation (TestOpsHomepage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/link_navigation_1'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-View Team Member Profile and Verify Home_visual_checkpoint')
