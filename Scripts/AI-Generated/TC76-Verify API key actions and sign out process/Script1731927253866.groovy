...
WebUI.takeScreenshot(reportLocation + '/TC76/Step 6-Click on button copyActions CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC76/Step 13-Click on button copyActions CopyToClipboard.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC76-Verify API key actions and sign out process_visual_checkpoint')
