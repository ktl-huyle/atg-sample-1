...
WebUI.takeScreenshot(reportLocation + '/TC222/Step 4-Click on button TestResultDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC222/Step 5-Click on button TestResultDetails2 - Navigate to page teamprojectexecutionstest-result.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC222-View Test Result Details and Re runs_visual_checkpoint')
