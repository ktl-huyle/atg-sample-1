...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 4-Click on button BDDPOC.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 6-Click on link projectDetails BPBddPoc - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 7-Click on button BDDPoc.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 9-Click on label EnableBDDReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 10-Click on button Save.png')
...
"Step 13: Click on div integrationTools (integrationTools)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 13-Click on div integrationTools integrationTools.png')

"Step 14: Click on div iconElements (iconElements2)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 14-Click on div iconElements iconElements2.png')

"Step 15: Click on div testingTools (testingTools)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 15-Click on div testingTools testingTools.png')

"Step 16: Click on div integrationTools (integrationTools2)"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 16-Click on div integrationTools integrationTools2.png')

"Step 17: Click on div testingTools (testingTools2) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 17-Click on div testingTools testingTools2 - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Manage Integrations and Enable BDD Reports in Sauce Demo_visual_checkpoint')
