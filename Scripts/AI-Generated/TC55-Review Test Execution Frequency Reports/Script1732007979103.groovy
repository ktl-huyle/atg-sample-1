...
"Step 4: Click on div testRunsUpload (TestRunsUpload)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_testRunsUpload'))

WebUI.takeScreenshot(reportLocation + '/TC55/Step 4-Click on div testRunsUpload TestRunsUpload.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC55-Review Test Execution Frequency Reports_visual_checkpoint')
