...
"Step 7: Click on pre failedTest (failedVerify) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 7-Click on pre failedTest failedVerify - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC33-Verify Test Execution and Home Page_visual_checkpoint')
