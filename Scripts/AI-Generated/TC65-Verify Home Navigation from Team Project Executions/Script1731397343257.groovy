...
"Step 15: Click on pre object3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/pre_object3'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC65-Verify Home Navigation from Team Project Executions_visual_checkpoint')
