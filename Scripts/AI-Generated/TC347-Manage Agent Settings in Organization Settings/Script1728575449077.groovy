...
import truetest.common.openAndUpdateProjectDetails
...
WebUI.takeScreenshot(reportLocation + '/TC347/Step 4-Click on link AgentSetup2 - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC347/Step 5-Click on link TestEnvironments - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC347/Step 6-Click on link agentSettings MyAgent.png')

"Step 7: Open project and update agent details"

openAndUpdateProjectDetails.execute()
...
WebUI.takeScreenshot(reportLocation + '/TC347/Step 8-Click on link AgentSetup - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC347/Step 9-Click on link TestEnvironments - Navigate to page organizationsettingsagent.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC347-Manage Agent Settings in Organization Settings_visual_checkpoint')
