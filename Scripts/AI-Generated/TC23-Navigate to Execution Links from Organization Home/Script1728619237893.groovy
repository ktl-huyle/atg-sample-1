...
"Step 4: Click on link LoadingInfo -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/link_LoadingInfo'))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 4-Click on link LoadingInfo - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 5-Click on link Execution2592 - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 6-Click on link TestCloudWindowsChrome - Navigate to page teamprojectagenttest-cloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 7-Click on link pageNavigation Page4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 8-Click on link pageNavigation Page3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 9-Click on link pageNavigation Page2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 10-Click on link pageNavigation Page1.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 11-Click on link pageNavigation Page2 - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Navigate to Execution Links from Organization Home_visual_checkpoint')
