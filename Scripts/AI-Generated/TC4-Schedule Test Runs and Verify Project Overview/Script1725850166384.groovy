...
"Step 4: Schedule a test run with environment configuration"
...
"Step 13: Schedule a test run with environment configuration"
...
"Step 16: Click on div subscribed"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_subscribed'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Schedule Test Runs and Verify Project Overview_visual_checkpoint')
