...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5-Click on link TestRuns3 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6-Click on link executionDetails executionDetails - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 7-Click on button LinkToRelease2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8-Click on span RegresiIpa.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 11-Click on link TestRuns32 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 12-Click on button LinkToRelease2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 13-Click on span RegresiIpa - Navigate to page .png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-View Release Reports and Verify Home Page_visual_checkpoint')
