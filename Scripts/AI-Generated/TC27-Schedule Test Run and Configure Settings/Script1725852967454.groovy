...
"Step 21: Configure test environments and run tests with multiple settings."
...
"Step 32: Schedule a test run and configure test objects."

scheduleAndRunTest.execute(data_path_1, Integer.valueOf(index_1))

"Step 33: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC27-Schedule Test Run and Configure Settings_visual_checkpoint')
