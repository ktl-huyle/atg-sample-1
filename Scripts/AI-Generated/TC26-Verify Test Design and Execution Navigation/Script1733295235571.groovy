...
"Step 9: Click on span objectItems (Object4)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems', ['span_objectItems_divNthChild': span_objectItems_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 9-Click on span objectItems Object4.png')

"Step 10: Click on div testCaseItems (TestCases2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1'))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 10-Click on div testCaseItems TestCases2.png')

"Step 11: Click on span objectItems (KatalonStudioTestCases)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 11-Click on span objectItems KatalonStudioTestCases.png')

"Step 12: Click on div testCaseItems (AgendarInventario)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1', ['div_testCaseItems_internalText': div_testCaseItems_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 12-Click on div testCaseItems AgendarInventario.png')
...
"Step 14: Click on div testCaseItems (MantenimientoSalas)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1', ['div_testCaseItems_internalText': div_testCaseItems_internalText_1]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 14-Click on div testCaseItems MantenimientoSalas.png')

"Step 15: Click on div testCaseItems (AgendarInventario)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1', ['div_testCaseItems_internalText': div_testCaseItems_internalText_2]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 15-Click on div testCaseItems AgendarInventario.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1', ['div_testCaseItems_internalText': div_testCaseItems_internalText_3]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 16-Click on div testCaseItems KatalonCloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 17-Click on link TestSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 23-Click on input rowSelection SelectRowCheckbox.png')
...
"Step 28: Click on span treeSwitchers (Object5)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 28-Click on span treeSwitchers Object5.png')

"Step 29: Click on div testCaseItems (AgendarInventario)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1', ['div_testCaseItems_internalText': div_testCaseItems_internalText_4]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 29-Click on div testCaseItems AgendarInventario.png')

"Step 30: Click on link caseLinks (Agendamiento) -> Navigate to page 'team/*/project/*/test-design/test-cases/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/link_caseLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/link_caseLinks', ['link_caseLinks_internalRoleLinkName': link_caseLinks_internalRoleLinkName, 'project_id': project_id, 'test_cases_id': test_cases_id, 'team_id': team_id]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 30-Click on link caseLinks Agendamiento - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 31-Click on link TestSuites4 - Navigate to page teamprojecttest-designtest-suites.png')

"Step 32: Click on span treeIcons (TreeSwitcherIcon)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 32-Click on span treeIcons TreeSwitcherIcon.png')

"Step 33: Click on span treeIcons (icon)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 33-Click on span treeIcons icon.png')
...
"Step 35: Click on div testSuiteItems (testSuite Validation Vehicles Damages Major)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 35-Click on div testSuiteItems testSuite Validation Vehicles Damages Major.png')

"Step 36: Click on div testSuiteItems (testSuite Validation Vehicles Damages Minor)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 36-Click on div testSuiteItems testSuite Validation Vehicles Damages Minor.png')

"Step 37: Click on link testSuiteActions (TestSuiteValidation) -> Navigate to page 'team/*/project/*/test-design/test-suites/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions_1', ['link_testSuiteActions_internalRoleLinkName': link_testSuiteActions_internalRoleLinkName, 'test_suites_id': test_suites_id, 'project_id': project_id_1, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 37-Click on link testSuiteActions TestSuiteValidation - Navigate to page teamprojecttest-designtest-suites.png')

"Step 38: Click on link testSuiteActions (TestSuiteValidation2) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['executions_id': executions_id, 'project_id': project_id_2, 'team_id': team_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 38-Click on link testSuiteActions TestSuiteValidation2 - Navigate to page teamprojectexecutions.png')
...
"Step 45: Click on div testCaseItems (MantenimientoSalas)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_testCaseItems_1', ['div_testCaseItems_internalText': div_testCaseItems_internalText_5]))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 45-Click on div testCaseItems MantenimientoSalas.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 47-Click on input rowSelection SelectRowCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 48-Click on input rowSelection UnselectRowCheckbox.png')

"Step 49: Click on div testRunItems (TestRunCell)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 49-Click on div testRunItems TestRunCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 50-Click on input rowSelection SelectRowCheckbox3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 51-Click on input rowSelection UnselectRowCheckbox2 - Navigate to page .png')

"Step 52: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC26-Verify Test Design and Execution Navigation_visual_checkpoint')
