...
"Step 9: Click on span objectItems (objectItems20)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 9-Click on span objectItems objectItems20.png')
...
"Step 11: Click on span objectItems (objectItems20)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_objectItems'))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 11-Click on span objectItems objectItems20.png')
...
"Step 28: Click on span treeSwitcher (TreeSwitcher6)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 28-Click on span treeSwitcher TreeSwitcher6.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/link_testCDC', ['link_testCDC_nthChild': link_testCDC_nthChild, 'link_testCDC_internalRoleLinkName': link_testCDC_internalRoleLinkName, 'team_id': team_id, 'test_cases_id': test_cases_id, 'project_id': project_id]))
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 34-Click on span treeSwitcher treeSwitcher2.png')
