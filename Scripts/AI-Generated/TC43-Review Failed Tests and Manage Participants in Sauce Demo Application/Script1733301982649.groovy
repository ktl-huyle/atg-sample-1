...
"Step 4: Click on div failedItems (dynamicObject)"
...
WebUI.takeScreenshot(reportLocation + '/TC43/Step 4-Click on div failedItems dynamicObject.png')

"Step 5: Click on div failedTests (failedTests6)"
...
WebUI.takeScreenshot(reportLocation + '/TC43/Step 5-Click on div failedTests failedTests6.png')

"Step 6: Click on div failedTests (failedTests7)"
...
WebUI.takeScreenshot(reportLocation + '/TC43/Step 6-Click on div failedTests failedTests7.png')
...
"Step 10: Click on div FailedTestRun (dynamicObject2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_FailedTestRun"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_FailedTestRun', ['div_FailedTestRun_internalRoleButtonName': div_FailedTestRun_internalRoleButtonName]))

WebUI.takeScreenshot(reportLocation + '/TC43/Step 10-Click on div FailedTestRun dynamicObject2.png')
...
"Step 16: Click on image filePreviews (dynamicObject)"
...
WebUI.takeScreenshot(reportLocation + '/TC43/Step 16-Click on image filePreviews dynamicObject.png')

"Step 17: Click on button Close22 -> Navigate to page 'organization/*/home'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/button_Close22'))

WebUI.takeScreenshot(reportLocation + '/TC43/Step 17-Click on button Close22 - Navigate to page organizationhome.png')

"Step 18: Click on link participantManagement (dynamicObject) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC43/Step 18-Click on link participantManagement dynamicObject - Navigate to page teamprojectexecutions.png')

"Step 19: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC43-Review Failed Tests and Manage Participants in Sauce Demo Application_visual_checkpoint')
