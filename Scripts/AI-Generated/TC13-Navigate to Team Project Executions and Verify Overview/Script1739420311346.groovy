...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 2-Click on link Executions - Navigate to page team project detailteamproject.png')
...
"Step 5: Click on link TestRuns3 -> Navigate to page 'team project executions#team/*/project/*/executions'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/overview?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_overview/link_TestRuns3'))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on link TestRuns3 - Navigate to page team project executionsteamprojectexecutions.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Navigate to Team Project Executions and Verify Overview_visual_checkpoint')
