...
WebUI.takeScreenshot(reportLocation + '/TC418/Step 4-Click on link executionLinks Execution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC418/Step 5-Click on link executionLinks Execution2.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC418-Verify Execution Links in Project Executions_visual_checkpoint')
