...
import truetest.common.manageTestResultStatus
...
"Step 2: View and change the status of test results in the project"

manageTestResultStatus.execute()
...
"Step 16: View and change the status of test results in the project"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Mark Test Results as Passed and Verify Home Page_visual_checkpoint')
