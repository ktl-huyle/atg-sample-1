...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 4-Click on link projectLinks FirstProject - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 5-Click on link Executions.png')

"Step 6: Schedule multiple test runs with different configurations"

scheduleMultipleTestRuns.execute(data_path_0, Integer.valueOf(index_0))

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC103-Schedule Test Runs with Different Configurations_visual_checkpoint')
