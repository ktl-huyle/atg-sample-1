...
"Step 4: Click on pre failedTestCases (ErrorMessage)"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 4-Click on pre failedTestCases ErrorMessage.png')
...
"Step 8: Click on div sketchDetails (CreatedWithSketch)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_sketchDetails'))

WebUI.takeScreenshot(reportLocation + '/TC29/Step 8-Click on div sketchDetails CreatedWithSketch.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC29-Verify failed test cases and resource management_visual_checkpoint')
