...
"Step 2: Click on pre failedTests (ErrorMessage)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 2-Click on pre failedTests ErrorMessage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Preview and Verify Test Run Resources_visual_checkpoint')
