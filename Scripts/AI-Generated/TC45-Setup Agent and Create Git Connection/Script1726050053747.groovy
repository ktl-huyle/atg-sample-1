...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 4-Click on link agentSetup - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 5-Click on link testEnvironments - Navigate to page organizationsettingsagent.png')

"Step 6: Click on link myAgent"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/settings/agent?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_settings_agent/link_myAgent'))

WebUI.takeScreenshot(reportLocation + '/TC45/Step 6-Click on link myAgent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 8-Click on link agentSetup - Navigate to page organizationsettingstest-environment-installation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC45/Step 9-Click on link testEnvironments - Navigate to page organizationsettingsagent.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC45-Setup Agent and Create Git Connection_visual_checkpoint')
