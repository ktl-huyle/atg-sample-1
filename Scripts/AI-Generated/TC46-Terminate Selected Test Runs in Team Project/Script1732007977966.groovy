...
"Step 4: Click on input selectRowCheckbox (SelectRow)"
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 4-Click on input selectRowCheckbox SelectRow.png')

"Step 5: Click on input selectRowCheckbox (SelectRow2)"
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 5-Click on input selectRowCheckbox SelectRow2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 6-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 7-Click on button Confirm.png')

"Step 8: Click on input selectRowCheckbox (SelectRow3)"
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 8-Click on input selectRowCheckbox SelectRow3.png')

"Step 9: Click on input selectRowCheckbox (SelectRow4)"
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 9-Click on input selectRowCheckbox SelectRow4.png')

"Step 10: Click on input selectRowCheckbox (SelectRow5)"
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 10-Click on input selectRowCheckbox SelectRow5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 11-Click on button Terminate2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 12-Click on button Confirm.png')

"Step 13: Click on input selectRowCheckbox (SelectRow6)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/input_selectRowCheckbox"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/input_selectRowCheckbox', ['input_selectRowCheckbox_class': input_selectRowCheckbox_class_5, 'input_selectRowCheckbox_internalRoleRowName': input_selectRowCheckbox_internalRoleRowName_5]))

WebUI.takeScreenshot(reportLocation + '/TC46/Step 13-Click on input selectRowCheckbox SelectRow6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 14-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC46/Step 15-Click on button Confirm - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC46-Terminate Selected Test Runs in Team Project_visual_checkpoint')
