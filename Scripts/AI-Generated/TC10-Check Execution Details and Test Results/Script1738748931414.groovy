...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 14-Click on pre failedTests FailedTest.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Check Execution Details and Test Results_visual_checkpoint')
