...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_userAction'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC21-Verify User Flow Navigation from Welcome Page_visual_checkpoint')
