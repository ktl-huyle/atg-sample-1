...
"Step 3: Click on pre errorMessages (FailedTestCase)"
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3-Click on pre errorMessages FailedTestCase.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCases"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCases', ['div_failedTestCases_class': div_failedTestCases_class_2, 'div_failedTestCases_internalRoleButtonName': div_failedTestCases_internalRoleButtonName_2]))
...
"Step 18: Click on pre errorMessages (FailedPreRequisiteBranchOpen)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/pre_errorMessages"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/pre_errorMessages', ['pre_errorMessages_class': pre_errorMessages_class_1, 'pre_errorMessages_internalRoleButtonName': pre_errorMessages_internalRoleButtonName_1]))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 18-Click on pre errorMessages FailedPreRequisiteBranchOpen.png')
...
"Step 21: Click on pre errorMessages (FailedPreRequisiteBranchOpen2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/pre_errorMessages"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/pre_errorMessages', ['pre_errorMessages_class': pre_errorMessages_class_2, 'pre_errorMessages_internalRoleButtonName': pre_errorMessages_internalRoleButtonName_2]))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 21-Click on pre errorMessages FailedPreRequisiteBranchOpen2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Manage Failed Test Cases and Verify Home Page_visual_checkpoint')
