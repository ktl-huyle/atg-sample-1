...
WebUI.takeScreenshot(reportLocation + '/TC156/Step 13-Click on div integrationTools KatalonStudio.png')
...
WebUI.takeScreenshot(reportLocation + '/TC156/Step 14-Click on div integrationTools ALMTestManagement.png')
...
WebUI.takeScreenshot(reportLocation + '/TC156/Step 15-Click on div integrationTools MobileDeviceTesting.png')
...
WebUI.takeScreenshot(reportLocation + '/TC156/Step 16-Click on div integrationTools Kobiton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC156/Step 17-Click on div integrationTools TestingFramework - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC156-Manage BDD reports and verify home page_visual_checkpoint')
