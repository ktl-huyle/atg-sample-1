...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 5-Click on td licenseDetails KSENodeLocked.png')

"Step 6: Click on span licenseDetails (KSENodeLocked)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/license?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_user_license/span_licenseDetails'))

WebUI.takeScreenshot(reportLocation + '/TC104/Step 6-Click on span licenseDetails KSENodeLocked.png')
...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 7-Click on td licenseDetails KSENodeLocked2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC104-Verify License Management and Home Page Access_visual_checkpoint')
