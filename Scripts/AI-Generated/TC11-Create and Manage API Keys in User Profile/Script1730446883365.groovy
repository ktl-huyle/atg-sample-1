...
"Step 2: Create a new API key for accessing application features"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Manage API Keys in User Profile_visual_checkpoint')
