...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 8-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')

"Step 9: Click on span testCaseItems (objectItems)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Click on span testCaseItems objectItems.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 10-Click on div testCases testCases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 11-Click on span testCaseItems testCaseItems.png')

"Step 12: Click on div testCases (testCases2)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 12-Click on div testCases testCases2.png')
...
"Step 14: Click on div testCases (testCases3)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 14-Click on div testCases testCases3.png')

"Step 15: Click on div testCases (testCases2)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 15-Click on div testCases testCases2.png')

"Step 16: Click on div testCases (testCases4)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 16-Click on div testCases testCases4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 17-Click on link TestSuites4 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 20-Click on link Executions2 - Navigate to page teamprojecttest-runs.png')
...
"Step 23: Click on input rowSelection (rowSelection)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 23-Click on input rowSelection rowSelection.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 26-Click on input SelectAllRowsCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 28-Click on span TreeSwitcher.png')

"Step 29: Click on div testCases (testCases2)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 29-Click on div testCases testCases2.png')

"Step 30: Click on link AgendamientoInventarioConDaniosMayores -> Navigate to page 'team/*/project/*/test-design/test-cases/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_design_test_cases/link_AgendamientoInventarioConDaniosMayores'))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 30-Click on link AgendamientoInventarioConDaniosMayores - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 31-Click on link TestSuites42 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 32-Click on span treeIcons treeIcons.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 33-Click on span treeIcons treeIcons2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 34-Click on span TreeSwitcher.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 35-Click on div testSuiteItems testSuiteItems8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 36-Click on div testSuiteItems testSuiteItems9.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['link_testSuiteActions_internalRoleLinkName': link_testSuiteActions_internalRoleLinkName, 'test_suites_id': test_suites_id, 'team_id': team_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 37-Click on link testSuiteActions testSuiteActions - Navigate to page teamprojecttest-designtest-suites.png')

"Step 38: Click on link testSuiteActions (TestSuiteValidation) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions_1', ['executions_id': executions_id, 'team_id': team_id_1, 'project_id': project_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 38-Click on link testSuiteActions TestSuiteValidation - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 39-Click on link TestResults3 - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 44-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')

"Step 45: Click on div testCases (testCases3)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 45-Click on div testCases testCases3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 46-Click on link Executions2 - Navigate to page teamprojecttest-runs.png')

"Step 47: Click on input rowSelection (rowSelection2)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 47-Click on input rowSelection rowSelection2.png')

"Step 48: Click on input rowSelection (rowSelection3)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 48-Click on input rowSelection rowSelection3.png')

"Step 49: Click on div testRunItems (testRunItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 49-Click on div testRunItems testRunItems2.png')

"Step 50: Click on input rowSelection (rowSelection4)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 50-Click on input rowSelection rowSelection4.png')

"Step 51: Click on input rowSelection (rowSelection5) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 51-Click on input rowSelection rowSelection5 - Navigate to page .png')

"Step 52: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Test Design Cases and Execution Management in Sauce Demo_visual_checkpoint')
