...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testItems', ['link_testItems_nthChild': link_testItems_nthChild, 'project_id': project_id_1, 'team_id': team_id_1, 'path_param_6': path_param_6, 'path_param_5': path_param_5]))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites', ['link_testSuites_internalRoleLinkName': link_testSuites_internalRoleLinkName, 'project_id': project_id_2, 'team_id': team_id_2, 'path_param_6': path_param_6_1, 'path_param_5': path_param_5_1]))
...
"Step 34: Click on span treeSwitcherIcons (TreeSwitcherIcon)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/span_treeSwitcherIcons"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/span_treeSwitcherIcons', ['span_treeSwitcherIcons_divNthChild': span_treeSwitcherIcons_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 34-Click on span treeSwitcherIcons TreeSwitcherIcon.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites', ['link_testSuites_internalRoleLinkName': link_testSuites_internalRoleLinkName_1, 'project_id': project_id_3, 'team_id': team_id_3, 'path_param_6': path_param_6_2, 'path_param_5': path_param_5_2]))
...
"Step 56: Click on link testingTools (VisualTesting) -> Navigate to page 'team project#team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/link_testingTools"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/link_testingTools', ['link_testingTools_internalRoleLinkName': link_testingTools_internalRoleLinkName, 'project_id': project_id_4, 'team_id': team_id_4, 'path_param_5': path_param_5_3]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 56-Click on link testingTools VisualTesting - Navigate to page team projectteamproject.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Integrate Jira and Verify Team Project_visual_checkpoint')
