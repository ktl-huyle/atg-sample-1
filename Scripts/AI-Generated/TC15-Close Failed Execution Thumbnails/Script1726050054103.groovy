...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 4-Click on pre failedE2Ecglflow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 5-Click on div thumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 7-Click on div thumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 8-Click on button close - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Close Failed Execution Thumbnails_visual_checkpoint')
