...
"Step 8: Click on link testSuites (CoordinatorCore) -> Navigate to page 'team project executions#team/{*}/project/{*}/executions/{*}'"
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 8-Click on link testSuites CoordinatorCore - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC28-Navigate to Test Suites and Confirm Home Page_visual_checkpoint')
