...
"Step 4: Click on link testRuns"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_testRuns'))

WebUI.takeScreenshot(reportLocation + '/TC2/Step 4-Click on link testRuns.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Test Runs in Team Project_visual_checkpoint')
