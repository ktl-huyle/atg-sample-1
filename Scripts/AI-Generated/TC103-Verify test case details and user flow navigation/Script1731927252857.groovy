...
"Step 16: Click on div testCaseDetails (UploadedData) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC103/Step 16-Click on div testCaseDetails UploadedData - Navigate to page .png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC103-Verify test case details and user flow navigation_visual_checkpoint')
