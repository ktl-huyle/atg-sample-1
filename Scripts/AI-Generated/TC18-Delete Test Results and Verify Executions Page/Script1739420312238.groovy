...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 2-Click on div CustomCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3-Click on label testResults FailedSISBook.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Click on label testResults FailedSISBook2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 5-Click on button Delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 6-Click on button delete.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Delete Test Results and Verify Executions Page_visual_checkpoint')
