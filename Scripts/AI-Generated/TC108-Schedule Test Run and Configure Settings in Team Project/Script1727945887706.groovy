...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 4-Click on td dynamicObject TestProject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 5-Click on td dynamicObject TestProject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 6-Click on link dynamicObject TestProject - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 7-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 8-Click on button AlertButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 9-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 11-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 12-Click on link OrganizationSetup - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 13-Click on link AgentSetup - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 14-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 16-Click on link ViewEPPsAutomationTest - Navigate to page teamprojecttest-runs.png')

"Step 17: Click on header testRunStatus (EPPsAutomationTest) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunStatus"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunStatus', ['header_testRunStatus_internalRoleHeadingName': header_testRunStatus_internalRoleHeadingName]))

WebUI.takeScreenshot(reportLocation + '/TC108/Step 17-Click on header testRunStatus EPPsAutomationTest - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC108-Schedule Test Run and Configure Settings in Team Project_visual_checkpoint')
