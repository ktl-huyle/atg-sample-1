...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 4-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 5-Click on link Executions3 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 6-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 7-Click on link ScriptRepositories - Navigate to page teamprojecttest-project.png')

"Step 8: Click on td testProjectDetails (katalonWebsite)"
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 8-Click on td testProjectDetails katalonWebsite.png')

"Step 9: Click on link projectLinks (katalonWebsite) -> Navigate to page 'team/*/project/*/test-project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 9-Click on link projectLinks katalonWebsite - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 10-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 11-Click on button RefreshScriptRepository2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 12-Click on button RefreshScriptRepository2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC421/Step 13-Click on link Dashboard2 - Navigate to page teamproject.png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC421-Refresh Script Repository in Team Project_visual_checkpoint')
