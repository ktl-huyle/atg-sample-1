...
WebUI.takeScreenshot(reportLocation + '/TC154/Step 4-Click on link Planning - Navigate to page team project releasesteamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC154/Step 5-Click on link SPRINT - Navigate to page team project releasesteamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC154/Step 6-Click on link TestRuns - Navigate to page team project releases executionsteamprojectreleasesexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC154/Step 7-Click on link 4077 - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC154/Step 8-Click on link TestResults - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC154/Step 9-Click on div TestCasePassed.png')

"Step 10: View multiple thumbnail images and close the viewer repeatedly"
...
WebUI.takeScreenshot(reportLocation + '/TC154/Step 11-Click on link Planning - Navigate to page team project releasesteamprojectreleases.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC154-Verify Sprint and Test Runs Access in Team Project Releases_visual_checkpoint')
