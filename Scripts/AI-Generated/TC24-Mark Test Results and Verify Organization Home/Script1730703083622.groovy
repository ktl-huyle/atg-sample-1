...
"Step 2: View test result details and mark as passed"

viewTestResultsAndMarkAsPassed.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 16: View test result details and mark as passed"

viewTestResultsAndMarkAsPassed.execute(data_path_1, Integer.valueOf(index_1))
