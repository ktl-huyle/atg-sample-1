...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 2-Click on button Shamika.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Sign Out from Team Project_visual_checkpoint')
