...
"Step 8: Click on div penTestIssues (penTestIssues)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_penTestIssues'))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 8-Click on div penTestIssues penTestIssues.png')
...
"Step 10: Click on link executionDetails (executionDetails3)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName, 'team_id': team_id, 'project_id': project_id, 'executions_id': executions_id]))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 10-Click on link executionDetails executionDetails3.png')
...
"Step 12: Click on link executionDetails (executionDetails4) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 12-Click on link executionDetails executionDetails4 - Navigate to page teamprojectexecutions.png')
...
"Step 14: Click on td testCaseCheckout"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/td_testCaseCheckout'))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 14-Click on td testCaseCheckout.png')
...
"Step 18: Click on link executionDetails (executionDetails3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_2, 'team_id': team_id_2, 'project_id': project_id_2, 'executions_id': executions_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 18-Click on link executionDetails executionDetails3.png')

"Step 19: Click on link executionDetails (executionDetails4) -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails', ['link_executionDetails_trNthChild': link_executionDetails_trNthChild_1, 'link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_3, 'team_id': team_id_3, 'project_id': project_id_3, 'executions_id': executions_id_3]))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 19-Click on link executionDetails executionDetails4 - Navigate to page teamprojectexecutions.png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC21-Sort Test Executions and Verify Page_visual_checkpoint')
