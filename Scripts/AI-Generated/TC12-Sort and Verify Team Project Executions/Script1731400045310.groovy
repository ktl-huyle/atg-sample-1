...
"Step 2: Click on div sortInfo (SortInfo)"
...
"Step 4: Click on div sortInfo (SortInfo2)"
...
"Step 6: Click on div objectInfo (Object2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_objectInfo'))
...
"Step 8: Click on link executionInfo (Object) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Sort and Verify Team Project Executions_visual_checkpoint')
