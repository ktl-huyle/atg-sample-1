...
"Step 7: Click on button showAPIKey (Object)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_ShowAPIKey_1'))

WebUI.takeScreenshot()

"Step 9: Click on input passwordField (Object)"
...
"Step 10: Click on input passwordField (Password)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/input_passwordField_1'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Verify API Key Creation and Logout Process_visual_checkpoint')
