...
"Step 2: Create a new API key for access and manage settings."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Manage API Key in User Settings_visual_checkpoint')
