...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 2-Click on link Executions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3-Click on link Executions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 4-Click on link Schedules2 - Navigate to page team project gridteamprojectgrid.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 5-Click on link Settings - Navigate to page settingsteamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 6-Click on link TestEnvironments - Navigate to page team project agentteamprojectagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 7-Click on link ScriptRepositories - Navigate to page team projectteamproject.png')

"Step 8: Click on link Executions2 -> Navigate to page 'team project detail#team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Executions2'))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 8-Click on link Executions2 - Navigate to page team project detailteamproject.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Access Team Project Settings and Verify Details_visual_checkpoint')
