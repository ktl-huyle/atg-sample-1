...
WebUI.takeScreenshot(reportLocation + '/TC425/Step 4-Click on link Files - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC425/Step 5-Click on link executionFiles HTMLFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC425/Step 6-Click on button ReRun - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC425-Re run Execution Files in Project Executions_visual_checkpoint')
