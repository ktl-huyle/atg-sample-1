...
"Step 12: Click on div testSuites (TestRunDetails)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 12-Click on div testSuites TestRunDetails.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Check Test Results and Return to Home Page_visual_checkpoint')
