...
WebUI.takeScreenshot(reportLocation + '/TC415/Step 4-Click on link Executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC415/Step 5-Click on header testRunTitles EPPsAutomationTest.png')

"Step 6: Click on button sessionTabs (Sessions) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC415/Step 6-Click on button sessionTabs Sessions - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC415-Verify Executions in Team Project Test Runs_visual_checkpoint')
