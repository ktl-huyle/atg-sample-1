...
"Step 4: Click on div testRunCells (APIMediaFiles)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on div testRunCells APIMediaFiles.png')
...
"Step 20: Click on link testingResources (KatalonWebsite) -> Navigate to page 'team/*/project/*/test-project/*'"
...
"Step 26: Click on td testingResources (KatalonWebsite)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 26-Click on td testingResources KatalonWebsite.png')

"Step 27: Click on link testingResources (KatalonWebsite) -> Navigate to page 'team/*/project/*/test-project/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_project/link_testingResources"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_project/link_testingResources', ['link_testingResources_trNthChild': link_testingResources_trNthChild_1, 'link_testingResources_internalRoleLinkName': link_testingResources_internalRoleLinkName_1, 'test_project_id': test_project_id_1, 'team_id': team_id_1, 'project_id': project_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 27-Click on link testingResources KatalonWebsite - Navigate to page teamprojecttest-project.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Verify Scheduling of Test Runs and Script Refresh_visual_checkpoint')
