...
"Step 7: Click on div menuBackdrop (PopoverBackdrop)"
...
"Step 11: Click on div menuBackdrop (PopoverBackdrop)"
...
"Step 54: Click on div integrationIcon (CodelessAutomationToolIcon)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/integrations?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationIcon"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_integrations/div_integrationIcon', ['div_integrationIcon_internalRoleTreeitemName': div_integrationIcon_internalRoleTreeitemName]))

WebUI.takeScreenshot()

"Step 55: Click on div integrationTools (CodelessAutomationTool)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Manage Test Runs and Verify Home Page_visual_checkpoint')
