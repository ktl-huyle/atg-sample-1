...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 4-Click on button runActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 5-Click on span R5Maintenance.png')

"Step 6: Click on button runActions (Run) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 6-Click on button runActions Run - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC173-Run Actions in Team Project Grid Plan Job_visual_checkpoint')
