...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 4-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 5-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 6-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 7-Click on link Executions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 8-Click on div testRunCells UntitledTestRun4053.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 9-Click on div testRunCells UntitledTestRun4054.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 10-Click on header testRunHeaders UntitledTestRun4054.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 11-Click on button Details.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 12-Click on button Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 13-Click on div dynamicObject PopoverBackdrop.png')

"Step 14: Click on div testRunLabels (UntitledTestRunLabel)"
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 14-Click on div testRunLabels UntitledTestRunLabel.png')

"Step 15: Click on div testRunLabels (UntitledTestRunLabel)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/div_testRunLabels"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_testRunLabels', ['div_testRunLabels_internalLabel': div_testRunLabels_internalLabel_1]))

WebUI.takeScreenshot(reportLocation + '/TC282/Step 15-Click on div testRunLabels UntitledTestRunLabel.png')

"Step 16: Click on div testRunLabels (UntitledTestRunLabel)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/div_testRunLabels"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_testRunLabels', ['div_testRunLabels_internalLabel': div_testRunLabels_internalLabel_2]))

WebUI.takeScreenshot(reportLocation + '/TC282/Step 16-Click on div testRunLabels UntitledTestRunLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 17-Click on div Paper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 18-Click on div Paper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 19-Click on button Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 20-Click on div dynamicObject PopoverBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 21-Click on div Paper.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 22-Click on button SessionsTab.png')
...
WebUI.takeScreenshot(reportLocation + '/TC282/Step 23-Click on button FailedTestResultsTab - Navigate to page .png')

"Step 24: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC282-View and Analyze Test Run Details_visual_checkpoint')
