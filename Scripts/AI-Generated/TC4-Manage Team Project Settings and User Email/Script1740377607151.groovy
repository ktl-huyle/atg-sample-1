...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Click on div testRunDetails ParallelSuite749.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on div testRunDetails ParallelSuite750.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on div testRunDetails ParallelSuite751.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_detail/div_MyOrganization'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on div MyOrganization.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Manage Team Project Settings and User Email_visual_checkpoint')
