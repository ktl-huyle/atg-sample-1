import truetest.common.viewTestResultDetailsAndUpdateStatus
...
"Step 2: View test result details and mark the result as passed"

viewTestResultDetailsAndUpdateStatus.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 16: View test result details and mark the result as passed"

viewTestResultDetailsAndUpdateStatus.execute(data_path_1, Integer.valueOf(index_1))
