...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 2-Click on button executionControl LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3-Click on span R5Maintenance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Click on button executionControl Run.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Control Execution and View Reports in Project Management_visual_checkpoint')
