...
"Step 5: Click on link RunFrequency -> Navigate to page 'report#team/{*}/project/{*}/test-reports/test-execution/frequency-report'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/overview?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_overview/link_RunFrequency'))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 5-Click on link RunFrequency - Navigate to page reportteamprojecttest-reportstest-executionfrequency-report.png')
...
"Step 9: Click on link RunFrequency -> Navigate to page 'report#team/{*}/project/{*}/test-reports/test-execution/frequency-report'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/overview?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_overview/link_RunFrequency'))

WebUI.takeScreenshot(reportLocation + '/TC15/Step 9-Click on link RunFrequency - Navigate to page reportteamprojecttest-reportstest-executionfrequency-report.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify Report Generation from Test Runs_visual_checkpoint')
