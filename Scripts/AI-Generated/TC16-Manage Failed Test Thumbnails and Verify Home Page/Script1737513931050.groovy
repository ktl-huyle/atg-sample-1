...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 2-Click on pre failedTests failedTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 3-Click on div thumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 4-Click on button close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 5-Click on div thumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 6-Click on button close - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Manage Failed Test Thumbnails and Verify Home Page_visual_checkpoint')
