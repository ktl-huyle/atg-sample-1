...
import katalon.common.scheduleAndRunTestConfigurations
...
"Step 25: Schedule and run tests with various configurations"

scheduleAndRunTestConfigurations.execute(data_path_0, Integer.valueOf(index_0))
...
"Step 65: Schedule and run tests with various configurations"

scheduleAndRunTestConfigurations.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Check Team Project Grid Plan Job Executions_visual_checkpoint')
