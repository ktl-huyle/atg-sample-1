...
import truetest.common.viewTestRunDetailsAndSearchExecutions
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 4-Click on link Reports5 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 5-Click on link TestRuns4 - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 6-Click on button selectOrganization SelectOrganization2 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 7-Click on link Reports6.png')

"Step 8: View test run details and search for executions"

viewTestRunDetailsAndSearchExecutions.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 9-Click on link Overview - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 10-Click on link Executions - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 11-Click on body PageContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 12-Click on item RunningOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 13-Click on input Executor.png')

"Step 14: Click on div historyDetails (HistorySchedule)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_historyDetails'))

WebUI.takeScreenshot(reportLocation + '/TC47/Step 14-Click on div historyDetails HistorySchedule.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 15-Click on input DateRange.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 16-Click on button gridCells GridCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 17-Click on input DateRange.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 18-Click on button gridCells gridCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 20-Click on input selectAllRows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 21-Click on button terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 22-Click on button confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 23-Click on input DateRange2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 24-Click on button monthNavigation PreviousMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 26-Click on button gridCells gridCell2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 28-Click on input selectAllRows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 29-Click on button terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 30-Click on button confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 31-Click on link Reports7 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 32-Click on link TestRuns6 - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 33-Click on link Executions4 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 34-Click on input selectRow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 35-Click on button terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 36-Click on button confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 37-Click on header testRunDetails testRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 38-Click on button alertClose AlertClose2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 39-Click on link Reports6 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 40-Click on link TestRuns6 - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 41-Click on button selectOrganization SelectOrganization3 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 42-Click on link executions2 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 43-Click on i time.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 44-Click on button monthNavigation PreviousMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 46-Click on button gridCells gridCell2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 47-Click on button monthNavigation nextMonth.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 49-Click on button gridCells gridCell3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 50-Click on input Executor.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 51-Click on body PageContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 52-Click on div running.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 53-Click on input selectAllRows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 54-Click on button terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 55-Click on button confirm.png')

"Step 56: Click on link testingTools (calendar)"
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 56-Click on link testingTools calendar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 57-Click on link moreItems more.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 58-Click on span importing.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 59-Click on link details - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 60-Click on link testResults - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 61-Click on link files4 - Navigate to page file managementteamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 62-Click on link reports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 63-Click on span bhtIp.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 64-Click on link bhtLnc - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 65-Click on link Reports6 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 66-Click on link TestRuns6 - Navigate to page team project executionsteamprojectexecutions.png')

"Step 67: Click on link projectExecutions (TestExecution)"
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 67-Click on link projectExecutions TestExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 68-Click on button selectOrganization SelectOrganization3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 69-Click on link BhtIp - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 70-Click on link executions2 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 71-Click on input DateRange.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 72-Click on button gridCells gridCell4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 73-Click on body PageContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 74-Click on div backdropElements MenuBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 75-Click on i executor.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 76-Click on button open.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 77-Enter input value in input Executor.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 78-Click on div userEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 79-Click on header testRunDetails testRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 80-Click on button Close2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 81-Click on link executions3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 82-Click on link executions3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 83-Click on link Reports5.png')

"Step 84: View test run details and search for executions"

viewTestRunDetailsAndSearchExecutions.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 85-Click on link executions - Navigate to page team projectteamproject.png')

"Step 86: Click on link testingTools (calendar)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_testingTools"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testingTools', ['link_testingTools_internalRoleLinkName': link_testingTools_internalRoleLinkName_1]))

WebUI.takeScreenshot(reportLocation + '/TC47/Step 86-Click on link testingTools calendar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 87-Click on link moreItems more.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 88-Click on div rowBackground.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 89-Click on link moreItems more.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 90-Click on link Reports5 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC47/Step 91-Click on link TestRuns4 - Navigate to page team project executionsteamprojectexecutions.png')

"Step 92: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC47-View Test Execution Reports and Analyze Results_visual_checkpoint')
