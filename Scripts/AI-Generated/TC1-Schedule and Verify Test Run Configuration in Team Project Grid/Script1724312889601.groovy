...
scheduleTestRunAndSaveConfiguration.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Schedule and Verify Test Run Configuration in Team Project Grid_visual_checkpoint')
