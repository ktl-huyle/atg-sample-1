...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on link Executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 5-Click on div testRunItems ParallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on div testRunItems ParallelSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on div testRunItems ParallelSuite3.png')

"Step 8: Click on div testRunItems (ParallelSuite) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 8-Click on div testRunItems ParallelSuite - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Team Project Executions Navigation and Login_visual_checkpoint')
