...
WebUI.takeScreenshot(reportLocation + '/TC91/Step 4-Click on div MaintenanceLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC91/Step 5-Click on div TestRunsConfiguration.png')
...
WebUI.takeScreenshot(reportLocation + '/TC91/Step 6-Click on button runActions Run4.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC91-Configure Test Runs in Team Project Grid_visual_checkpoint')
