...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 4-Click on button failedTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 5-Click on button deleteExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 6-Click on button deleteExecution2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 7-Click on button failedTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 8-Click on button deleteExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 9-Click on button deleteExecution2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 10-Click on div executionStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 11-Click on div dashboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 12-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 13-Click on div Dashboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC57/Step 14-Click on div Dashboard2.png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC57-Delete Failed Test Executions_visual_checkpoint')
