...
"Step 2: Click on link projectExecution (SC Synergy Care Manager) -> Navigate to page 'team project#team/{*}/project/{*}'"
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 2-Click on link projectExecution SC Synergy Care Manager - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 3-Click on button EnableJiraIntegration - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 4-Click on link JiraAddon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 5-Click on link JiraAddon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 6-Click on div RequiredFieldsMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 7-Click on div ColumnContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 8-Click on input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 9-Enter input value in input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 10-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 11-Enter input value in input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 12-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 13-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 14-Click on input Username.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 15-Click on div PasswordInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 16-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 17-Click on link Planning - Navigate to page team project releasesteamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 18-Click on link Dashboard - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 19-Click on div ZeroCount.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 20-Click on div NewFailuresIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 21-Click on div NewFailuresIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 22-Click on link Tests5 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 23-Click on link executions4 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 24-Click on link Planning - Navigate to page team project releasesteamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 25-Click on link Tests2 - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 26-Click on link testSuites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 27-Click on span katalonCloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 28-Click on span treeSwitcher treeSwitcher2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 29-Click on link scriptRepository - Navigate to page team project setupteamprojectsetup.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 30-Click on div createGitRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 32-Click on link tests - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 33-Click on span treeSwitcher TreeSwitcher2.png')

"Step 34: Click on span treeSwitcherIcon (treeSwitcherIcon7)"
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 34-Click on span treeSwitcherIcon treeSwitcherIcon7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 35-Click on link testSuites2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 36-Click on link Reports8 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 37-Click on link Planning - Navigate to page team project releasesteamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 38-Click on link Requirements - Navigate to page team project requirementsteamprojectrequirements.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 39-Click on button dynamicObject object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 40-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 41-Click on button dynamicObject object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 42-Click on div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 43-Click on div Jira Issues.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 44-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 45-Click on div object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 46-Click on link Dashboard - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 47-Click on div ReleaseReadiness.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 48-Click on td NoDataMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 49-Click on div DashboardRefresh.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 50-Click on link Reports9 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 51-Click on link Summary by Test Result - Navigate to page test performance reportteamprojecttest-reportstest-executiontest-performance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 52-Click on link testRuns - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 53-Click on link Run Frequency - Navigate to page report pageteamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 54-Click on link failedTestResults - Navigate to page failed test resultteamprojectfailed-test-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 55-Click on link defects - Navigate to page team projectteamproject.png')

"Step 56: Click on link testingTools (VisualTesting)"
...
WebUI.takeScreenshot(reportLocation + '/TC48/Step 56-Click on link testingTools VisualTesting.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC48-Integrate Jira and Manage Test Execution Settings_visual_checkpoint')
