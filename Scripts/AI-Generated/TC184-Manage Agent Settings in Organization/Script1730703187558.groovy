...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 4-Click on link agentSettings agentSettings - Navigate to page organizationsettingsagentlocal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 5-Click on link agentSettingsOverview - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 6-Click on link kubernetesSettings - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 7-Click on link circleCISettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 8-Click on link localSettings - Navigate to page organizationsettingsagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 9-Click on button navigation - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 10-Click on link projectLinks firstProjectExecution - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 11-Click on link tests - Navigate to page teamprojecttest-designtest-cases.png')

"Step 12: Click on link executions -> Navigate to page 'team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_design_test_cases/link_executions_3'))

WebUI.takeScreenshot(reportLocation + '/TC184/Step 12-Click on link executions - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 13-Click on link tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 14-Click on link executions - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 15-Click on link reports2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 16-Click on link tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 17-Click on link testSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 18-Click on link testObjects - Navigate to page teamprojecttest-designtest-objects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 19-Click on button notification.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 20-Click on div backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 21-Click on link testCases - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 22-Click on button firstProject.png')

"Step 23: Click on div navigationBars (topNavbar)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_navigationBars'))

WebUI.takeScreenshot(reportLocation + '/TC184/Step 23-Click on div navigationBars topNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 24-Click on link settings - Navigate to page teamproject.png')

"Step 25: Click on link navigationLinks (scriptRepositories)"
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 25-Click on link navigationLinks scriptRepositories.png')

"Step 26: Click on link navigationLinks (testEnvironments)"
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 26-Click on link navigationLinks testEnvironments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 27-Click on link agentLocalSettings agentLocalSettings - Navigate to page organizationsettingsagentlocal.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 28-Click on link executionDetails - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 29-Click on link requirements - Navigate to page teamprojecttest-reportstest-designrequirement-test-run-coverage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 30-Click on link testCases - Navigate to page teamprojecttest-reportstest-maintenance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 31-Click on link defects defects - Navigate to page teamproject.png')

"Step 32: Click on link navigationLinks (visualTesting)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_navigationLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_navigationLinks', ['link_navigationLinks_internalRoleLinkName': link_navigationLinks_internalRoleLinkName_2]))

WebUI.takeScreenshot(reportLocation + '/TC184/Step 32-Click on link navigationLinks visualTesting.png')

"Step 33: Click on link navigationLinks (testRuns)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_navigationLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_navigationLinks', ['link_navigationLinks_nthChild': link_navigationLinks_nthChild_2]))

WebUI.takeScreenshot(reportLocation + '/TC184/Step 33-Click on link navigationLinks testRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 34-Click on link tests2 - Navigate to page teamprojecttest-designtest-cases.png')

"Step 35: Click on div navigationBars (dashboard)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/div_navigationBars'))

WebUI.takeScreenshot(reportLocation + '/TC184/Step 35-Click on div navigationBars dashboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 36-Click on link testSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 37-Click on link dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 38-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC184/Step 39-Click on link projectManagement - Navigate to page .png')

"Step 40: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC184-Manage Agent Settings in Organization_visual_checkpoint')
