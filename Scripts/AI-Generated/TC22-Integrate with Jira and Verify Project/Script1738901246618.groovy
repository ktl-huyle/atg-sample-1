...
"Step 22: Click on link testCases (Tests2) -> Navigate to page 'team project details#team/*/project/*/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_testCases"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testCases', ['link_testCases_nthChild': link_testCases_nthChild, 'path_param_6': path_param_6, 'team_id': team_id_1, 'project_id': project_id_1, 'path_param_5': path_param_5]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 22-Click on link testCases Tests2 - Navigate to page team project detailsteamproject.png')
...
"Step 34: Click on span treeSwitcherDetails (TreeSwitcherIcon)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/span_treeSwitcherDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/span_treeSwitcherDetails', ['span_treeSwitcherDetails_divNthChild': span_treeSwitcherDetails_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 34-Click on span treeSwitcherDetails TreeSwitcherIcon.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/link_testingTools', ['link_testingTools_internalRoleLinkName': link_testingTools_internalRoleLinkName, 'team_id': team_id_4, 'project_id': project_id_4, 'path_param_5': path_param_5_3]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Integrate with Jira and Verify Project_visual_checkpoint')
