...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunLinks', ['link_testRunLinks_trNthChild': link_testRunLinks_trNthChild, 'link_testRunLinks_internalRoleLinkName': link_testRunLinks_internalRoleLinkName, 'project_id': project_id, 'team_id': team_id, 'plan_id': plan_id]))
...
"Step 5: Click on link executionLinks (execution10) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionLinks', ['link_executionLinks_internalRoleLinkName': link_executionLinks_internalRoleLinkName, 'project_id': project_id_1, 'executions_id': executions_id, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC42/Step 5-Click on link executionLinks execution10 - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName, 'project_id': project_id_2, 'job_id': job_id, 'team_id': team_id_2, 'plan_id': plan_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC42/Step 6-Click on link executionDetails execution8 - Navigate to page teamprojectgridplanjob.png')
...
"Step 10: Click on div testRunDetails (untitledTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 10-Click on div testRunDetails untitledTestRun.png')
...
"Step 18: Click on link organizationSettings (katalonTesting) -> Navigate to page 'team/*/project/*/test-project/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_project/link_organizationSettings', ['link_organizationSettings_trNthChild': link_organizationSettings_trNthChild, 'link_organizationSettings_internalRoleLinkName': link_organizationSettings_internalRoleLinkName, 'project_id': project_id_3, 'team_id': team_id_3, 'test_project_id': test_project_id]))

WebUI.takeScreenshot(reportLocation + '/TC42/Step 18-Click on link organizationSettings katalonTesting - Navigate to page teamprojecttest-project.png')
...
"Step 22: Click on div testCaseDetails (testCases)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 22-Click on div testCaseDetails testCases.png')
...
"Step 39: Click on div testRunDetails (untitledTestRun2)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 39-Click on div testRunDetails untitledTestRun2.png')

"Step 40: Click on div testRunDetails (untitledTestRun3)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 40-Click on div testRunDetails untitledTestRun3.png')
...
"Step 46: Click on div testRunDetails (untitledTestRun3)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 46-Click on div testRunDetails untitledTestRun3.png')

"Step 47: Click on div testRunDetails (untitledTestRun3)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 47-Click on div testRunDetails untitledTestRun3.png')
...
"Step 59: Click on div testRunDetails (UntitledTestRun6)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 59-Click on div testRunDetails UntitledTestRun6.png')
...
"Step 62: Click on div testRunDetails (UntitledTestRun6)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 62-Click on div testRunDetails UntitledTestRun6.png')
...
"Step 65: Click on div testRunDetails (UntitledTestRun6)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 65-Click on div testRunDetails UntitledTestRun6.png')
...
"Step 72: Click on span listenerActions (LogItem)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 72-Click on span listenerActions LogItem.png')
...
"Step 88: Click on div testRunDetails (EdgeOpenTest)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 88-Click on div testRunDetails EdgeOpenTest.png')
...
"Step 91: Click on div testRunDetails (EdgeOpenTest2)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 91-Click on div testRunDetails EdgeOpenTest2.png')

"Step 92: Click on div edgeOpenTestImage (EdgeOpenTestImage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/div_edgeOpenTestImage'))

WebUI.takeScreenshot(reportLocation + '/TC42/Step 92-Click on div edgeOpenTestImage EdgeOpenTestImage.png')
...
"Step 94: Click on div testRunDetails (EdgeOpenTest2)"
...
WebUI.takeScreenshot(reportLocation + '/TC42/Step 94-Click on div testRunDetails EdgeOpenTest2.png')
...
"Step 99: Click on link executionLinks (TestRunID) -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid/plan/.*/job?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionLinks', ['link_executionLinks_internalRoleLinkName': link_executionLinks_internalRoleLinkName_1, 'project_id': project_id_5, 'executions_id': executions_id_1, 'team_id': team_id_5]))

WebUI.takeScreenshot(reportLocation + '/TC42/Step 99-Click on link executionLinks TestRunID - Navigate to page teamprojectexecutions.png')

"Step 100: Click on link executionDetails (TestRunID) -> Navigate to page 'team/*/project/*/grid/plan/*/job/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_1, 'project_id': project_id_6, 'job_id': job_id_1, 'team_id': team_id_6, 'plan_id': plan_id_3]))

WebUI.takeScreenshot(reportLocation + '/TC42/Step 100-Click on link executionDetails TestRunID - Navigate to page teamprojectgridplanjob.png')

"Step 101: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC42-Review Test Run Details and Schedule Executions_visual_checkpoint')
