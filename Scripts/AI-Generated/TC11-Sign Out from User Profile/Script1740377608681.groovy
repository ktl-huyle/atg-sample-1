...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/button_UserProfile'))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 2-Click on button UserProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 3-Click on link SignOut - Navigate to page user actionlogout.png')

"Step 4: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Sign Out from User Profile_visual_checkpoint')
