...
WebUI.takeScreenshot(reportLocation + '/TC59/Step 4-Click on div infoSidebar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC59/Step 5-Click on button row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC59/Step 6-Click on link planJob - Navigate to page teamprojectgridplanjob.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC59-Access Team Project Grid Plan Job_visual_checkpoint')
