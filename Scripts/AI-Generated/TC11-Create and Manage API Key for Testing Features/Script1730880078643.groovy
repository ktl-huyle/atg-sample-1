...
"Step 2: Create a new API key for accessing testing features."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create and Manage API Key for Testing Features_visual_checkpoint')
