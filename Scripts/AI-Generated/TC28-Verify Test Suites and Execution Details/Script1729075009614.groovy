...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 4-Click on div RecentProjects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 5-Click on link testExecution Test - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 6-Click on td CoordinatorCore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 7-Click on link testSuites testSuites - Navigate to page team project detailsteamproject.png')

"Step 8: Click on link testSuite (CoordinatorCore) -> Navigate to page 'team project executions#team/{*}/project/{*}/executions/{*}'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}/{.*}/{.*}?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuite"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuite', ['link_testSuite_internalRoleRowName': link_testSuite_internalRoleRowName]))

WebUI.takeScreenshot(reportLocation + '/TC28/Step 8-Click on link testSuite CoordinatorCore - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 9-Click on tr PassedCoordinatorCore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 10-Click on td Duration - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC28-Verify Test Suites and Execution Details_visual_checkpoint')
