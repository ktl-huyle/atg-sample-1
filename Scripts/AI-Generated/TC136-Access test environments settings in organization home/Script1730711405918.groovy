...
WebUI.takeScreenshot(reportLocation + '/TC136/Step 4-Click on div organizationLinks FPFirstProject - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC136/Step 5-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC136/Step 6-Click on link Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC136/Step 7-Click on link TestEnvironments - Navigate to page teamprojectagent.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC136-Access test environments settings in organization home_visual_checkpoint')
