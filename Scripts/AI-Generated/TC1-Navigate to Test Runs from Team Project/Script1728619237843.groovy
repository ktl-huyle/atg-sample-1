...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on link projectNavigation TestRuns.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate to Test Runs from Team Project_visual_checkpoint')
