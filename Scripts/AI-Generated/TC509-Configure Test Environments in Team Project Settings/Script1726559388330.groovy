...
WebUI.takeScreenshot(reportLocation + '/TC509/Step 4-Click on div fpFirstProject30m42s - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC509/Step 5-Click on link settings2 - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC509/Step 6-Click on link settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC509/Step 7-Click on link testEnvironments - Navigate to page teamprojectagent.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC509-Configure Test Environments in Team Project Settings_visual_checkpoint')
