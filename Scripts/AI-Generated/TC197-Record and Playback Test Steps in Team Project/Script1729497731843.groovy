...
"Step 4: Click on link testExecutionLinks (Sample Test Case) -> Navigate to page '/team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 4-Click on link testExecutionLinks Sample Test Case - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 5-Click on button AddTestCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 6-Click on button RecordTestSteps - Navigate to page teamprojecttest-designtest-casesedit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 7-Click on span dragSelects DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 8-Click on span dragSelects DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 9-Click on span dragSelects DragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 10-Click on button AddNewTestStep.png')

"Step 11: Click on div objectSelection (ClickOnObject)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases/.*/edit?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases_edit/div_objectSelection'))

WebUI.takeScreenshot(reportLocation + '/TC197/Step 11-Click on div objectSelection ClickOnObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 12-Click on input objectInputs ObjectInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 13-Click on div ObjectInputContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 14-Click on div CaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 15-Click on button Save.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 16-Click on div Unknown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 17-Click on button AddNewTestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 18-Enter input value in input objectInputs AutocompleteInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 19-Click on div objectSelection SelectValueDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 20-Click on input ValueInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 21-Click on input objectInputs DropdownObjectInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 22-Click on div CaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 23-Click on input ValueInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 24-Enter input value in input ValueInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 25-Click on button Save2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 26-Click on input dragSelectCheckboxes Checkbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 27-Click on input dragSelectCheckboxes DragSelectCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 28-Click on input dragSelectCheckboxes DragSelectCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 29-Click on input dragSelectCheckboxes DragSelectCheckbox3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 30-Click on input dragSelectCheckboxes DragSelectCheckbox4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 31-Click on input dragSelectCheckboxes DragSelectCheckbox5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 32-Click on input dragSelectCheckboxes DragSelectCheckbox6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 33-Click on input dragSelectCheckboxes DragSelectCheckbox7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 34-Click on input dragSelectCheckboxes DragSelectCheckbox8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 35-Click on span DeleteSelectedSteps.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 36-Click on div RecordPlayback.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 37-Click on button Playback.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 38-Click on span dragSelects DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 39-Click on span dragSelects DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 40-Click on span dragSelects DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 41-Click on span dragSelects DragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 42-Click on button Edit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 43-Click on input ValueInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 44-Click on input ValueInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 45-Enter input value in input ValueInput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 46-Click on button Save3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC197/Step 47-Click on button Playback - Navigate to page .png')

"Step 48: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC197-Record and Playback Test Steps in Team Project_visual_checkpoint')
