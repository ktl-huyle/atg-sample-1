...
WebUI.takeScreenshot(reportLocation + '/TC368/Step 4-Click on link planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC368/Step 5-Click on link sprint - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC368/Step 6-Click on link testRuns - Navigate to page teamprojectreleasesexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC368/Step 7-Click on link 4077 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC368/Step 8-Click on link testResults - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC368/Step 9-Click on div passedTc10PbbverifyCreateProfileFlowNew.png')
...
WebUI.takeScreenshot(reportLocation + '/TC368/Step 11-Click on link planning - Navigate to page teamprojectreleases.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC368-Navigate Planning and Verify Releases in Team Project_visual_checkpoint')
