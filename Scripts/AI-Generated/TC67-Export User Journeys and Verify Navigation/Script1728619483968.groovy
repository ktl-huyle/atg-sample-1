...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 4-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 5-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 6-Click on link Execution - Navigate to page organizationsettingstruetest.png')

"Step 7: Click on link projectNavigation (LLA Digital Jamaica) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 7-Click on link projectNavigation LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 8-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 9-Click on div UserJourneyVisualization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 10-Click on input Checkbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 11-Click on button navigation ExpandGraph.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 12-Click on button ExportAllFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 13-Click on link DownloadCSV.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 14-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 15-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 16-Click on link Execution - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 17-Click on div QA JamaicaFlow.png')

"Step 18: Click on div gridCell (GridCell)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/settings/truetest/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_settings_truetest/div_gridCell'))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 18-Click on div gridCell GridCell.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 19-Click on p InstallTrueTest.png')

"Step 20: Click on link projectNavigation (LLA Digital Jamaica) -> Navigate to page 'team/*/project/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/settings/truetest/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_organization_settings_truetest/link_projectNavigation"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_settings_truetest/link_projectNavigation', ['link_projectNavigation_internalRoleLinkName': link_projectNavigation_internalRoleLinkName_1, 'link_projectNavigation_project_id': link_projectNavigation_project_id_1, 'link_projectNavigation_team_id': link_projectNavigation_team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 20-Click on link projectNavigation LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 21-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeys.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 22-Click on button viewDetails ViewDetails - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 23-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 24-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 25-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 26-Enter input value in input SearchFlows.png')

"Step 27: Click on p userJourney (VerifyNavigationHome)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/p_userJourney', ['p_userJourney_class': p_userJourney_class]))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 27-Click on p userJourney VerifyNavigationHome.png')

"Step 28: Click on button navigation (GoToNextPage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/truetest/user-journeys/.*/aut/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_navigation'))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 28-Click on button navigation GoToNextPage.png')

"Step 29: Click on p userJourney (VerifyInternetBundles)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/truetest/user-journeys/.*/aut/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/p_userJourney"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/p_userJourney', ['p_userJourney_class': p_userJourney_class_1]))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 29-Click on p userJourney VerifyInternetBundles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 30-Click on button dynamicObject NavigateInteract.png')

"Step 31: Click on button navigation (GoToNextPage2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/truetest/user-journeys/.*/aut/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_navigation'))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 31-Click on button navigation GoToNextPage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 32-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 33-Enter input value in input SearchFlows.png')

"Step 34: Click on p userJourney (NavigateInteract)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/truetest/user-journeys/.*/aut/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/p_userJourney"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/p_userJourney', ['p_userJourney_class': p_userJourney_class_2]))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 34-Click on p userJourney NavigateInteract.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 35-Click on button dynamicObject ShowDetailFlowPanel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 36-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 37-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 38-Click on button dynamicObject ShowDetailFlowPanel2 - Navigate to page .png')

"Step 39: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC67-Export User Journeys and Verify Navigation_visual_checkpoint')
