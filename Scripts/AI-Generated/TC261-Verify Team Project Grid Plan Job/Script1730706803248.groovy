...
WebUI.takeScreenshot(reportLocation + '/TC261/Step 4-Click on div InfoSidebar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC261/Step 5-Click on button PerfTestButton.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunLinks', ['link_testRunLinks_trNthChild': link_testRunLinks_trNthChild, 'link_testRunLinks_internalRoleLinkName': link_testRunLinks_internalRoleLinkName, 'link_testRunLinks_team_id': link_testRunLinks_team_id, 'link_testRunLinks_project_id': link_testRunLinks_project_id, 'link_testRunLinks_plan_id': link_testRunLinks_plan_id]))

WebUI.takeScreenshot(reportLocation + '/TC261/Step 6-Click on link testRunLinks PerfTestAPIs01User - Navigate to page teamprojectgridplanjob.png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC261-Verify Team Project Grid Plan Job_visual_checkpoint')
