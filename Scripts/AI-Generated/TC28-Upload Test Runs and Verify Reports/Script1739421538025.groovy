...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 2-Click on div TestRunsUpload.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 3-Click on link RunFrequency - Navigate to page reportteamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 4-Click on button DateLabel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 5-Click on link Dashboard - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 6-Click on link Reports4 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 7-Click on link RunFrequency - Navigate to page reportteamprojecttest-reportstest-executionfrequency-report.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC28-Upload Test Runs and Verify Reports_visual_checkpoint')
