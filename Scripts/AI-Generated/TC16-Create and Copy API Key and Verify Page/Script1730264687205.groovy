...
"Step 6: Create an API key with specified name and options"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Create and Copy API Key and Verify Page_visual_checkpoint')
