...
"Step 61: Click on header testRunHeading (TestRunHeading)"
...
"Step 62: Click on header testRunHeading (TestRunHeading)"
...
"Step 85: Click on header testRunHeading (TestRunHeading2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/header_testRunHeading_1'))
...
"Step 87: Click on button alertClose (Close3)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Verify Marking Test Results as Passed_visual_checkpoint')
