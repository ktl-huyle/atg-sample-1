...
"Step 5: Click on link 1538 -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/link_1538'))

WebUI.takeScreenshot()

"Step 6: Click on span error"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_error'))

WebUI.takeScreenshot()

"Step 7: Click on div sidebarLayout"
...
"Step 8: Click on button failedMv013NormalOrder -> Navigate to page 'team/*/project/*/executions/*/test-result/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Test Results from Reports_visual_checkpoint')
