...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_DailyPast7Days'))

WebUI.takeScreenshot()

"Step 3: Click on div TestRunStatus"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Review Daily Test Run Status and Navigate to User Management_visual_checkpoint')
