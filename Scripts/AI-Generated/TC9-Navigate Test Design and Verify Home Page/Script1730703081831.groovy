...
"Step 7: Click on span testCasesLabel (TreeSwitcher)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_testCasesLabel'))
...
"Step 9: Click on span testCasesLabel (TestCasesLabel)"
...
"Step 33: Click on div testSuiteValidation (TestSuiteValidation)"
...
"Step 34: Click on div testSuiteValidation (TestSuiteValidation2)"
