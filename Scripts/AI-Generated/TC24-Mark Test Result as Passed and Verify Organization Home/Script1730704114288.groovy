...
viewAndUpdateTestResultStatus.execute(data_path_0, Integer.valueOf(index_0))
...
viewAndUpdateTestResultStatus.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Mark Test Result as Passed and Verify Organization Home_visual_checkpoint')
