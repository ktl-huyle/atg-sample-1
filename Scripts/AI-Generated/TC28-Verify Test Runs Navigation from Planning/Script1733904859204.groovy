...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 4-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 5-Click on link SPRINT - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 6-Click on link TestRuns - Navigate to page teamprojectreleasesexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 7-Click on link 4077 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 8-Click on link TestResults2 - Navigate to page teamprojectexecutionstest-runs.png')

"Step 9: Click on div PassedTC10"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions_test_runs/div_PassedTC10'))

WebUI.takeScreenshot(reportLocation + '/TC28/Step 9-Click on div PassedTC10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 10-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 11-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 12-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 13-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 14-Click on div ThumbnailImage3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 15-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC28/Step 16-Click on link Planning - Navigate to page teamprojectreleases.png')

"Step 17: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC28-Verify Test Runs Navigation from Planning_visual_checkpoint')
