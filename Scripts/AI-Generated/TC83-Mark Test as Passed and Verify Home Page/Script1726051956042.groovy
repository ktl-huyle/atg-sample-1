...
"Step 5: Click on div testRunsRequirementsTestNth2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_testRunsRequirementsTestNth2'))

WebUI.takeScreenshot()

"Step 6: Click on button insightlyAutomation"
...
"Step 7: Click on div testRunsRequirementsTestNth2 -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC83-Mark Test as Passed and Verify Home Page_visual_checkpoint')
