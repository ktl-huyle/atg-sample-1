...
"Step 6: Click on button teamMembers (albertoBeba)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC40-Logout and Verify Home Page from Team Project Test Runs_visual_checkpoint')
