...
"Step 7: Click on div menuBackdrops (PopoverBackdrop)"
...
"Step 11: Click on div menuBackdrops (PopoverBackdrop)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/div_menuBackdrops"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/div_menuBackdrops', ['div_menuBackdrops_class': div_menuBackdrops_class_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Schedule and Configure Test Runs with Verification_visual_checkpoint')
