...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 2-Click on link History - Navigate to page team project detailteamproject.png')

"Step 3: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC34-Review History in Team Project Detail_visual_checkpoint')
