...
"Step 2: Click on pre errorMessages (ErrorMessage)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 2-Click on pre errorMessages ErrorMessage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-View Resource Center and Verify Home Page_visual_checkpoint')
