...
"Step 4: Click on span logItemContentMuiListSubheaderRootSpan2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions_test_result/span_logItemContentMuiListSubheaderRootSpan2'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC38-View Failed Test Results and Return Home_visual_checkpoint')
