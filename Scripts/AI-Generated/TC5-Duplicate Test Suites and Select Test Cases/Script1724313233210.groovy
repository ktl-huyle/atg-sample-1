import katalon.common.duplicateAndSelectTestCases
...
"Step 6: Select and duplicate existing test suites in the application"

duplicateTestSuites.execute()

"Step 7: Duplicate test suites and select specific test cases"

duplicateAndSelectTestCases.execute()
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Duplicate Test Suites and Select Test Cases_visual_checkpoint')
