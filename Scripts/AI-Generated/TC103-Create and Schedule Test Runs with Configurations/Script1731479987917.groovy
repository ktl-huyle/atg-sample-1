...
"Step 2: Navigate to team project settings and schedule a test run"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC103-Create and Schedule Test Runs with Configurations_visual_checkpoint')
