...
"Step 5: Click on link myOrganization (MyOrganization) -> Navigate to page 'organization/*/home'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/web-services?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_web_services/link_myOrganization"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_web_services/link_myOrganization', ['organization_id': organization_id]))

WebUI.takeScreenshot(reportLocation + '/TC67/Step 5-Click on link myOrganization MyOrganization - Navigate to page organizationhome.png')
...
"Step 14: Click on div integrationIcons (ChevronRightIcon)"
...
WebUI.takeScreenshot(reportLocation + '/TC67/Step 14-Click on div integrationIcons ChevronRightIcon.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC67-Enable BDD Reports and Integrate Testing Tools_visual_checkpoint')
