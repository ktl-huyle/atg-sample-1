import katalon.common.viewTeamProjectExecutionFiles
...
"Step 4: View and filter execution files for team projects."

viewTeamProjectExecutionFiles.execute(data_path_0, Integer.valueOf(index_0))

"Step 5: View and filter execution files for team projects."

viewTeamProjectExecutionFiles.execute(data_path_1, Integer.valueOf(index_1))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC46-View and Filter Execution Files in SauceDemo_visual_checkpoint')
