...
"Step 9: Click on span testCaseSwitcher (TestCasesLabel)"
...
"Step 30: Click on span iconSwitcher (TreeSwitcherIcon)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-suites?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/span_iconSwitcher"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/span_iconSwitcher', ['span_iconSwitcher_class': span_iconSwitcher_class]))

WebUI.takeScreenshot()

"Step 31: Click on span iconSwitcher (Icon)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-suites?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/span_iconSwitcher"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/span_iconSwitcher', ['span_iconSwitcher_class': span_iconSwitcher_class_1]))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['link_testSuiteActions_team_id': link_testSuiteActions_team_id_1, 'link_testSuiteActions_project_id': link_testSuiteActions_project_id_1, 'link_testSuiteActions_executions_id': link_testSuiteActions_executions_id]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Navigate Through Test Cases and Suites to Verify Home Page_visual_checkpoint')
