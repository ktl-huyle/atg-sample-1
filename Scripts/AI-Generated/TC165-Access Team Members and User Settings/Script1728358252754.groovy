...
"Step 4: Click on div teamMembers (QualityEngineer2) -> Navigate to page 'team/*/project/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 4-Click on div teamMembers QualityEngineer2 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 5-Click on div UserflowModalBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 6-Click on button dynamicObject PO.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 7-Click on link UserSettings - Navigate to page usersettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 8-Click on button dynamicObject PO.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 9-Click on link ViewProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 10-Click on div Backdrop - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC165-Access Team Members and User Settings_visual_checkpoint')
