...
import truetest.common.updateTestResultStatus
...
"Step 2: View and update the status of test result details"

updateTestResultStatus.execute()
...
"Step 16: View and update the status of test result details"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Manage Test Result Statuses and Verify Organization Home_visual_checkpoint')
