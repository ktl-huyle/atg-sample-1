...
"Step 6: Click on div TestSuiteCell"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_TestSuiteCell'))
...
"Step 8: Click on link ExecutionLink -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Sort and Verify Team Project Executions_visual_checkpoint')
