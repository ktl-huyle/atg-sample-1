...
"Step 4: Click on div testDetails (Web)"
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 4-Click on div testDetails Web.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 5-Click on button uploadedData UploadedData - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 6-Click on span treeSwitchers Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 7-Click on span treeSwitchers TreeSwitcher7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 8-Click on span treeSwitchers TreeSwitcher8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 9-Click on span treeSwitchers TreeSwitcher9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 10-Click on span treeSwitchers TreeSwitcher10.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers', ['span_treeSwitchers_class': span_treeSwitchers_class_4]))

WebUI.takeScreenshot(reportLocation + '/TC170/Step 11-Click on span treeSwitchers TreeSwitcher11.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_1', ['span_treeSwitchers_nthChild': span_treeSwitchers_nthChild_4, 'span_treeSwitchers_class': span_treeSwitchers_class_5, 'span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild_4]))

WebUI.takeScreenshot(reportLocation + '/TC170/Step 12-Click on span treeSwitchers TreeSwitcher12.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_1', ['span_treeSwitchers_nthChild': span_treeSwitchers_nthChild_5, 'span_treeSwitchers_class': span_treeSwitchers_class_6, 'span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild_5]))

WebUI.takeScreenshot(reportLocation + '/TC170/Step 13-Click on span treeSwitchers TreeSwitcher13.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_2"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_2', ['span_treeSwitchers_nthChild': span_treeSwitchers_nthChild_6, 'span_treeSwitchers_class': span_treeSwitchers_class_7, 'span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild_6]))

WebUI.takeScreenshot(reportLocation + '/TC170/Step 14-Click on span treeSwitchers TreeSwitcher14.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_1', ['span_treeSwitchers_nthChild': span_treeSwitchers_nthChild_7, 'span_treeSwitchers_class': span_treeSwitchers_class_8, 'span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild_7]))

WebUI.takeScreenshot(reportLocation + '/TC170/Step 15-Click on span treeSwitchers TreeSwitcher15.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 16-Click on div Sanity - Navigate to page teamprojecttest-designtest-cases.png')

"Step 17: Click on div testDetails (Sanity2) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 17-Click on div testDetails Sanity2 - Navigate to page .png')

"Step 18: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC170-Verify Test Details and Home Page Navigation_visual_checkpoint')
