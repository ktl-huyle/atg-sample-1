...
"Step 2: Create a new API key for integration with external services."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Generate API Key for User Integration_visual_checkpoint')
