...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 4-Click on button AI.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 5-Click on link ViewProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 6-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 7-Click on div TopNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 8-Click on button organizationAdmin OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 9-Click on button organizationAdmin OrganizationAdmin2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 10-Click on div TopLeftNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 11-Click on button organizationAdmin OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 12-Click on link OrganizationAdminIbpaas.png')
...
WebUI.takeScreenshot(reportLocation + '/TC144/Step 13-Click on link ViewAllProjects - Navigate to page .png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC144-Verify Organization Admin Access and Navigation_visual_checkpoint')
