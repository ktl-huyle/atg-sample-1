...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 5-Click on button apiKeyActions CellButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 6-Click on button ShowApiKey.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 7-Click on input userInputs TextInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 8-Click on input userInputs PasswordInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 9-Click on button copyActions CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 10-Click on button NidhiKachhadiya.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 11-Click on link SignOut - Navigate to page organizationhome.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC140-Create and manage API keys in user account_visual_checkpoint')
