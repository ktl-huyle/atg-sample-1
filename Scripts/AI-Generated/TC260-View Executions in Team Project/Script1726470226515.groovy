...
"Step 4: Click on pre dynamicObject (failedE2Ecglflow)"
...
WebUI.takeScreenshot(reportLocation + '/TC260/Step 4-Click on pre dynamicObject failedE2Ecglflow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC260/Step 5-Click on div thumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC260/Step 6-Click on button close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC260/Step 7-Click on div thumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC260/Step 8-Click on button close - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC260-View Executions in Team Project_visual_checkpoint')
