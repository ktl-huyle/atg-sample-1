...
"Step 25: Click on link testResources (scriptRepositories)"
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 25-Click on link testResources scriptRepositories.png')

"Step 26: Click on link testResources (testEnvironments)"
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 26-Click on link testResources testEnvironments.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_agentSettings', ['organization_id': organization_id_1, 'local_id': local_id_1]))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_reports_test_maintenance/link_defects', ['link_defects_internalRoleLinkName': link_defects_internalRoleLinkName, 'path_param_5': path_param_5, 'project_id': project_id_1, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC19/Step 31-Click on link defects defects - Navigate to page teamproject.png')

"Step 32: Click on link testResources (visualTesting)"
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 32-Click on link testResources visualTesting.png')

"Step 33: Click on link testResources (testRuns)"
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 33-Click on link testResources testRuns.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Verify Agent Settings and Project Execution Details_visual_checkpoint')
