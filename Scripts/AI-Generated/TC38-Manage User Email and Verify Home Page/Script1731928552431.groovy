...
"Step 9: Click on link viewAllProjects (viewAllProjects)"
...
"Step 12: Click on span dynamicObject (object3)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_settings/div_dynamicObject'))
...
"Step 25: Click on div dynamicObject (object5) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/settings?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_settings/div_dynamicObject_1'))

WebUI.takeScreenshot()

"Step 26: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC38-Manage User Email and Verify Home Page_visual_checkpoint')
