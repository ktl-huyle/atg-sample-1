...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 5-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 6-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 7-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 8-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 9-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 10-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 11-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 12-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 13-Click on button Submit - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 14-Click on button testResultDetails TestResultDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 15-Click on button testResultDetails TestResultDetails2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 16-Click on button testResultDetails TestResultDetails3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 17-Click on button testResultDetails TestResultDetails4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 19-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 20-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 21-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 22-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 23-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 24-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 25-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 26-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 27-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 28-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 29-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 30-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 31-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 32-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 33-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 34-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 35-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 36-Click on button Submit - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 37-Click on button testResultDetails TestResultDetails5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 38-Click on button testResultDetails TestResultDetails6.png')

"Step 39: Click on button automationActions (InsightlyAutomation)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/button_automationActions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/button_automationActions', ['button_automationActions_internalRoleButtonName': button_automationActions_internalRoleButtonName]))

WebUI.takeScreenshot(reportLocation + '/TC159/Step 39-Click on button automationActions InsightlyAutomation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 40-Click on link Insightly - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 41-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 42-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 43-Click on button Submit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 44-Click on button MarkAsPassed.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 45-Click on label ChangeTestResultStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 46-Click on button Submit - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC159/Step 47-Click on link executionDetails ExecutionDetails1879IE56Failed.png')

"Step 48: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC159-Mark Failed Test Results as Passed After Review_visual_checkpoint')
