import katalon.common.markTestExecutionAsPassed
...
"Step 2: Mark the external link test execution as passed based on results."

markTestExecutionAsPassed.execute()
...
"Step 16: Mark the external link test execution as passed based on results."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Mark External Link Test Execution as Passed_visual_checkpoint')
