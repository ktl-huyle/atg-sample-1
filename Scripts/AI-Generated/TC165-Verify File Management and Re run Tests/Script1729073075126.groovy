...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 4-Click on link Files - Navigate to page file managementteamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 5-Click on link fileManagement MaintenanceFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC165/Step 6-Click on button ReRun - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC165-Verify File Management and Re run Tests_visual_checkpoint')
