...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 4-Click on link executionDetails ExecutionDetails - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 5-Click on div LoadingSpinner.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 6-Click on div LoadingSpinner.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 7-Click on link TestRuns3 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 8-Click on link TestRuns4 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 9-Click on label failedExecutions FailedExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 10-Click on label failedExecutions FailedExecution2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 11-Click on label failedExecutions FailedExecution3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 12-Click on button Delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 14-Click on link TestRuns4 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 15-Click on link TestRuns4 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC294/Step 16-Click on button DeleteExecution.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC294-Delete Failed Test Execution Records_visual_checkpoint')
