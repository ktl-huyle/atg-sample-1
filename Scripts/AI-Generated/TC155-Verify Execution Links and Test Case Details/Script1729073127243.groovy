...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 4-Click on div sortingInfo sortingInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 5-Click on span started.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 6-Click on div sortingInfo sortingInfo2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 7-Click on div cardBody.png')

"Step 8: Click on div testRunIssues (cellSP3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/executions?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_testRunIssues'))

WebUI.takeScreenshot(reportLocation + '/TC155/Step 8-Click on div testRunIssues cellSP3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 9-Click on td loading.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 10-Click on link executionLinks Executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 11-Click on div testCase.png')

"Step 12: Click on link executionLinks (Executions) -> Navigate to page 'team project executions#team/{*}/project/{*}/executions/{*}'"
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 12-Click on link executionLinks Executions - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 13-Click on div failedTestResults.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 14-Click on td testCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 15-Click on div testCaseDetails - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 16-Click on div allTestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 17-Click on div allTestRuns.png')
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 18-Click on link executionLinks Executions.png')

"Step 19: Click on link executionLinks (Executions) -> Navigate to page 'team project executions#team/{*}/project/{*}/executions/{*}'"
...
WebUI.takeScreenshot(reportLocation + '/TC155/Step 19-Click on link executionLinks Executions - Navigate to page team project executionsteamprojectexecutions.png')

"Step 20: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC155-Verify Execution Links and Test Case Details_visual_checkpoint')
