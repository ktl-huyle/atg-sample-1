...
WebUI.takeScreenshot(reportLocation + '/TC431/Step 4-Click on button runRelease LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC431/Step 5-Click on span R5Maintenance.png')

"Step 6: Click on button runRelease (Run) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC431/Step 6-Click on button runRelease Run - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC431-Run Release in Project Grid Plan Job_visual_checkpoint')
