...
"Step 4: Click on link forumAndProjectExecution (ForumPosting3) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on link forumAndProjectExecution ForumPosting3 - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_tests', ['project_id': project_id_1, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on link tests Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['link_testSuiteActions_internalRoleLinkName': link_testSuiteActions_internalRoleLinkName, 'test_suites_id': test_suites_id, 'project_id': project_id_2, 'team_id': team_id_2]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Test Design Test Suites Overview_visual_checkpoint')
