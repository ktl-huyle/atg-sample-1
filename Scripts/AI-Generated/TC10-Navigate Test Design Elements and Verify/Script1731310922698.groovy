...
"Step 7: Click on span testCaseElements (TreeSwitcher)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_testCaseElements'))
...
"Step 9: Click on span testCaseElements (KatalonStudioTestCases)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Navigate Test Design Elements and Verify_visual_checkpoint')
