...
"Step 7: Click on div testRunCells (UntitledTestRun3)"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 7-Click on div testRunCells UntitledTestRun3.png')
...
"Step 10: Click on div testRunCells (UntitledTestRun4)"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 10-Click on div testRunCells UntitledTestRun4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 31-Click on button sessionActions Sessions.png')
...
"Step 33: Click on div historyInfo (HistoryInfo)"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 33-Click on div historyInfo HistoryInfo.png')
...
"Step 35: Click on div testRunDetails (UntitledTestRun5)"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 35-Click on div testRunDetails UntitledTestRun5.png')
...
"Step 38: Click on link reportFiles (FileReport)"
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 38-Click on link reportFiles FileReport.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 42-Click on link pageLinks Page2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 43-Click on link pageLinks Page3.png')

"Step 44: Click on link reportFiles (HTMLReport) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/files?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions_files/link_reportFiles"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_files/link_reportFiles', ['link_reportFiles_trNthChild': link_reportFiles_trNthChild_1, 'link_reportFiles_internalRoleLinkName': link_reportFiles_internalRoleLinkName_1]))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 44-Click on link reportFiles HTMLReport - Navigate to page .png')

"Step 45: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC21-Verify Test Runs and Reports Access_visual_checkpoint')
