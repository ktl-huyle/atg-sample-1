...
import truetest.common.saveUserEmailAndScheduleEnvironments
...
"Step 6: Save user email and schedule environments"

saveUserEmailAndScheduleEnvironments.execute()

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC96-Save User Email in Job Scheduling_visual_checkpoint')
