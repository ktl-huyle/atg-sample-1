...
"Step 6: Click on div failedTests (failedTests4)"
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 6-Click on div failedTests failedTests4.png')
...
"Step 9: Click on span failedItems (failedItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 9-Click on span failedItems failedItems2.png')
...
"Step 14: Click on image filePreviews (filePreviews)"
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 14-Click on image filePreviews filePreviews.png')
...
"Step 16: Click on div failedItems (failedItems)"
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 16-Click on div failedItems failedItems.png')

"Step 17: Click on div failedTests (failedTests5)"
...
WebUI.takeScreenshot(reportLocation + '/TC22/Step 17-Click on div failedTests failedTests5.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Review Failed Tests and Verify Home Page_visual_checkpoint')
