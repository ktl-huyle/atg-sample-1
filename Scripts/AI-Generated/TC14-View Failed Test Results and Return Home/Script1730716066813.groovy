...
"Step 2: Click on span FailedSortFilter"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_FailedSortFilter'))

WebUI.takeScreenshot()

"Step 3: Click on span FailedSortFilter"
...
"Step 5: Click on button testResultDetails (ExternalLink)"
...
"Step 9: Click on span logItemComponents (SketchToolImage) -> Navigate to page ''"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result/span_logItemComponents', ['span_logItemComponents_nthChild': span_logItemComponents_nthChild, 'span_logItemComponents_internalHasText': span_logItemComponents_internalHasText]))

WebUI.takeScreenshot()

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-View Failed Test Results and Return Home_visual_checkpoint')
