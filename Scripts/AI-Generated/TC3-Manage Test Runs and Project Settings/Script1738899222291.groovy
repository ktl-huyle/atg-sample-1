...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Click on div testRunCells ParallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on div testRunCells ParallelSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on div testRunCells ParallelSuite3.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Manage Test Runs and Project Settings_visual_checkpoint')
