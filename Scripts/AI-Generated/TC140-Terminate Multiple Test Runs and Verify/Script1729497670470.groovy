...
"Step 4: Click on input rowSelection (SelectRowCheckbox)"
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 4-Click on input rowSelection SelectRowCheckbox.png')

"Step 5: Click on input rowSelection (SelectRowCheckbox2)"
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 5-Click on input rowSelection SelectRowCheckbox2.png')

"Step 6: Click on button Terminate2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/button_Terminate2'))

WebUI.takeScreenshot(reportLocation + '/TC140/Step 6-Click on button Terminate2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 7-Click on button Confirm.png')

"Step 8: Click on input rowSelection (SelectRowCheckbox3)"
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 8-Click on input rowSelection SelectRowCheckbox3.png')

"Step 9: Click on input rowSelection (SelectRowCheckbox4)"
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 9-Click on input rowSelection SelectRowCheckbox4.png')

"Step 10: Click on input rowSelection (SelectRowCheckbox5)"
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 10-Click on input rowSelection SelectRowCheckbox5.png')

"Step 11: Click on button Terminate3"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/button_Terminate3'))

WebUI.takeScreenshot(reportLocation + '/TC140/Step 11-Click on button Terminate3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 12-Click on button Confirm.png')

"Step 13: Click on input rowSelection (SelectRowCheckbox6)"
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 13-Click on input rowSelection SelectRowCheckbox6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 14-Click on button Terminate2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC140/Step 15-Click on button Confirm - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC140-Terminate Multiple Test Runs and Verify_visual_checkpoint')
