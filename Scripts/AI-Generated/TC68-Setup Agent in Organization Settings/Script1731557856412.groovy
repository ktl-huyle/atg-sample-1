...
"Step 4: Click on link organizationSettingsAgent (organizationSettingsAgentLocal2) -> Navigate to page 'organization/*/settings/agent/local/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC68-Setup Agent in Organization Settings_visual_checkpoint')
