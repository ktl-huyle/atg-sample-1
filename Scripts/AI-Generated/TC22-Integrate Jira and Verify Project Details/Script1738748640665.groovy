...
"Step 34: Click on span testCaseObjects (TreeSwitcherIcon)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/span_testCaseObjects"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/span_testCaseObjects', ['span_testCaseObjects_divNthChild': span_testCaseObjects_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 34-Click on span testCaseObjects TreeSwitcherIcon.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/link_visualTesting', ['link_visualTesting_internalRoleLinkName': link_visualTesting_internalRoleLinkName, 'team_id': team_id_4, 'project_id': project_id_4, 'path_param_5': path_param_5_3]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Integrate Jira and Verify Project Details_visual_checkpoint')
