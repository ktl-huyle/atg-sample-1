...
"Step 5: Click on item scheduleTestRunCreated"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/item_scheduleTestRunCreated'))

WebUI.takeScreenshot()

"Step 6: Click on input radioButtons"
...
"Step 7: Click on div object -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Schedule Test Run and Verify Execution in Team Project_visual_checkpoint')
