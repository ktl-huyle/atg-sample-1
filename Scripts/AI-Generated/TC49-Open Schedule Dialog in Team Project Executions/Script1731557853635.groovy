...
"Step 2: Click on link dynamicObject (fpFirstProjectTestCases61m18sExecutionTim) -> Navigate to page 'team/*/project/*'"
...
"Step 3: Click on link executions4 -> Navigate to page 'team/*/project/*/test-runs'"
...
"Step 4: Click on button openScheduleDialog"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/span_object2'))

WebUI.takeScreenshot()

"Step 9: Click on div object15"
...
"Step 22: Click on button closeConfigureTsDialog"
...
"Step 28: Click on div object25"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_object25'))

WebUI.takeScreenshot()

"Step 29: Click on div object22"
...
"Step 31: Click on button closeConfigureTsDialog"
...
"Step 32: Click on button closeDialogButton -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC49-Open Schedule Dialog in Team Project Executions_visual_checkpoint')
