...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 4-Click on div dailyPast7DaysRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 5-Click on div testRunByStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 6-Click on span settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 7-Click on link userManagementAddAndRemoveUsers - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC34-Manage User Management in Test Executions_visual_checkpoint')
