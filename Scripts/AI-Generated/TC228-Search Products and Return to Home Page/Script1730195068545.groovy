...
WebUI.takeScreenshot(reportLocation + '/TC228/Step 4-Click on input SearchTerm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC228/Step 5-Click on input SearchTerm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC228/Step 6-Enter input value in input SearchTerm - Navigate to page SearchDisplay.png')

"Step 7: Click on link productItems (PaconPosterBoard) -> Navigate to page '/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC228/Step 7-Click on link productItems PaconPosterBoard - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC228-Search Products and Return to Home Page_visual_checkpoint')
