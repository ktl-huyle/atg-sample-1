...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 4-Click on link executions - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 5-Click on div testRunDetails parallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 6-Click on div testRunDetails parallelSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 7-Click on div testRunDetails parallelSuite3.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/div_testRunDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_testRunDetails', ['div_testRunDetails_internalRoleCellName': div_testRunDetails_internalRoleCellName_3]))

WebUI.takeScreenshot(reportLocation + '/TC38/Step 8-Click on div testRunDetails parallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 9-Click on button jobReady.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 10-Click on div myOrganization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 11-Click on link viewAllProjects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 12-Click on div currentReadyTechJob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 13-Click on link jrJobReady - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 14-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 15-Click on link organizationManagement - Navigate to page team project settingsteamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 16-Click on p ReadyCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 17-Click on input UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 18-Enter input value in input UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 19-Click on div ProjectProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 20-Click on input Timezone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 21-Click on div EnableBDDReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 22-Click on div InputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 23-Click on span Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 24-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 25-Click on div InputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 26-Enter input value in input UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC38/Step 27-Click on div TeamProfile - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC38-Manage Test Run Details and Organization Settings_visual_checkpoint')
