...
WebUI.takeScreenshot(reportLocation + '/TC390/Step 4-Click on link ProjectLink - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC390/Step 5-Click on pre logDetails LogOutput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC390/Step 6-Click on pre logDetails LogOutput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC390/Step 7-Click on pre logDetails LogOutput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC390/Step 8-Click on pre logDetails LogOutput - Navigate to page teamprojectgridplanjob.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC390-View Project Link Details in Team Project Grid_visual_checkpoint')
