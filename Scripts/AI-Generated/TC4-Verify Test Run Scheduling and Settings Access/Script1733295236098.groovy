...
"Step 4: Click on div testRunItems (APIMediaFiles)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on div testRunItems APIMediaFiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on div sortOptions SortIDDescending.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on button Details.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on div SelectEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 9-Click on div AdvancedSettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 10-Click on div ScheduleAt.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 11-Click on div ExecutionProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 12-Click on div Default.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 13-Click on div TestSuitesTS10Product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 14-Click on div TestSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 15-Click on link Refresh.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 16-Click on div SelectTestSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 17-Click on button CloseDialog.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 18-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 19-Click on link ScriptRepositories - Navigate to page teamprojecttest-project.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_project/link_testProjects', ['link_testProjects_trNthChild': link_testProjects_trNthChild, 'link_testProjects_internalRoleLinkName': link_testProjects_internalRoleLinkName, 'project_id': project_id, 'test_project_id': test_project_id, 'team_id': team_id]))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 20-Click on link testProjects TestProject - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 21-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 22-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 23-Click on link Executions2 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 24-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 25-Click on link ScriptRepositories - Navigate to page teamprojecttest-project.png')

"Step 26: Click on td TestProject"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_project/td_TestProject'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 26-Click on td TestProject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 27-Click on link testProjects TestProject - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 28-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 29-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 30-Click on button RefreshScriptRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 31-Click on link Dashboard - Navigate to page teamproject.png')

"Step 32: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Verify Test Run Scheduling and Settings Access_visual_checkpoint')
