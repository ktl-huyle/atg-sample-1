...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 28-Click on span treeSwitcher TreeSwitcher.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 33-Click on span treeSwitcher object.png')

"Step 34: Click on span dynamicObject (TreeSwitcherIcon)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/span_dynamicObject', ['span_dynamicObject_divNthChild': span_dynamicObject_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 34-Click on span dynamicObject TreeSwitcherIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 39-Click on button closeAlerts Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 41-Click on button closeAlerts AlertClose.png')
...
"Step 56: Click on link dynamicObject (VisualTesting) -> Navigate to page 'team project#team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/link_dynamicObject"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/link_dynamicObject', ['link_dynamicObject_internalRoleLinkName': link_dynamicObject_internalRoleLinkName, 'path_param_5': path_param_5_3, 'project_id': project_id_4, 'team_id': team_id_4]))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 56-Click on link dynamicObject VisualTesting - Navigate to page team projectteamproject.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC23-Integrate Jira and Verify Team Project_visual_checkpoint')
