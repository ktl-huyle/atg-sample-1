...
WebUI.takeScreenshot(reportLocation + '/TC17/Step 30-Click on div object.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC17-Verify test environment configuration and execution_visual_checkpoint')
