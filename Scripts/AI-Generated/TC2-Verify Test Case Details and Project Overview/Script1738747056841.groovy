...
"Step 2: Click on link testCaseDetails (ExecutionOverview) -> Navigate to page 'team project executions#team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC2/Step 2-Click on link testCaseDetails ExecutionOverview - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Test Case Details and Project Overview_visual_checkpoint')
