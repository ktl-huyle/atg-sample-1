...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Click on div testRunDetails ParallelSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on div testRunDetails ParallelSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on div testRunDetails ParallelSuite3.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Manage Test Run Details and Settings in Team Project_visual_checkpoint')
