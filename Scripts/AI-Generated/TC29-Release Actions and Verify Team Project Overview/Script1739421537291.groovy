...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 2-Click on button releaseActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 3-Click on span ProjectVersion.png')

"Step 4: Click on button releaseActions (Run)"
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 4-Click on button releaseActions Run.png')
...
WebUI.takeScreenshot(reportLocation + '/TC29/Step 5-Click on link Reports - Navigate to page team project overviewteamprojectoverview.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC29-Release Actions and Verify Team Project Overview_visual_checkpoint')
