...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 2-Click on button ai.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 3-Click on link viewProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 4-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 5-Click on div topNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 6-Click on button organizationAdmin organizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 7-Click on button organizationAdmin organizationAdmin2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 8-Click on div TopLeftNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 9-Click on button organizationAdmin organizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 10-Click on link organizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 11-Click on link viewAllProjects - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC36-View Profile and Verify Home Page_visual_checkpoint')
