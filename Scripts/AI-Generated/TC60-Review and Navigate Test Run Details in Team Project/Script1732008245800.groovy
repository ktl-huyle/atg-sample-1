...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 8-Click on div testRunCells UntitledTestRun4053.png')
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 9-Click on div testRunCells UntitledTestRun4054.png')
...
"Step 13: Click on div testOptions (PopoverBackdrop)"
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 13-Click on div testOptions PopoverBackdrop.png')
...
"Step 20: Click on div testOptions (PopoverBackdrop)"
...
WebUI.takeScreenshot(reportLocation + '/TC60/Step 20-Click on div testOptions PopoverBackdrop.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC60-Review and Navigate Test Run Details in Team Project_visual_checkpoint')
