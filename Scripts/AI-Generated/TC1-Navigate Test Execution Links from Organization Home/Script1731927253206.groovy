...
"Step 7: Click on link testRunDetails (Execution) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7-Click on link testRunDetails Execution - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate Test Execution Links from Organization Home_visual_checkpoint')
