...
"Step 6: Click on pre failedTestCases (FailedKundensonderpreise)"
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 6-Click on pre failedTestCases FailedKundensonderpreise.png')
...
"Step 9: Click on span failedTestDetails (FailedProject)"
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 9-Click on span failedTestDetails FailedProject.png')
...
"Step 14: Click on image filePreview (FilePreview)"
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 14-Click on image filePreview FilePreview.png')
...
"Step 16: Click on div failedPreRequisites (FailedBelege)"
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 16-Click on div failedPreRequisites FailedBelege.png')

"Step 17: Click on pre failedTestCases (FailedLieferanten)"
...
WebUI.takeScreenshot(reportLocation + '/TC31/Step 17-Click on pre failedTestCases FailedLieferanten.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC31-Verify failed test case details and navigation_visual_checkpoint')
