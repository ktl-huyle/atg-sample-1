...
"Step 2: Click on link projectLinks (EcoEHSExecution) -> Navigate to page 'team/*/project/*'"
...
"Step 4: Schedule a test run with environment selection and device options"
...
"Step 7: Click on div testSuites (EHSTestAutomation)"
...
"Step 9: Click on div testSuites (KatalonCloud)"
...
"Step 10: Click on div testSuites (UploadedData)"
...
"Step 11: Click on div testSuites (TestSuites2)"
...
"Step 13: Schedule a test run with environment selection and device options"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Schedule Test Runs with Environment Selection_visual_checkpoint')
