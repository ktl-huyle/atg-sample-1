...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 4-Click on div HistorySchedule.png')
...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 5-Click on header EPPsAutomationTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 6-Click on header EPPsAutomationTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 7-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 8-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 9-Click on button dynamicObject object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 10-Click on button dynamicObject object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC401/Step 11-Click on button dynamicObject object3 - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC401-Verify History Schedule and Execution Details in Sauce Demo_visual_checkpoint')
