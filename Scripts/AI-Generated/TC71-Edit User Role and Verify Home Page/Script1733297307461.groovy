...
WebUI.takeScreenshot(reportLocation + '/TC71/Step 4-Click on button editUser.png')
...
WebUI.takeScreenshot(reportLocation + '/TC71/Step 5-Click on select userTeamRole.png')
...
WebUI.takeScreenshot(reportLocation + '/TC71/Step 6-Click on button save - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC71-Edit User Role and Verify Home Page_visual_checkpoint')
