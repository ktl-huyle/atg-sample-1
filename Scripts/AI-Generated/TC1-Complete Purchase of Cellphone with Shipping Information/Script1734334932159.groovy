...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 16-Click on input ZipCode.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 17-Enter input value in input ZipCode2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 18-Click on input City.png')

"Step 19: Enter input value in input City2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/checkout/shipping-address?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_checkout_shipping_address/input_City'), input_City2)

WebUI.takeScreenshot(reportLocation + '/TC1/Step 19-Enter input value in input City2.png')
...
"Step 23: Click on main Home"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/main_Home'))

WebUI.takeScreenshot(reportLocation + '/TC1/Step 23-Click on main Home.png')

"Step 24: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Complete Purchase of Cellphone with Shipping Information_visual_checkpoint')
