...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 4-Click on header testRuns UntitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 5-Click on button sessionControls Sessions3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 6-Click on div TotalTests.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 7-Click on i Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 8-Click on button sessionControls FailedTestResults.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 9-Click on button sessionControls Sessions3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 10-Click on button sessionControls Sessions4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 11-Click on div TotalTests.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 12-Click on div testRunDetails TestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 13-Click on button Close.png')

"Step 14: Click on div testRunInfo (TestRunInfo)"
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 14-Click on div testRunInfo TestRunInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 15-Click on div NoDataMessage.png')

"Step 16: Click on div testRunInfo (TestRunInfo)"
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 16-Click on div testRunInfo TestRunInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 17-Click on button Close.png')

"Step 18: Click on div testRunInfo (TestRunInfo)"
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 18-Click on div testRunInfo TestRunInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 19-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 20-Click on link TestResults2 - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 21-Click on div FailedSignin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 23-Click on button TestResultDetails - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 24-Click on div thumbnailImages ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 25-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 26-Click on div FileDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 27-Click on div thumbnailImages ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 28-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 29-Click on image testRunImages FileImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 30-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 31-Click on div FileDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 32-Click on div ObjectRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 33-Click on link Requests - Navigate to page teamprojectexecutionstest-resultrequests.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 34-Click on link TestObjects - Navigate to page teamprojectexecutionstest-resulttest-objects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 35-Click on link SimilarFailures - Navigate to page teamprojectexecutionstest-resultsimilar-failures.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 36-Click on link Comments - Navigate to page teamprojectexecutionstest-resultcomments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 37-Click on link ReRuns - Navigate to page teamprojectexecutionstest-resultre-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 38-Click on time FailedSigninReRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 39-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 40-Click on div FilePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 41-Click on div AttachmentFileName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 42-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 43-Click on div FilePreviewDownloadMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 44-Click on div FilePreviewDownloadMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 45-Click on div FilePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 46-Click on link Result - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 47-Click on div ErrorMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 48-Click on label Maintainer - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 49-Click on div FailedSignin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 50-Click on link TestRunLink - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 51-Click on div InputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 52-Click on input FailureReasonSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 53-Click on div FailureReasonBeta.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 54-Click on div ObjectRepository2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 55-Click on div ObjectRepositoryImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC196/Step 56-Click on div thumbnailImages ThumbnailImage2 - Navigate to page .png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC196-Close Thumbnail Images in Test Results_visual_checkpoint')
