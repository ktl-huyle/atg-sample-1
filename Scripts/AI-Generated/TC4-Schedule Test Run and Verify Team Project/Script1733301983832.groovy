...
"Step 4: Click on div testRunItems (testRunItems4)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on div testRunItems testRunItems4.png')

"Step 5: Click on div sortOptions (sortOptions)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on div sortOptions sortOptions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 11-Click on div executionProfileContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 15-Click on link ClickHereToRefresh.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 16-Click on div SelectTestSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 20-Click on link testProjects testProjects - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 23-Click on link Executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 26-Click on td KatalonWebsite.png')

"Step 27: Click on link testProjects (testProjects) -> Navigate to page 'team/*/project/*/test-project/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_project/link_testProjects"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_project/link_testProjects', ['link_testProjects_trNthChild': link_testProjects_trNthChild_1, 'link_testProjects_internalRoleLinkName': link_testProjects_internalRoleLinkName_1, 'team_id': team_id_1, 'test_project_id': test_project_id_1, 'project_id': project_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 27-Click on link testProjects testProjects - Navigate to page teamprojecttest-project.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Schedule Test Run and Verify Team Project_visual_checkpoint')
