...
"Step 2: Click on link navigation (EcoEHSExecution) -> Navigate to page 'team/*/project/*'"
...
"Step 4: Schedule and run test suites in the SauceDemo application"
...
"Step 13: Schedule and run test suites in the SauceDemo application"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Schedule and Run Test Suites_visual_checkpoint')
