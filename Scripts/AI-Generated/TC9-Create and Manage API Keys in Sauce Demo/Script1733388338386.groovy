...
"Step 9: Click on button apiKeyActions (apiKeyActions)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on button apiKeyActions apiKeyActions.png')
...
"Step 11: Click on input apiKeyInputs (apiKeyInputs)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_user/input_apiKeyInputs'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 11-Click on input apiKeyInputs apiKeyInputs.png')

"Step 12: Click on input apiKeyInputs (apiKeyInputs2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_user/input_apiKeyInputs'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 12-Click on input apiKeyInputs apiKeyInputs2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 13-Click on button copyToClipboard CopyToClipboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 14-Click on button NK.png')

"Step 15: Click on link SignOut2 -> Navigate to page 'organization/*/home'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/link_SignOut2'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 15-Click on link SignOut2 - Navigate to page organizationhome.png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Create and Manage API Keys in Sauce Demo_visual_checkpoint')
