...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 4-Click on link Job5409 - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 5-Click on pre logOutputs LogOutput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 6-Click on pre logOutputs LogOutput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 7-Click on pre logOutputs LogOutput2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC108/Step 8-Click on pre logOutputs LogOutput2 - Navigate to page teamprojectgridplanjob.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC108-Review Log Outputs in Team Project Grid_visual_checkpoint')
