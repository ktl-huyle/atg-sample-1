...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 4-Click on link Executions5 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 5-Click on div testRunDetails ParallelSuite751.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 6-Click on div testRunDetails ParallelSuite749.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 7-Click on div testRunDetails ParallelSuite750.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 8-Click on div testRunDetails ParallelSuite751.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 9-Click on button JobReady.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 10-Click on div MyOrganization.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 11-Click on link ViewAllProjects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 12-Click on div CurrentReadyTechJob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 13-Click on link JRJobReady - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 14-Click on span settings Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 15-Click on link OrganizationManagement - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 16-Click on p ReadyCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 17-Click on input SelectUsersToAdd.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 18-Enter input value in input SelectUsersToAdd.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 19-Click on div ProjectProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 20-Click on input SelectTimeZone.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 21-Click on div EnableBDDReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 22-Click on div UnknownContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 23-Click on span settings Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 24-Click on div dynamicObject MuiBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 25-Click on div UnknownContent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 26-Enter input value in input SelectUsersToAdd.png')
...
WebUI.takeScreenshot(reportLocation + '/TC173/Step 27-Click on div TeamReadyCase - Navigate to page .png')

"Step 28: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC173-Verify Home Page After Project Management Actions_visual_checkpoint')
