...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 4-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 5-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 6-Click on link TrueTest45 - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 7-Click on link projectLinks LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 8-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 9-Click on div UserJourneyGraph.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 10-Click on input ControlledCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 11-Click on button navigationActions ExpandGraph.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 12-Click on button ExportAllFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 13-Click on link DownloadCSV.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 14-Click on span SettingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 15-Click on link TrueTestBetaConfigure - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 16-Click on link TrueTest45 - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 17-Click on div QA JamaicaFlow.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 18-Click on div dynamicObject URLLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 19-Click on p InstallTrueTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 20-Click on link projectLinks LLA Digital Jamaica - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 21-Click on link TrueTest - Navigate to page teamprojecttruetestuser-journeys.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 22-Click on button viewDetails ViewDetails - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 23-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 24-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 25-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 26-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 27-Click on p userJourneySteps VerifyNavigationToHome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 28-Click on button navigationActions GoToNextPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 29-Click on p userJourneySteps VerifyInternetBundles.png')

"Step 30: Click on button detailFlowPanels (ShowDetails)"
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 30-Click on button detailFlowPanels ShowDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 31-Click on button navigationActions GoToNextPage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 32-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 33-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 34-Click on p userJourneySteps NavigateAndInteract.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 35-Click on button detailFlowPanels ShowDetailFlowPanel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 36-Click on input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 37-Enter input value in input SearchFlows.png')
...
WebUI.takeScreenshot(reportLocation + '/TC148/Step 38-Click on button detailFlowPanels ShowDetailFlowPanel2 - Navigate to page .png')

"Step 39: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC148-Configure TrueTest Settings and Verify User Journeys_visual_checkpoint')
