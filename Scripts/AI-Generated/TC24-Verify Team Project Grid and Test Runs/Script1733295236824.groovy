...
"Step 4: Click on link testRunItems (untitledTestRun) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunItems"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunItems', ['project_id': project_id, 'plan_id': plan_id, 'team_id': team_id]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 4-Click on link testRunItems untitledTestRun - Navigate to page teamprojectgridplanjob.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionDetails', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName, 'executions_id': executions_id, 'project_id': project_id_1, 'team_id': team_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 5-Click on link executionDetails execution10 - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_2', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_1, 'job_id': job_id, 'project_id': project_id_2, 'plan_id': plan_id_1, 'team_id': team_id_2]))
...
"Step 22: Click on div testCaseItems (TestCases)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 22-Click on div testCaseItems TestCases.png')
...
"Step 25: Click on div testSuites"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_design_test_cases/div_testSuites'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 25-Click on div testSuites.png')
...
"Step 54: Click on image testImage"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions_test_result/image_testImage'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 54-Click on image testImage.png')

"Step 55: Click on image testImage"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions_test_result/image_testImage'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 55-Click on image testImage.png')

"Step 56: Click on image testImage"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions_test_result/image_testImage'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 56-Click on image testImage.png')
...
"Step 63: Click on header testRunTitles (UntitledTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 63-Click on header testRunTitles UntitledTestRun.png')

"Step 64: Click on header testRunTitles (UntitledTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 64-Click on header testRunTitles UntitledTestRun.png')
...
"Step 87: Click on header testRunTitles (EdgeOpenTest)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 87-Click on header testRunTitles EdgeOpenTest.png')
...
"Step 97: Click on link testRunItems (EdgeOpenTest) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunItems"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunItems', ['project_id': project_id_4, 'plan_id': plan_id_2, 'team_id': team_id_4]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 97-Click on link testRunItems EdgeOpenTest - Navigate to page teamprojectgridplanjob.png')

"Step 98: Click on div EdgeOpenTestTable"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid/plan/.*/job?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_grid_plan_job/div_EdgeOpenTestTable'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 98-Click on div EdgeOpenTestTable.png')

"Step 99: Click on link executionDetails (TestRunID) -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid/plan/.*/job?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionDetails', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_2, 'executions_id': executions_id_1, 'project_id': project_id_5, 'team_id': team_id_5]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 99-Click on link executionDetails TestRunID - Navigate to page teamprojectexecutions.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_2"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_2', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_3, 'job_id': job_id_1, 'project_id': project_id_6, 'plan_id': plan_id_3, 'team_id': team_id_6]))
