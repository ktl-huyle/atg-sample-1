...
"Step 4: Click on link PerfTestAPIs (PerfTestAPIs2) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid/link_PerfTestAPIs"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_PerfTestAPIs', ['link_PerfTestAPIs_trNthChild': link_PerfTestAPIs_trNthChild, 'link_PerfTestAPIs_internalRoleLinkName': link_PerfTestAPIs_internalRoleLinkName, 'team_id': team_id, 'project_id': project_id, 'plan_id': plan_id]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 4-Click on link PerfTestAPIs PerfTestAPIs2 - Navigate to page teamprojectgridplanjob.png')

"Step 5: Click on link execution (Execution3) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_execution', ['link_execution_trNthChild': link_execution_trNthChild, 'link_execution_internalRoleLinkName': link_execution_internalRoleLinkName, 'team_id': team_id_1, 'executions_id': executions_id, 'project_id': project_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 5-Click on link execution Execution3 - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName, 'team_id': team_id_2, 'job_id': job_id, 'project_id': project_id_2, 'plan_id': plan_id_1]))
...
"Step 25: Click on div dynamicObject (testSuites)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 25-Click on div dynamicObject testSuites.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_testSuites_2'))
...
"Step 54: Click on image dynamicObject (TestResultImage)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 54-Click on image dynamicObject TestResultImage.png')

"Step 55: Click on image dynamicObject (TestResultImage)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 55-Click on image dynamicObject TestResultImage.png')

"Step 56: Click on image dynamicObject (TestResultImage)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 56-Click on image dynamicObject TestResultImage.png')
...
"Step 63: Click on header testRun (EPPsAutomation4)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 63-Click on header testRun EPPsAutomation4.png')

"Step 64: Click on header testRun (EPPsAutomation4)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 64-Click on header testRun EPPsAutomation4.png')
...
"Step 87: Click on header testRun (EPPsAutomation4)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 87-Click on header testRun EPPsAutomation4.png')
...
"Step 97: Click on link PerfTestAPIs (PerfTestAPIs2) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid/link_PerfTestAPIs"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_PerfTestAPIs', ['link_PerfTestAPIs_trNthChild': link_PerfTestAPIs_trNthChild_1, 'link_PerfTestAPIs_internalRoleLinkName': link_PerfTestAPIs_internalRoleLinkName_1, 'team_id': team_id_4, 'project_id': project_id_4, 'plan_id': plan_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 97-Click on link PerfTestAPIs PerfTestAPIs2 - Navigate to page teamprojectgridplanjob.png')

"Step 98: Click on div dynamicObject (EdgeOpenTestTable)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid/plan/.*/job?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/div_dynamicObject"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/div_dynamicObject', ['div_dynamicObject_internalText': div_dynamicObject_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 98-Click on div dynamicObject EdgeOpenTestTable.png')

"Step 99: Click on link execution (Execution3) -> Navigate to page 'team/*/project/*/executions/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid/plan/.*/job?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_execution"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_execution', ['link_execution_trNthChild': link_execution_trNthChild_1, 'link_execution_internalRoleLinkName': link_execution_internalRoleLinkName_1, 'team_id': team_id_5, 'executions_id': executions_id_1, 'project_id': project_id_5]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 99-Click on link execution Execution3 - Navigate to page teamprojectexecutions.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_1', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_1, 'team_id': team_id_6, 'job_id': job_id_1, 'project_id': project_id_6, 'plan_id': plan_id_3]))
