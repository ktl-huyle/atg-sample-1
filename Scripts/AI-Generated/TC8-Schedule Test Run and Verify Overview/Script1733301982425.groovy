...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on link projectDetails projectDetails - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 9-Click on link ClickHereToRefresh2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 10-Click on div SelectTestSuite2.png')
...
"Step 14: Click on div testSuiteItems (testSuiteItems4)"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 14-Click on div testSuiteItems testSuiteItems4.png')

"Step 15: Click on div testSuiteItems (testSuiteItems5)"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 15-Click on div testSuiteItems testSuiteItems5.png')

"Step 16: Click on div testSuiteItems (testSuiteItems6)"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 16-Click on div testSuiteItems testSuiteItems6.png')

"Step 17: Click on div testSuiteItems (testSuiteItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 17-Click on div testSuiteItems testSuiteItems2.png')

"Step 18: Click on div testSuiteItems (testSuiteItems7)"
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 18-Click on div testSuiteItems testSuiteItems7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 29-Click on div menuItems menuItems.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 44-Click on button closeActions closeActions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 45-Click on button closeActions closeActions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 48-Click on p sessionDetails sessionDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC8/Step 49-Click on div menuItems menuItems2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Schedule Test Run and Verify Overview_visual_checkpoint')
