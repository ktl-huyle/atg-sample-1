...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 2-Click on button executionControls LinkToRelease.png')
...
"Step 4: Click on button executionControls (Run) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on button executionControls Run - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Manage Execution Controls in Project Management_visual_checkpoint')
