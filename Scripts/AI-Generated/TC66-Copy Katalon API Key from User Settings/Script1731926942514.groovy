...
"Step 9: Click on button copyActions (CopyToClipboard2)"
...
WebUI.takeScreenshot(reportLocation + '/TC66/Step 9-Click on button copyActions CopyToClipboard2.png')

"Step 10: Click on button copyActions (CopyToClipboard3) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_user/button_copyActions'))

WebUI.takeScreenshot(reportLocation + '/TC66/Step 10-Click on button copyActions CopyToClipboard3 - Navigate to page .png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC66-Copy Katalon API Key from User Settings_visual_checkpoint')
