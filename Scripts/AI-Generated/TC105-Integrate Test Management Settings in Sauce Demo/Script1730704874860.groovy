...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_integrations', ['link_integrations_trNthChild': link_integrations_trNthChild, 'link_integrations_internalRoleLinkName': link_integrations_internalRoleLinkName, 'link_integrations_project_id': link_integrations_project_id, 'link_integrations_team_id': link_integrations_team_id, 'link_integrations_test_project_id': link_integrations_test_project_id]))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_executionDetails', ['link_executionDetails_trNthChild': link_executionDetails_trNthChild, 'link_executionDetails_team_id': link_executionDetails_team_id, 'link_executionDetails_project_id': link_executionDetails_project_id, 'link_executionDetails_executions_id': link_executionDetails_executions_id]))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_testCases', ['div_testCases_class': div_testCases_class, 'div_testCases_nth': div_testCases_nth, 'div_testCases_internalText': div_testCases_internalText]))
