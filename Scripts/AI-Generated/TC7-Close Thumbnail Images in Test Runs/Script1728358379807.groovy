...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Click on link SPRINT - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on link TestRuns - Navigate to page teamprojectreleasesexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 7-Click on link 4077 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 8-Click on link TestResults - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 9-Click on div PassedTestCase.png')

"Step 10: Close all opened thumbnail images in the application."
...
WebUI.takeScreenshot(reportLocation + '/TC7/Step 11-Click on link Planning - Navigate to page teamprojectreleases.png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC7-Close Thumbnail Images in Test Runs_visual_checkpoint')
