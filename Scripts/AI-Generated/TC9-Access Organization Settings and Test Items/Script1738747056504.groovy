...
"Step 9: Click on link testItems (Tests) -> Navigate to page 'team project details#team/*/project/*/*/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on link testItems Tests - Navigate to page team project detailsteamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Access Organization Settings and Test Items_visual_checkpoint')
