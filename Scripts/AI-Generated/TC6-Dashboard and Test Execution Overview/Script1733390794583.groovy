...
"Step 9: Click on span treeSwitchers (TreeSwitcher6)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 9-Click on span treeSwitchers TreeSwitcher6.png')
...
"Step 11: Click on span treeSwitchers (TreeSwitcher6)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 11-Click on span treeSwitchers TreeSwitcher6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 12-Click on div testCases AgendarInventario.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 14-Click on div testCases MantenimientoSalas.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 15-Click on div testCases AgendarInventario.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 16-Click on div testCases KatalonCloud.png')
...
"Step 28: Click on span treeSwitchers (TreeSwitcher7)"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 28-Click on span treeSwitchers TreeSwitcher7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 29-Click on div testCases AgendarInventario.png')

"Step 30: Click on link insuranceDemographics (Agendamiento) -> Navigate to page 'team/*/project/*/test-design/test-cases/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/link_insuranceDemographics', ['link_insuranceDemographics_internalRoleLinkName': link_insuranceDemographics_internalRoleLinkName, 'team_id': team_id, 'test_cases_id': test_cases_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 30-Click on link insuranceDemographics Agendamiento - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 35-Click on div testSuites TestSuiteValidation.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 36-Click on div testSuites TestSuiteValidation2.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['link_testSuiteActions_internalRoleLinkName': link_testSuiteActions_internalRoleLinkName, 'team_id': team_id_1, 'test_suites_id': test_suites_id, 'project_id': project_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 37-Click on link testSuiteActions TestSuiteValidation - Navigate to page teamprojecttest-designtest-suites.png')

"Step 38: Click on link testSuites (CPACDECPreapprovalBindTestSuite2) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 38-Click on link testSuites CPACDECPreapprovalBindTestSuite2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 45-Click on div testCases MantenimientoSalas.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Dashboard and Test Execution Overview_visual_checkpoint')
