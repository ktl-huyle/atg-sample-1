...
"Step 4: Click on input checkboxSelection (SelectRow)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 4-Click on input checkboxSelection SelectRow.png')

"Step 5: Click on input checkboxSelection (SelectRow2)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 5-Click on input checkboxSelection SelectRow2.png')
...
"Step 8: Click on input checkboxSelection (SelectRow3)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 8-Click on input checkboxSelection SelectRow3.png')

"Step 9: Click on input checkboxSelection (SelectRow4)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 9-Click on input checkboxSelection SelectRow4.png')

"Step 10: Click on input checkboxSelection (SelectRow5)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 10-Click on input checkboxSelection SelectRow5.png')
...
"Step 13: Click on input checkboxSelection (SelectRow4)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/input_checkboxSelection"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/input_checkboxSelection', ['input_checkboxSelection_class': input_checkboxSelection_class_5, 'input_checkboxSelection_internalRoleRowName': input_checkboxSelection_internalRoleRowName_5]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 13-Click on input checkboxSelection SelectRow4.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Terminate Multiple Test Runs in Team Project_visual_checkpoint')
