...
import katalon.common.actionSequence_11
...
"Step 2: Click on link tests -> Navigate to page 'team/*/project/*/test-design/*'"
...
"Step 3: Click on link testSuites"
...
"Step 7: Call function actionSequence 11"

actionSequence_11.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Call function actionSequence 11"

actionSequence_11.execute(data_path_1, Integer.valueOf(index_1))
...
"Step 10: Click on link testCases -> Navigate to page 'team/*/project/*/test-reports/test-maintenance/*'"
...
"Step 15: Click on link testRuns2 -> Navigate to page 'team/*/project/*/executions'"
...
"Step 16: Click on link teamProjectExecutions2 -> Navigate to page 'team/*/project/*/executions/*'"
...
"Step 19: Click on div object30"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_object30'))

WebUI.takeScreenshot()

"Step 20: Click on div object31"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/div_object31'))
...
"Step 25: Click on span object6"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_object6'))
...
"Step 28: Click on button selectOrganization"
...
"Step 31: Click on link tests -> Navigate to page 'team/*/project/*/test-design/*'"
...
"Step 33: Call function actionSequence 1"

actionSequence_1.execute(data_path_2, Integer.valueOf(index_2))

"Step 34: Click on link schedules2 -> Navigate to page 'team/*/project/*/grid'"
...
"Step 35: Click on button openScheduleDialog"
...
"Step 48: Click on div reactSelect20Option0"
...
"Step 50: Click on div object18"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_grid/div_object18'))

WebUI.takeScreenshot()

"Step 51: Click on div object18 -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TestCase-079_visual_checkpoint')
