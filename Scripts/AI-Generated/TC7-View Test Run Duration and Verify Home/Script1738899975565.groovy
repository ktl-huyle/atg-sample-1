...
"Step 4: Click on div currentData (CurrentDDDivisi)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_organization_home/div_currentData"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/div_currentData', ['div_currentData_internalHasText': div_currentData_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 4-Click on div currentData CurrentDDDivisi.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC7-View Test Run Duration and Verify Home_visual_checkpoint')
