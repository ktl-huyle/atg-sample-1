...
"Step 5: Click on button sessionManagement (Sessions2)"
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 5-Click on button sessionManagement Sessions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 8-Click on button sessionManagement FailedTestResults.png')

"Step 9: Click on button sessionManagement (Sessions2)"
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 9-Click on button sessionManagement Sessions2.png')

"Step 10: Click on button sessionManagement (Sessions3)"
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 10-Click on button sessionManagement Sessions3.png')
...
"Step 12: Click on div testRunOptions (TestRunDetails)"
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 12-Click on div testRunOptions TestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 14-Click on div testRunDetails TestRunInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 16-Click on div testRunDetails TestRunInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC37/Step 18-Click on div testRunDetails TestRunInfo.png')
...
"Step 25: Click on div filePreviewMessage (FilePreviewMessage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_runs/div_filePreviewMessage'))

WebUI.takeScreenshot(reportLocation + '/TC37/Step 25-Click on div filePreviewMessage FilePreviewMessage.png')
...
"Step 44: Click on div filePreviewMessage (FilePreviewMessage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*/re-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result_re_runs/div_filePreviewMessage'))

WebUI.takeScreenshot(reportLocation + '/TC37/Step 44-Click on div filePreviewMessage FilePreviewMessage.png')
...
"Step 47: Click on div filePreviewDownloadMessage (FilePreviewDownloadMessage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*/re-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result_re_runs/div_filePreviewDownloadMessage'))

WebUI.takeScreenshot(reportLocation + '/TC37/Step 47-Click on div filePreviewDownloadMessage FilePreviewDownloadMessage.png')

"Step 48: Click on div filePreviewDownloadMessage (FilePreviewDownloadMessage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*/re-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result_re_runs/div_filePreviewDownloadMessage'))

WebUI.takeScreenshot(reportLocation + '/TC37/Step 48-Click on div filePreviewDownloadMessage FilePreviewDownloadMessage.png')

"Step 49: Click on div filePreviewMessage (FilePreviewMessage)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*/re-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_test_result_re_runs/div_filePreviewMessage'))

WebUI.takeScreenshot(reportLocation + '/TC37/Step 49-Click on div filePreviewMessage FilePreviewMessage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC37-Review Test Run Details and Manage Execution Results_visual_checkpoint')
