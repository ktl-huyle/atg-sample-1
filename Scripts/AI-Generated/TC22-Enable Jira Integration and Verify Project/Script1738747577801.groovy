...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_tests', ['link_tests_nthChild': link_tests_nthChild, 'path_param_5': path_param_5, 'project_id': project_id_1, 'team_id': team_id_1, 'path_param_6': path_param_6]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 22-Click on link tests Tests2 - Navigate to page team project detailsteamproject.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites', ['link_testSuites_internalRoleLinkName': link_testSuites_internalRoleLinkName, 'path_param_5': path_param_5_1, 'project_id': project_id_2, 'team_id': team_id_2, 'path_param_6': path_param_6_1]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/span_treeSwitcher_1"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/span_treeSwitcher_1', ['span_treeSwitcher_divNthChild': span_treeSwitcher_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 34-Click on span treeSwitcher TreeSwitcherIcon.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites', ['link_testSuites_internalRoleLinkName': link_testSuites_internalRoleLinkName_1, 'path_param_5': path_param_5_2, 'project_id': project_id_3, 'team_id': team_id_3, 'path_param_6': path_param_6_2]))
...
"Step 39: Click on button closeAlerts (Close)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/requirements?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlerts"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlerts', ['button_closeAlerts_class': button_closeAlerts_class]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 39-Click on button closeAlerts Close.png')
...
"Step 41: Click on button closeAlerts (AlertClose)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/requirements?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlerts"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlerts', ['button_closeAlerts_class': button_closeAlerts_class_1]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 41-Click on button closeAlerts AlertClose.png')
...
"Step 56: Click on link testingOptions (VisualTesting) -> Navigate to page 'team project#team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/link_testingOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/link_testingOptions', ['link_testingOptions_internalRoleLinkName': link_testingOptions_internalRoleLinkName, 'path_param_5': path_param_5_3, 'project_id': project_id_4, 'team_id': team_id_4]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 56-Click on link testingOptions VisualTesting - Navigate to page team projectteamproject.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Enable Jira Integration and Verify Project_visual_checkpoint')
