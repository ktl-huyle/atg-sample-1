...
"Step 5: Click on item scheduleTestRun"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/item_scheduleTestRun'))

WebUI.takeScreenshot()

"Step 6: Click on radioButton a"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/radioButton_a'))

WebUI.takeScreenshot()

"Step 7: Click on div reactSelectControl -> Navigate to page ''"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Schedule Test Run with Environment Selection in Team Project_visual_checkpoint')
