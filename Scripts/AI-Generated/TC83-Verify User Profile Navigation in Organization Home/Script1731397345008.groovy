...
"Step 2: Click on button nawwarahYusof"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/organization/.*/home?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_organization_home/button_nawwarahYusof'))
...
"Step 4: Click on button nawwarahYusof"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_user/button_nawwarahYusof'))
...
"Step 6: Click on link katalonApiKey"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC83-Verify User Profile Navigation in Organization Home_visual_checkpoint')
