...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 5-Click on link Reports - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 7-Click on link Reports2 - Navigate to page teamprojectoverview.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-Verify Test Design and Release Reports_visual_checkpoint')
