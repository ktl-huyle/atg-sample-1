...
"Step 2: Schedule a test run and save configurations in Katalon"

scheduleTestRunAndSaveConfigurations.execute(data_path_0, Integer.valueOf(index_0))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Navigate and Schedule Test Run in Katalon for Team Project_visual_checkpoint')
