...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 4-Click on span ProfileAll.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 5-Click on input FilterByProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 6-Enter input value in input FilterByProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 7-Click on button Update.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 8-Click on link moreItems MoreItems.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 9-Click on div CreatedWithSketch.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 10-Click on button thumbnailActions ThumbnailAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 11-Click on button thumbnailActions ThumbnailAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 12-Click on button thumbnailActions ThumbnailAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 13-Click on button thumbnailActions ThumbnailAction2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 14-Click on button thumbnailActions ThumbnailAction2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 15-Click on button thumbnailActions ThumbnailAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 16-Click on pre TooltipMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 17-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 18-Click on button showSlides ShowSlide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 19-Click on button showSlides ShowSlide2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 20-Click on button showSlides ShowSlide3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 21-Click on button showSlides ShowSlide4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 22-Click on button showSlides ShowSlide5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 23-Click on button showSlides ShowSlide6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 24-Click on button showSlides ShowSlide7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 25-Click on button showSlides ShowSlide8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 26-Click on button showSlides ShowSlide9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 27-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 28-Click on form ReportDefect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 29-Click on div SummaryMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC169/Step 30-Click on div noDataDisplay ThumbnailImage2 - Navigate to page .png')

"Step 31: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC169-Verify Thumbnail Actions and Defect Reporting_visual_checkpoint')
