...
"Step 2: Click on div testRun (UntitledTestRun3)"
...
"Step 5: Schedule a test run and configure the test environment settings"
...
"Step 8: Click on link project (TestProject) -> Navigate to page 'team/*/project/*/test-project/*'"
...
"Step 15: Click on link project (TestProject) -> Navigate to page 'team/*/project/*/test-project/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_project/link_project"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_project/link_project', ['link_project_trNthChild': link_project_trNthChild_1, 'link_project_internalRoleLinkName': link_project_internalRoleLinkName_1, 'link_project_team_id': link_project_team_id_1, 'link_project_test_project_id': link_project_test_project_id_1, 'link_project_project_id': link_project_project_id_1]))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Refresh Script Repositories in Team Project_visual_checkpoint')
