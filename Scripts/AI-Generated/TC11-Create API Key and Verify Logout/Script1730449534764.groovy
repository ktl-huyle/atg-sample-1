...
"Step 2: Create a new API key for accessing the application."

createApiKeyForAccess.execute(data_path_0, Integer.valueOf(index_0))

"Step 3: Click on button apiActions (ActionButton)"
...
"Step 5: Click on input credentials (ApiKeyTextbox)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/user/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_user/input_credentials'))

WebUI.takeScreenshot()

"Step 6: Click on input credentials (PasswordField)"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Create API Key and Verify Logout_visual_checkpoint')
