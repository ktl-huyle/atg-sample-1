...
"Step 4: Click on link testRunDetails (UntitledTestRun) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunDetails', ['project_id': project_id, 'team_id': team_id, 'plan_id': plan_id]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 4-Click on link testRunDetails UntitledTestRun - Navigate to page teamprojectgridplanjob.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionDetails', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName, 'project_id': project_id_1, 'team_id': team_id_1, 'executions_id': executions_id]))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_1, 'project_id': project_id_2, 'team_id': team_id_2, 'plan_id': plan_id_1, 'job_id': job_id]))
...
"Step 22: Click on div testCaseDetails (TestCases2)"
...
WebUI.takeScreenshot(reportLocation + '/TC11/Step 22-Click on div testCaseDetails TestCases2.png')
...
"Step 63: Click on header testRunOverview (UntitledTestRun)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunOverview"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunOverview', ['header_testRunOverview_internalRoleHeadingName': header_testRunOverview_internalRoleHeadingName]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 63-Click on header testRunOverview UntitledTestRun.png')

"Step 64: Click on header testRunOverview (UntitledTestRun)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunOverview"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunOverview', ['header_testRunOverview_internalRoleHeadingName': header_testRunOverview_internalRoleHeadingName_1]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 64-Click on header testRunOverview UntitledTestRun.png')
...
"Step 87: Click on header testRunOverview (EdgeOpenTest)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunOverview"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/header_testRunOverview', ['header_testRunOverview_internalRoleHeadingName': header_testRunOverview_internalRoleHeadingName_2]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 87-Click on header testRunOverview EdgeOpenTest.png')
...
"Step 97: Click on link testRunDetails (testPlan) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_testRunDetails', ['project_id': project_id_4, 'team_id': team_id_4, 'plan_id': plan_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC11/Step 97-Click on link testRunDetails testPlan - Navigate to page teamprojectgridplanjob.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_executionDetails', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_2, 'project_id': project_id_5, 'team_id': team_id_5, 'executions_id': executions_id_1]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_3, 'project_id': project_id_6, 'team_id': team_id_6, 'plan_id': plan_id_3, 'job_id': job_id_1]))
