...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 2-Click on button runManagement LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC19/Step 4-Click on button runManagement Run - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Manage Run Management in Project Management_visual_checkpoint')
