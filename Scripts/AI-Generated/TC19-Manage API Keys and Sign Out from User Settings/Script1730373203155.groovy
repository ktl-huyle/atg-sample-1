...
"Step 6: Create a new API key with specified name and options"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Manage API Keys and Sign Out from User Settings_visual_checkpoint')
