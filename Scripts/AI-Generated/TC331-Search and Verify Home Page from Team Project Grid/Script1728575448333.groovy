...
WebUI.takeScreenshot(reportLocation + '/TC331/Step 5-Click on input Search.png')
...
WebUI.takeScreenshot(reportLocation + '/TC331/Step 6-Enter input value in input Search - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC331-Search and Verify Home Page from Team Project Grid_visual_checkpoint')
