...
"Step 2: Click on link organizationSettingsAgent (organizationSettingsAgentLocal) -> Navigate to page 'organization/*/settings/agent/local/*'"
...
"Step 8: Click on link dynamicObject (fpFirstProjectTestCases188545m33sExecu) -> Navigate to page 'team/*/project/*'"
...
"Step 25: Click on link organizationSettingsAgent (organizationSettingsAgentLocal) -> Navigate to page 'organization/*/settings/agent/local/*'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC39-Comprehensive Navigation in Organization Settings_visual_checkpoint')
