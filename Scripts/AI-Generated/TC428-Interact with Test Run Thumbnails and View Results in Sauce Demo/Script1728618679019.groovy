...
import truetest.common.quickThumbnailImageInteraction
...
"Step 4: Click on header testRunTitles (UntitledTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 4-Click on header testRunTitles UntitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 5-Click on button sessionTabs SessionsTab.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 6-Click on div TotalTests.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 7-Click on i Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 8-Click on button sessionTabs FailedTestResultsTab.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 9-Click on button sessionTabs SessionsTab.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 10-Click on button sessionTabs SessionsTab2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 11-Click on div TotalTests.png')

"Step 12: Click on div testRunElements (TestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 12-Click on div testRunElements TestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 13-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 14-Click on div testRunDetails TestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 15-Click on div NoDataDisplay.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 16-Click on div testRunDetails TestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 17-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 18-Click on div testRunDetails TestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 19-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 20-Click on link TestResults2 - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 21-Click on div FailedSigninMessage.png')

"Step 22: Quickly interact with and close multiple thumbnail images."

quickThumbnailImageInteraction.execute()
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 23-Click on button testResultDetails GoToTestResultDetails - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 24-Click on div thumbnailImages ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 25-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 26-Click on div FilePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 27-Click on div thumbnailImages ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 28-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 29-Click on image FilePreview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 30-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 31-Click on div FilePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 32-Click on div ObjectRepositoryTreeItem.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 33-Click on link Requests - Navigate to page teamprojectexecutionstest-resultrequests.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 34-Click on link TestObjects - Navigate to page teamprojectexecutionstest-resulttest-objects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 35-Click on link SimilarFailures - Navigate to page teamprojectexecutionstest-resultsimilar-failures.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 36-Click on link Comments - Navigate to page teamprojectexecutionstest-resultcomments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 37-Click on link ReRuns - Navigate to page teamprojectexecutionstest-resultre-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 38-Click on time FailedSigninReRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 39-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 40-Click on div FileTypePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 41-Click on div Attachments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 42-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 43-Click on div FileDownloadMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 44-Click on div FileDownloadMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 45-Click on div FileTypePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 46-Click on link Result - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 47-Click on div ErrorMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 48-Click on label Maintainer - Navigate to page teamprojectexecutionstest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 49-Click on div FailedSigninMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 50-Click on link TestRuns - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 51-Click on div NoDefectLinkedMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 52-Click on div ObjectRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 53-Click on div ObjectRepositoryImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC428/Step 54-Click on div thumbnailImages ThumbnailImage2 - Navigate to page .png')

"Step 55: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC428-Interact with Test Run Thumbnails and View Results in Sauce Demo_visual_checkpoint')
