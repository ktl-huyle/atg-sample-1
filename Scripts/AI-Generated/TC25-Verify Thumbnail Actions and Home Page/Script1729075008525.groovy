...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 4-Click on span ProfileAll.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 5-Click on input FilterByProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 6-Enter input value in input FilterByProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 7-Click on button Update.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 8-Click on link moreItems MoreItems.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 9-Click on div CreatedWithSketch.png')

"Step 10: Click on button thumbnailAction (ThumbnailAction)"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 10-Click on button thumbnailAction ThumbnailAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 11-Click on button thumbnailAction ThumbnailAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 12-Click on button thumbnailAction ThumbnailAction.png')

"Step 13: Click on button thumbnailAction (ThumbnailAction2)"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 13-Click on button thumbnailAction ThumbnailAction2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 14-Click on button thumbnailAction ThumbnailAction2.png')

"Step 15: Click on button thumbnailAction (ThumbnailAction)"
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 15-Click on button thumbnailAction ThumbnailAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 16-Click on pre TooltipMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 17-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 18-Click on button showSlide ShowSlide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 19-Click on button showSlide ShowSlide2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 20-Click on button showSlide ShowSlide3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 21-Click on button showSlide ShowSlide4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 22-Click on button showSlide ShowSlide5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 23-Click on button showSlide ShowSlide6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 24-Click on button showSlide ShowSlide7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 25-Click on button showSlide ShowSlide8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 26-Click on button showSlide ShowSlide9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 27-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 28-Click on form ReportDefect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC25/Step 29-Click on div SummaryMessage.png')

"Step 30: Click on div noDataDisplay (ThumbnailImage2) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/div_noDataDisplay'))

WebUI.takeScreenshot(reportLocation + '/TC25/Step 30-Click on div noDataDisplay ThumbnailImage2 - Navigate to page .png')

"Step 31: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC25-Verify Thumbnail Actions and Home Page_visual_checkpoint')
