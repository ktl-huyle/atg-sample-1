...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 4-Click on div testRunItems testRunItems.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 5-Click on div sortOptions sortOptions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 6-Click on button Details.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 7-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 8-Click on div SelectEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 9-Click on div AdvancedSettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 10-Click on div ScheduleAt.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 11-Click on div executionProfileContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 12-Click on div Default.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 13-Click on div TestSuitesTS10Product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 14-Click on div TestSuite.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 15-Click on link ClickHereToRefresh.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 16-Click on div SelectTestSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 17-Click on button CloseDialog.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 18-Click on link Settings - Navigate to page teamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 19-Click on link ScriptRepositories - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC185/Step 20-Click on link testProjects testProjects - Navigate to page teamprojecttest-project.png')

"Step 21: Click on button RefreshScriptRepository -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_project/button_RefreshScriptRepository_1'))

WebUI.takeScreenshot(reportLocation + '/TC185/Step 21-Click on button RefreshScriptRepository - Navigate to page .png')

"Step 22: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC185-Manage Test Runs and Schedule Execution in Sauce Demo_visual_checkpoint')
