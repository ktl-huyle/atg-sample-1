...
import katalon.common.editProjectDescriptionAndSave
...
"Step 7: Edit the description of a team project and save changes"

editProjectDescriptionAndSave.execute(data_path_0, Integer.valueOf(index_0))

"Step 8: Click on button alert -> Navigate to page 'team/*/project/*/test-design/test-cases'"
...
"Step 14: Schedule a test run and save the configuration settings"

scheduleTestRunAndSaveSettings.execute(data_path_1, Integer.valueOf(index_1))
...
"Step 17: Click on link teamProjectTestProject -> Navigate to page 'team/*/project/*/test-project/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-project?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_project/link_teamProjectTestProject_2'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC11-Comprehensive Test Project Management and Verification_visual_checkpoint')
