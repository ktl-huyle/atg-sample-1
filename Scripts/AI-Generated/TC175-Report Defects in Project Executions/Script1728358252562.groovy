...
WebUI.takeScreenshot(reportLocation + '/TC175/Step 4-Click on div RightSidebar2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC175/Step 5-Click on div ReportDefect.png')
...
"Step 7: Click on label FunctionsUpdates"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/label_FunctionsUpdates'))

WebUI.takeScreenshot(reportLocation + '/TC175/Step 7-Click on label FunctionsUpdates.png')
...
WebUI.takeScreenshot(reportLocation + '/TC175/Step 8-Click on button Submit.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC175-Report Defects in Project Executions_visual_checkpoint')
