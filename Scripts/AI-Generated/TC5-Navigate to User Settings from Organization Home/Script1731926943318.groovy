...
"Step 4: Click on button userActions (RicardoLaboy)"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 4-Click on button userActions RicardoLaboy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Click on span Settings.png')

"Step 7: Click on link projectManagement (ProjectManagement) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 7-Click on link projectManagement ProjectManagement - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Navigate to User Settings from Organization Home_visual_checkpoint')
