...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 2-Click on button runManagement LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on button runManagement Run.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC30-Run Management and Verify Project Overview_visual_checkpoint')
