...
"Step 4: Click on link dataStatus (EcoEHSExecution) -> Navigate to page 'team/*/project/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/link_dataStatus', ['link_dataStatus_internalRoleLinkName': link_dataStatus_internalRoleLinkName, 'team_id': team_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on link dataStatus EcoEHSExecution - Navigate to page teamproject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Manage Test Suites and Schedule Test Runs_visual_checkpoint')
