...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on link fpHvsamplesTestCase - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5-Click on button testCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6-Click on button recordTestSteps - Navigate to page teamprojecttest-designtest-casesedit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on span dragSelectEnterA.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 8-Click on span dragSelectEnterA.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on span dragSelectEnterA.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10-Click on button addNewTestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 11-Click on div clickOnObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 12-Click on input object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 13-Click on div selectObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 14-Click on div testStepCaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 15-Click on button saveActionButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 16-Click on div cssCa23fy.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 17-Click on button addNewTestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 18-Enter input value in input testStepEditAutocompleteInput.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 19-Click on div selectValueFromDropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 20-Click on input value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 21-Click on input dropdown.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 22-Click on div testStepCaptureNewObjectOption.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 23-Click on input value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 24-Enter input value in input value.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 25-Click on button saveActionButton2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 26-Click on input dragSelect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 27-Click on input dragSelect2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 28-Click on input dragSelect3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 29-Click on input dragSelect4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 30-Click on input dragSelect5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 31-Click on input dragSelect6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 32-Click on input dragSelect7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 33-Click on input dragSelect8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 34-Click on input dragSelect9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 35-Click on span deleteAllSelectedSteps.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 36-Click on div recordPlaybackOpenThe.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 37-Click on button playbackWithBrowserExtension.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 38-Click on span dragSelectSelectPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 39-Click on span dragSelectSelectPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 40-Click on span dragSelectSelectPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 41-Click on span dragSelectSelectPrice.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 42-Click on button testStepEditButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 43-Click on input value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 44-Click on input value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 45-Enter input value in input value2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 46-Click on button saveActionButton3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 47-Click on button playbackWithBrowserExtension - Navigate to page .png')

"Step 48: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Record Test Steps for Test Case Execution_visual_checkpoint')
