...
"Step 12: Schedule a test run and select the testing environment."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Perform Multiple Actions in Team Project and Verify Home Page_visual_checkpoint')
