...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 4-Click on link signOut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 5-Click on span settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 6-Click on link truetestBetaConfigurePropertiesForTrueTest - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 7-Click on div httpsOspredevIrl01Vopak.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 8-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 9-Click on span object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 10-Click on button applicationUnderTestCancelButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 11-Click on button g.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 12-Click on link signOut - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 13-Click on button settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 14-Click on link signOut - Navigate to page organizationsettingstruetest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 15-Click on link firstProjectAi - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 16-Click on link settings - Navigate to page teamprojecttruetestuser-journeys.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 17-Click on button viewDetails - Navigate to page teamprojecttruetestuser-journeysaut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 18-Click on div verifyLoginWithMailOtponHomePageNth0.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 19-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 20-Click on button object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 21-Click on button showDetailFlowPanel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 22-Click on button showDetailFlowPanel2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 23-Click on button showDetailFlowPanel3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 24-Click on button object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 25-Click on button object4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 26-Click on button object5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 27-Click on button object6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 28-Click on button object7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 29-Click on button object8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 30-Click on div verifyNpccreviewAccessFromPresalesPageNth0.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 31-Click on button object9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 32-Click on button showDetailFlowPanel4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 33-Click on button showDetailFlowPanel5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 34-Click on button object10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 35-Click on button object11.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 36-Click on p searchPartsUsingQuick.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 37-Click on p submitDecisionForNpcc.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 38-Click on p addEnquiryForNpcconHome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 39-Click on p verifyHeaderObjectAndLoginOnHomePage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 40-Click on p verifyHeaderObjectAndLoginAgainOnHomePage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 41-Click on button goToNextPage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 42-Click on div openServiceSearchFromPresalesPageNth0.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 43-Click on button expandGraphBtn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 44-Click on body object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 45-Click on item flowsWithoutTestCases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC39/Step 46-Click on body object - Navigate to page .png')

"Step 47: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC39-Verify User Journey and Access Management_visual_checkpoint')
