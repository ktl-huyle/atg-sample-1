...
"Step 2: Click on div qualityEngineerDetails (QualityEngineer) -> Navigate to page 'organization/*/home'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/welcome?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_welcome/div_qualityEngineerDetails'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Navigate Through User Details and Home Page_visual_checkpoint')
