...
"Step 2: Click on pre failedTestReports (ErrorMessage)"
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 2-Click on pre failedTestReports ErrorMessage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-View Failed Execution Reports and Home Page Verification_visual_checkpoint')
