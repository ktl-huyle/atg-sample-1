...
"Step 6: Create a new API key for accessing application features"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Manage API Keys and Verify Logout_visual_checkpoint')
