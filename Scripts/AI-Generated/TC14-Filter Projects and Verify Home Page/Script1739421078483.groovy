...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_MoreProjects'))

WebUI.takeScreenshot(reportLocation + '/TC14/Step 6-Click on link MoreProjects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 8-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 9-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 10-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 11-Click on button customActions CustomAction2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 12-Click on button customActions CustomAction2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 13-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 14-Click on pre WebElementTooltip.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 16-Click on button showSlides ShowSlide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 17-Click on button showSlides ShowSlide2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 18-Click on button showSlides ShowSlide3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 19-Click on button showSlides ShowSlide4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 20-Click on button showSlides ShowSlide5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 21-Click on button showSlides ShowSlide6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 22-Click on button showSlides ShowSlide7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 23-Click on button showSlides ShowSlide8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 24-Click on button showSlides ShowSlide9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 28-Click on div CustomContent - Navigate to page .png')

"Step 29: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC14-Filter Projects and Verify Home Page_visual_checkpoint')
