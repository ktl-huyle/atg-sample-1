...
WebUI.takeScreenshot(reportLocation + '/TC88/Step 5-Click on link fileReports FileReport2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC88-Re run Files in Team Project Executions_visual_checkpoint')
