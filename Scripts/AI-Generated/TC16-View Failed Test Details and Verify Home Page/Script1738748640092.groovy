...
"Step 10: Click on div failedTestCaseDetails (FailedTestCaseInfo)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCaseDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCaseDetails', ['div_failedTestCaseDetails_class': div_failedTestCaseDetails_class, 'div_failedTestCaseDetails_internalRoleButtonName': div_failedTestCaseDetails_internalRoleButtonName]))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 10-Click on div failedTestCaseDetails FailedTestCaseInfo.png')

"Step 11: Click on div failedTestCaseDetails (FailedPreRequisiteBranchOpen)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCaseDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCaseDetails', ['div_failedTestCaseDetails_class': div_failedTestCaseDetails_class_1, 'div_failedTestCaseDetails_internalRoleButtonName': div_failedTestCaseDetails_internalRoleButtonName_1]))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 11-Click on div failedTestCaseDetails FailedPreRequisiteBranchOpen.png')
...
"Step 14: Click on div failedTestDetails (FailedPreRequisiteBranchOpen2)"
...
WebUI.takeScreenshot(reportLocation + '/TC16/Step 14-Click on div failedTestDetails FailedPreRequisiteBranchOpen2.png')

"Step 15: Click on div failedTestCaseDetails (FailedPreRequisiteBranchOpen3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCaseDetails"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestCaseDetails', ['div_failedTestCaseDetails_class': div_failedTestCaseDetails_class_2, 'div_failedTestCaseDetails_internalRoleButtonName': div_failedTestCaseDetails_internalRoleButtonName_2]))

WebUI.takeScreenshot(reportLocation + '/TC16/Step 15-Click on div failedTestCaseDetails FailedPreRequisiteBranchOpen3.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC16-View Failed Test Details and Verify Home Page_visual_checkpoint')
