...
WebUI.takeScreenshot(reportLocation + '/TC101/Step 4-Click on div automationSpecialist AutomationSpecialist - Navigate to page homecreate-organization.png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC101-Verify Organization Creation from Welcome Page_visual_checkpoint')
