...
"Step 4: Click on div failedExecutionDetails (FailedTest)"
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 4-Click on div failedExecutionDetails FailedTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 5-Click on link TestResult - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 6-Click on item object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 7-Click on item object2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 8-Click on link Page2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 9-Click on link TestRuns5 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 10-Click on link TestRuns4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 11-Click on link executionLinks TestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 12-Click on link testRunLinks TestRun2 - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 13-Click on td testCases TestCases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 14-Click on div object - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 15-Click on link testRunLinks TestRun3 - Navigate to page teamprojectexecutions.png')

"Step 16: Click on pre errorMessages (FailedTest)"
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 16-Click on pre errorMessages FailedTest.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 17-Click on link object - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 18-Click on item object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 19-Click on pre TestStep.png')
...
WebUI.takeScreenshot(reportLocation + '/TC313/Step 20-Click on pre TestStep - Navigate to page .png')

"Step 21: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC313-View and Navigate Test Execution Results_visual_checkpoint')
