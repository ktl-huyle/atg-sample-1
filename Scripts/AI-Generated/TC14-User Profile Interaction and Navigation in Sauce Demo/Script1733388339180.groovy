...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 4-Click on div dynamicObject - Navigate to page organizationhome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 5-Click on button userProfile userProfile2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 7-Click on div Object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC14/Step 8-Click on div Object2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC14-User Profile Interaction and Navigation in Sauce Demo_visual_checkpoint')
