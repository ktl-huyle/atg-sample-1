...
"Step 4: Click on link participantManagement (participantManagement12) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on link participantManagement participantManagement12 - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteActions', ['link_testSuiteActions_internalRoleLinkName': link_testSuiteActions_internalRoleLinkName, 'test_suites_id': test_suites_id, 'team_id': team_id_2, 'project_id': project_id_2]))
