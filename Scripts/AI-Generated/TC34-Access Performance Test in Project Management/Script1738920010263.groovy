...
WebUI.takeScreenshot(reportLocation + '/TC34/Step 2-Click on link PerformanceTest - Navigate to page project managementteamprojectgridplanjob.png')

"Step 3: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC34-Access Performance Test in Project Management_visual_checkpoint')
