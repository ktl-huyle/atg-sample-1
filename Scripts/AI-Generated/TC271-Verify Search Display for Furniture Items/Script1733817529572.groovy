...
WebUI.takeScreenshot(reportLocation + '/TC271/Step 4-Click on button close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC271/Step 5-Click on button ShowMore.png')
...
WebUI.takeScreenshot(reportLocation + '/TC271/Step 6-Click on link ClassroomSelect - Navigate to page SearchDisplay.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_SearchDisplay/p_productDescriptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_SearchDisplay/p_productDescriptions', ['p_productDescriptions_internalText': p_productDescriptions_internalText]))

WebUI.takeScreenshot(reportLocation + '/TC271/Step 7-Click on p productDescriptions PhonicsFactoryDescription.png')
...
WebUI.takeScreenshot(reportLocation + '/TC271/Step 8-Click on link ClassroomSelectScienceTable - Navigate to page .png')
...
WebUI.takeScreenshot(reportLocation + '/TC271/Step 9-Click on button ShowMore2 - Navigate to page SearchDisplay.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC271-Verify Search Display for Furniture Items_visual_checkpoint')
