...
"Step 4: Click on span FailedSortAndFilter"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_FailedSortAndFilter'))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 4-Click on span FailedSortAndFilter.png')

"Step 5: Click on span FailedSortAndFilter"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions/span_FailedSortAndFilter'))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 5-Click on span FailedSortAndFilter.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-View and Analyze Test Result Details in Executions_visual_checkpoint')
