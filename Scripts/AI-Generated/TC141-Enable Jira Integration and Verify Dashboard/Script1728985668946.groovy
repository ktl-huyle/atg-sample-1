...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 2-Click on link projectLinks SC Synergy Care Manager - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 3-Click on button EnableJiraIntegration - Navigate to page teamprojectintegrations.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 4-Click on link Jira add on.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 5-Click on link Jira add on.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 6-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 7-Click on div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 8-Click on input serverUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 9-Enter input value in input serverUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 10-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 11-Enter input value in input serverUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 12-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 13-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 14-Click on input username.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 15-Click on div object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 16-Click on div RowContainer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 17-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 18-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 19-Click on div ZeroCount.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 20-Click on div NewFailuresIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 21-Click on div NewFailuresIcon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 22-Click on link Tests3 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 23-Click on link Executions2 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 24-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 25-Click on link Tests2 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 26-Click on link TestSuites2 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 27-Click on span KatalonCloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 28-Click on span TreeSwitcher.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 29-Click on link SettingUpScriptRepository - Navigate to page teamprojectgit-test-projectsetup.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 30-Click on div CreateGitRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 32-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')

"Step 33: Click on span treeSwitcher (TreeSwitcher4)"
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 33-Click on span treeSwitcher TreeSwitcher4.png')

"Step 34: Click on span treeSwitcherIcons (TreeSwitcher5)"
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 34-Click on span treeSwitcherIcons TreeSwitcher5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 35-Click on link TestSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 36-Click on link Reports - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 37-Click on link Planning - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 38-Click on link Requirements - Navigate to page teamprojectrequirements.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 39-Click on button dynamicObject object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 40-Click on div object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 41-Click on button dynamicObject object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 42-Click on div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 43-Click on div Jira Issues.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 44-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 45-Click on div object3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 46-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 47-Click on div ReleaseReadiness.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 48-Click on td NoDataMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 49-Click on div DashboardRefresh.png')

"Step 50: Click on link Reports4 -> Navigate to page '/team/*/project/*/overview'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Reports4'))

WebUI.takeScreenshot(reportLocation + '/TC141/Step 50-Click on link Reports4 - Navigate to page teamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 51-Click on link Summary by Test Result - Navigate to page teamprojecttest-reportstest-executiontest-performance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 52-Click on link TestRuns - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 53-Click on link Run Frequency - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 54-Click on link FailedTestResults - Navigate to page teamprojectfailed-test-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 55-Click on link Defects - Navigate to page teamprojectdefects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 56-Click on link Visual Testing - Navigate to page teamprojectkatalon-eyes.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC141-Enable Jira Integration and Verify Dashboard_visual_checkpoint')
