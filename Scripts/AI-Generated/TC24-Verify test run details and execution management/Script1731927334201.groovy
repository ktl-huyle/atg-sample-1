...
"Step 5: Click on div testRunDetails (SGDPSp2)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 5-Click on div testRunDetails SGDPSp2.png')
...
"Step 10: Click on div testRunDetails (QRPay)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 10-Click on div testRunDetails QRPay.png')

"Step 11: Click on div testRunDetails (TCCheckTransactionHistory)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 11-Click on div testRunDetails TCCheckTransactionHistory.png')

"Step 12: Click on div testRunDetails (TCCheckTransactionHistory2)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 12-Click on div testRunDetails TCCheckTransactionHistory2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Verify test run details and execution management_visual_checkpoint')
