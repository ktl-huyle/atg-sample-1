import truetest.common.viewAndCloseMultipleThumbnailImages
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 4-Click on header testRunDetails UntitledTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 5-Click on button SessionsTab3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 6-Click on div TotalTests.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 7-Click on i Icon.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 8-Click on button FailedTestResults2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 9-Click on button SessionsTab3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 10-Click on button Sessions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 11-Click on div TotalTests.png')

"Step 12: Click on div testRunUntitled (UntitledTestRun4)"
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 12-Click on div testRunUntitled UntitledTestRun4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 13-Click on button CloseButton.png')

"Step 14: Click on div testRunElements (UntitledTestRunDetails)"
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 14-Click on div testRunElements UntitledTestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 15-Click on div noDataDisplay NoDataDisplay.png')

"Step 16: Click on div testRunElements (UntitledTestRunDetails)"
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 16-Click on div testRunElements UntitledTestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 17-Click on button CloseButton.png')

"Step 18: Click on div testRunElements (UntitledTestRunDetails)"
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 18-Click on div testRunElements UntitledTestRunDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 19-Click on button Details - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 20-Click on link TestResults2 - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 21-Click on div FailedSignin.png')

"Step 22: View multiple thumbnail images and close the viewer repeatedly"

viewAndCloseMultipleThumbnailImages.execute()
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 23-Click on button testResultDetails TestResultDetails - Navigate to page test resultteamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 24-Click on div thumbnailImages ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 25-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 26-Click on div FilePreview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 27-Click on div thumbnailImages ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 28-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 29-Click on image FileImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 30-Click on div GalleryView.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 31-Click on div FilePreview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 32-Click on div ObjectRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 33-Click on link Requests - Navigate to page test requeststeamprojectexecutionstest-resultrequests.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 34-Click on link TestObjects - Navigate to page test objectsteamprojectexecutionstest-resulttest-objects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 35-Click on link SimilarFailures - Navigate to page test result analysisteamprojectexecutionstest-resultsimilar-failures.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 36-Click on link Comments - Navigate to page comments sectionteamprojectexecutionstest-resultcomments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 37-Click on link ReRuns - Navigate to page test result re runsteamprojectexecutionstest-resultre-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 38-Click on time FailedSigninReRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 39-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 40-Click on div FilePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 41-Click on div Attachments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 42-Click on div ThumbnailImage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 43-Click on div FilePreviewMessage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 44-Click on div FilePreviewMessage2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 45-Click on div FilePreviewMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 46-Click on link Result - Navigate to page test resultteamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 47-Click on div ErrorMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 48-Click on label Maintainer - Navigate to page team project executionsteamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 49-Click on div FailedSignin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 50-Click on link UnknownLink - Navigate to page test resultteamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 51-Click on div NoDefectLinked.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 52-Click on div ObjectRepository2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 53-Click on div ObjectRepositoryImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC168/Step 54-Click on div thumbnailImages ThumbnailImage2 - Navigate to page .png')

"Step 55: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC168-View and manage failed test results and images in test executions_visual_checkpoint')
