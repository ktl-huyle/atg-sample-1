...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 2-Click on link projectDetails FirstProject - Navigate to page team projectteamproject.png')

"Step 3: Click on link Executions3 -> Navigate to page 'team project detail#team/*/project/*/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Executions3'))

WebUI.takeScreenshot(reportLocation + '/TC21/Step 3-Click on link Executions3 - Navigate to page team project detailteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 4-Click on button ScheduleTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 5-Click on div SelectEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 6-Click on item MoreOptions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 7-Click on span CreatedWith.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 8-Click on span CreatedWithSketch.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 9-Click on div CreatedWithSketch.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 10-Click on div CreatedWithSketch2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 11-Click on div CreatedWithSketch3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 12-Click on div CreatedWithSketch4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 13-Click on div CreatedWithSketch3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 14-Click on div CreatedWithSketch4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 15-Click on div CreatedWithSketch3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 16-Click on div CreatedWithSketch5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 17-Click on div CreatedWithSketch4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 18-Click on div ConfigureTestEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 19-Click on div ConfigureTestEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 20-Click on div ConfigureTestEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 21-Click on div ConfigureTestEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 22-Click on button Cancel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 23-Click on div ReactSelectControl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 24-Click on item MoreOptions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 25-Click on div LocalEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 26-Click on div ReactSelectValue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 27-Click on div ReactSelectValue2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 28-Click on div KubernetesEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 29-Click on div LocalEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 30-Click on div ConfigureTestEnvironment.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 31-Click on button Cancel.png')
...
WebUI.takeScreenshot(reportLocation + '/TC21/Step 32-Click on button CloseDialog - Navigate to page .png')

"Step 33: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC21-Schedule Test Run and Configure Environments_visual_checkpoint')
