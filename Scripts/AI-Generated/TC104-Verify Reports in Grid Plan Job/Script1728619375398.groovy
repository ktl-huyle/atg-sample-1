...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 4-Click on button jobActions LinkToRelease.png')
...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 5-Click on span R5Maintenance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 6-Click on button jobActions Run2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC104/Step 7-Click on link Reports - Navigate to page teamproject.png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC104-Verify Reports in Grid Plan Job_visual_checkpoint')
