...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 4-Click on button TestResultDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC27/Step 5-Click on button TestResultDetails2 - Navigate to page teamprojectexecutionstest-result.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC27-View Test Result Details and Verify Page_visual_checkpoint')
