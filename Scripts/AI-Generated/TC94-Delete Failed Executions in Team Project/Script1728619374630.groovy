...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 4-Click on button FailedExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 5-Click on button DeleteExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 6-Click on button Delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 7-Click on button FailedExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 8-Click on button DeleteExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 9-Click on button Delete.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 10-Click on div ExecutionDoneMessage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 11-Click on div DashboardLink.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 12-Click on div LeftNavbarImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 13-Click on div dashboard.png')
...
WebUI.takeScreenshot(reportLocation + '/TC94/Step 14-Click on div dashboard2.png')

"Step 15: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC94-Delete Failed Executions in Team Project_visual_checkpoint')
