...
"Step 9: Click on button userAPIKey (UserObject)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 9-Click on button userAPIKey UserObject.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-API Key Creation and User Logout_visual_checkpoint')
