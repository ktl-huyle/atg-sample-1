...
WebUI.takeScreenshot(reportLocation + '/TC192/Step 4-Click on div WelcomeMessage2.png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC192-Verify Welcome Message and Home Page_visual_checkpoint')
