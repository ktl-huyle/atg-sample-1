...
"Step 4: Click on div failedExecutions (FailedED1451AuthOnly) -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on div failedExecutions FailedED1451AuthOnly - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Sort Team Project Executions and Verify Home Page_visual_checkpoint')
