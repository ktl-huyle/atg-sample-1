...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 2-Click on link projectLinks SC SynergyCareManager - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 3-Click on button EnableJiraIntegration - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 4-Click on link JiraAddOn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 5-Click on link JiraAddOn.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 6-Click on div YouNeedToFillInAll.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 7-Click on div Column12.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 8-Click on input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 9-Enter input value in input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 10-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 11-Enter input value in input ServerUrl.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 12-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 13-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 14-Click on input Username.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 15-Click on div PasswordJiraServer.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 16-Click on div Row.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 17-Click on link Planning2 - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 18-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 19-Click on div Zero.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 20-Click on div NewFailures.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 21-Click on div NewFailures.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 22-Click on link Tests4 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 23-Click on link Executions4 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 24-Click on link Planning2 - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 25-Click on link Tests3 - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 26-Click on link TestSuites2 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 27-Click on span KatalonCloud.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 28-Click on span treeSwitchers TreeSwitcher2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 29-Click on link SettingUpScriptRepository - Navigate to page teamprojectgit-test-projectsetup.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 30-Click on div CreateNewGitRepository.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 32-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_cases/span_treeSwitchers_2', ['span_treeSwitchers_divNthChild': span_treeSwitchers_divNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC181/Step 33-Click on span treeSwitchers TreeSwitcher16.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 34-Click on span treeSwitchers TreeSwitcher17.png')

"Step 35: Click on link TestSuites3 -> Navigate to page 'team/*/project/*/test-design/test-suites'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-design/test-cases?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_design_test_cases/link_TestSuites3_2'))

WebUI.takeScreenshot(reportLocation + '/TC181/Step 35-Click on link TestSuites3 - Navigate to page teamprojecttest-designtest-suites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 36-Click on link Reports - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 37-Click on link Planning3 - Navigate to page teamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 38-Click on link Requirements2 - Navigate to page teamproject.png')

"Step 39: Click on button closeActions (CloseButton)"
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 39-Click on button closeActions CloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 40-Click on div UnderTopNavbar.png')

"Step 41: Click on button closeActions (CloseButton2)"
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 41-Click on button closeActions CloseButton2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 42-Click on div JiraIssues.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 43-Click on div JiraIssues2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 44-Click on span settings Settings2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 45-Click on div dynamicObject MuiBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 46-Click on link Dashboard - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 47-Click on div ReleaseReadiness.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 48-Click on td NoDataToDisplay.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 49-Click on div DashboardRefresh.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 50-Click on link Reports5 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 51-Click on link SummaryByTestResult - Navigate to page teamprojecttest-reportstest-executiontest-performance.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 52-Click on link TestRuns - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 53-Click on link RunFrequency2 - Navigate to page teamprojecttest-reportstest-executionfrequency-report.png')
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 54-Click on link FailedTestResultsBeta - Navigate to page teamproject.png')

"Step 55: Click on link navigationLinks (Defects)"
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 55-Click on link navigationLinks Defects.png')

"Step 56: Click on link navigationLinks (VisualTesting)"
...
WebUI.takeScreenshot(reportLocation + '/TC181/Step 56-Click on link navigationLinks VisualTesting.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC181-Enable Jira Integration and Configure Settings_visual_checkpoint')
