...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteOptions_1', ['project_id': project_id, 'team_id': team_id, 'executions_id': executions_id]))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 5-Click on link testSuiteOptions CPACDECPreapprovalBindTestSuite - Navigate to page teamprojectexecutions.png')
