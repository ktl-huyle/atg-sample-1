...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 4-Click on div object2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 5-Click on div testRunStatus.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 6-Click on span settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC36/Step 7-Click on link userManagement - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC36-Access User Management and Verify Home Page_visual_checkpoint')
