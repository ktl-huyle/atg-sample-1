...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 4-Click on button userProfile userProfile3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 7-Click on span settingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 9-Click on span settingsButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 10-Click on link navigation navigation2.png')

"Step 11: Click on div objectItems (objectItems2) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC33/Step 11-Click on div objectItems objectItems2 - Navigate to page teamproject.png')

"Step 12: Click on link Executions42 -> Navigate to page 'team/*/project/*/test-runs'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Executions42'))

WebUI.takeScreenshot(reportLocation + '/TC33/Step 12-Click on link Executions42 - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC33-Manage User Profile and Verify Home Page_visual_checkpoint')
