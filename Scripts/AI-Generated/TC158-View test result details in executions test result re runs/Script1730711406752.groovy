...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 4-Click on button TestResultDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 5-Click on button TestResultDetails2 - Navigate to page teamprojectexecutionstest-result.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC158-View test result details in executions test result re runs_visual_checkpoint')
