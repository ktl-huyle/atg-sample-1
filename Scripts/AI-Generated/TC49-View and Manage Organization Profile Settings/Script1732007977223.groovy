...
"Step 8: Click on button organizationActions (OrganizationAdmin)"
...
WebUI.takeScreenshot(reportLocation + '/TC49/Step 8-Click on button organizationActions OrganizationAdmin.png')

"Step 9: Click on button organizationActions (OrganizationAdmin2)"
...
WebUI.takeScreenshot(reportLocation + '/TC49/Step 9-Click on button organizationActions OrganizationAdmin2.png')
...
"Step 11: Click on button organizationActions (OrganizationAdmin)"
...
WebUI.takeScreenshot(reportLocation + '/TC49/Step 11-Click on button organizationActions OrganizationAdmin.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC49-View and Manage Organization Profile Settings_visual_checkpoint')
