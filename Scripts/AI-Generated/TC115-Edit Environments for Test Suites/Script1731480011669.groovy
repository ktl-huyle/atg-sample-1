...
"Step 4: Configure environments for test suites and save changes"

configureTestSuitesEnvironmentsAndSave.execute()

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC115-Edit Environments for Test Suites_visual_checkpoint')
