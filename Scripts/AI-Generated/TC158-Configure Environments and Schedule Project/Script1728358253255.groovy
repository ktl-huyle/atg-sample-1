...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 4-Click on button projectActions Edit.png')
...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 5-Click on link ConfigureEnvironments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 6-Click on div ActiveTunnels.png')
...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 7-Click on div UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 8-Click on button Save.png')
...
WebUI.takeScreenshot(reportLocation + '/TC158/Step 9-Click on button Schedule - Navigate to page teamproject.png')

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC158-Configure Environments and Schedule Project_visual_checkpoint')
