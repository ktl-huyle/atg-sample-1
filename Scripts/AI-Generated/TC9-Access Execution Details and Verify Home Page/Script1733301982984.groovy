...
"Step 4: Click on link projectDetails (projectDetails2) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4-Click on link projectDetails projectDetails2 - Navigate to page teamproject.png')
...
"Step 7: Click on div testRunItems (testRunItems5)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7-Click on div testRunItems testRunItems5.png')
...
"Step 10: Click on div testRunItems (testRunItems6)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 10-Click on div testRunItems testRunItems6.png')
...
"Step 19: Click on div SelectTestSuite2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_SelectTestSuite2'))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 19-Click on div SelectTestSuite2.png')
...
"Step 31: Click on button sessionActions (sessionActions)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 31-Click on button sessionActions sessionActions.png')

"Step 32: Click on div sortOptions (sortOptions2)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 32-Click on div sortOptions sortOptions2.png')

"Step 33: Click on div historyItems (historyItems)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 33-Click on div historyItems historyItems.png')
...
"Step 35: Click on div untitledTestRuns (untitledTestRuns)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 35-Click on div untitledTestRuns untitledTestRuns.png')
...
"Step 38: Click on link fileDownload (HTMLFile)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_files/link_fileDownload', ['link_fileDownload_trNthChild': link_fileDownload_trNthChild]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 38-Click on link fileDownload HTMLFile.png')
...
"Step 42: Click on link pageNavigation (pageNavigation)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 42-Click on link pageNavigation pageNavigation.png')

"Step 43: Click on link pageNavigation (pageNavigation2)"
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 43-Click on link pageNavigation pageNavigation2.png')

"Step 44: Click on link fileDownload (fileDownload) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/files?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions_files/link_fileDownload"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_files/link_fileDownload', ['link_fileDownload_trNthChild': link_fileDownload_trNthChild_1]))

WebUI.takeScreenshot(reportLocation + '/TC9/Step 44-Click on link fileDownload fileDownload - Navigate to page .png')

"Step 45: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Access Execution Details and Verify Home Page_visual_checkpoint')
