...
"Step 4: Click on link testSuites (CPACDECPreapproval) -> Navigate to page 'team/*/project/*/test-design/test-suites/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_testSuites', ['link_testSuites_internalRoleLinkName': link_testSuites_internalRoleLinkName, 'test_suites_id': test_suites_id, 'project_id': project_id, 'team_id': team_id]))

WebUI.takeScreenshot(reportLocation + '/TC23/Step 4-Click on link testSuites CPACDECPreapproval - Navigate to page teamprojecttest-designtest-suites.png')

"Step 5: Click on link testSuites (CPACDECPreapprovalBindTestSuite2) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC23/Step 5-Click on link testSuites CPACDECPreapprovalBindTestSuite2 - Navigate to page teamprojectexecutions.png')
