...
"Step 4: Click on button organizationActions (AI)"
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 4-Click on button organizationActions AI.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 5-Click on link ViewProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 6-Click on div Backdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 7-Click on div OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 8-Click on button organizationAdminActions OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 9-Click on button organizationAdminActions OrganizationAdmin2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 10-Click on div TopLeftNavbar.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 11-Click on button organizationAdminActions OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 12-Click on link organizationLinks OrganizationAdmin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC141/Step 13-Click on link ViewAllProjects - Navigate to page .png')

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC141-View organization profile and verify home page_visual_checkpoint')
