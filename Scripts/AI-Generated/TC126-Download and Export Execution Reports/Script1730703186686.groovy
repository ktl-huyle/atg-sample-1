...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 4-Click on link projectLinks FirstProject2 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 5-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 6-Click on link Executions - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 7-Click on div testRunDetails UntitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 8-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 9-Click on link Files - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 10-Click on div testRunDetails UntitledTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 11-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 12-Click on link Files2 - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 13-Click on link Executions.png')
...
"Step 15: Click on button sessionActions (Sessions)"
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 15-Click on button sessionActions Sessions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 16-Click on div sortingInfo SortInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 17-Click on div historyInfo HistoryInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 18-Click on div TestExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 19-Click on div testRunDetails UntitledTestRun3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 20-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 21-Click on link Files3 - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 22-Click on link reportLinks FileReport.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 23-Click on button DownloadFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 24-Click on button CompressFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 25-Click on link ExportExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 26-Click on link pageLinks Page2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 27-Click on link pageLinks Page3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC126/Step 28-Click on link reportLinks HTMLReport - Navigate to page .png')

"Step 29: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC126-Download and Export Execution Reports_visual_checkpoint')
