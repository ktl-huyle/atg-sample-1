...
"Step 2: Click on div testRunCells (ParallelSuite)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Click on div testRunCells ParallelSuite.png')

"Step 3: Click on div testRunCells (ParallelSuite2)"
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on div testRunCells ParallelSuite2.png')

"Step 4: Click on div testRunCells (ParallelSuite3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunCells"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunCells', ['div_testRunCells_internalRoleCellName': div_testRunCells_internalRoleCellName_2]))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on div testRunCells ParallelSuite3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on button JobReady.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on div OrganizationButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Click on link ViewAllProjects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 8-Click on div CurrentReadyTech.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 9-Click on link JRJobReady - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 10-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 11-Click on link OrganizationManagement - Navigate to page settingsteamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 12-Click on p ReadyCase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 13-Click on input UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 14-Enter input value in input UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 15-Click on div ProjectProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 16-Click on input TimezoneConfig.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 17-Click on div EnableBDDReports.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 18-Click on div MuiInputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 19-Click on span Settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 20-Click on div MuiBackdrop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 21-Click on div MuiInputBase.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 22-Enter input value in input UserEmail.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 23-Click on div TeamReadyCase - Navigate to page .png')

"Step 24: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Navigate to Team Project Details and Configure Settings_visual_checkpoint')
