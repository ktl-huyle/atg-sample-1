...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Click on button addToCart AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on button addToCart AddToCart2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on label TB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on label Black.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 6-Click on label White.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 7-Click on label 512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 8-Click on label 256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 9-Click on label Black2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 11-Click on link GoToCart - Navigate to page cartcart.png')
...
"Step 13: Enter shipping details and proceed to payment to complete order."

fillShippingDetailsAndCompleteOrder.execute(data_path_0, Integer.valueOf(index_0))

"Step 14: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Add Multiple Products to Cart and Complete Order_visual_checkpoint')
