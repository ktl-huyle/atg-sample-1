...
"Step 3: Click on label colorStorageOption (Storage256GB)"
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Click on label colorStorageOption Storage256GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6-Click on link PlaceOrder - Navigate to page cart.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Complete Purchase Flow for SauceDemo with Shipping and Payment Details_visual_checkpoint')
