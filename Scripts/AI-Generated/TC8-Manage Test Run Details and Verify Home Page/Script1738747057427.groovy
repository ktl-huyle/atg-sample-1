...
"Step 6: Click on div testRunComponents (UntitledTestRun)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunComponents"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunComponents', ['div_testRunComponents_internalRoleCellName': div_testRunComponents_internalRoleCellName]))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 6-Click on div testRunComponents UntitledTestRun.png')

"Step 7: Click on div testRunComponents (UntitledTestRun2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunComponents"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunComponents', ['div_testRunComponents_internalRoleCellName': div_testRunComponents_internalRoleCellName_1]))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 7-Click on div testRunComponents UntitledTestRun2.png')

"Step 8: Click on header testRunInfo (UntitledTestRun2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/header_testRunInfo"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/header_testRunInfo', ['header_testRunInfo_internalRoleHeadingName': header_testRunInfo_internalRoleHeadingName]))

WebUI.takeScreenshot(reportLocation + '/TC8/Step 8-Click on header testRunInfo UntitledTestRun2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Manage Test Run Details and Verify Home Page_visual_checkpoint')
