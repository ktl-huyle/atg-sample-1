...
"Step 2: Click on div failedTestCases (FailedTest)"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 2-Click on div failedTestCases FailedTest.png')
...
"Step 14: Click on pre failedTestCases (FailedTest)"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 14-Click on pre failedTestCases FailedTest.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Check Test Results from Failed Test Cases_visual_checkpoint')
