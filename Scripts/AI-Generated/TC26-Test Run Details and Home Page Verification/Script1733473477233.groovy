...
"Step 4: Click on div testRunDetails (object2)"
...
WebUI.takeScreenshot(reportLocation + '/TC26/Step 4-Click on div testRunDetails object2.png')

"Step 5: Click on div object3 -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_object3'))

WebUI.takeScreenshot(reportLocation + '/TC26/Step 5-Click on div object3 - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC26-Test Run Details and Home Page Verification_visual_checkpoint')
