...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 4-Click on input rowSelection SelectRowCheckbox.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 5-Click on input rowSelection SelectRowCheckbox2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 6-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 7-Click on button Confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 8-Click on input rowSelection SelectRowCheckbox3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 9-Click on input rowSelection SelectRowCheckbox4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 10-Click on input rowSelection SelectRowCheckbox5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 11-Click on button Terminate2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 12-Click on button Confirm.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 13-Click on input rowSelection SelectRowCheckbox6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 14-Click on button Terminate.png')
...
WebUI.takeScreenshot(reportLocation + '/TC138/Step 15-Click on button Confirm - Navigate to page .png')

"Step 16: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC138-Terminate multiple test runs in team project_visual_checkpoint')
