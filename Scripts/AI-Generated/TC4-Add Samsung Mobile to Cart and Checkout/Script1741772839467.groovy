...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 2-Click on link Samsung2 - Navigate to page product categories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on button addToCart AddToCart.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Click on label 512GB.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 5-Click on label Blue.png')
...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 7-Click on link GoToCart - Navigate to page cartcart.png')
...
"Step 9: Enter email and fill in shipping details before completing the order."

enterEmailAndFillShippingDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 10: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Add Samsung Mobile to Cart and Checkout_visual_checkpoint')
