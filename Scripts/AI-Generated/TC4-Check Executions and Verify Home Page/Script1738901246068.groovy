...
WebUI.takeScreenshot(reportLocation + '/TC4/Step 3-Click on header testRunDetails EPPsAutomationTest.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Check Executions and Verify Home Page_visual_checkpoint')
