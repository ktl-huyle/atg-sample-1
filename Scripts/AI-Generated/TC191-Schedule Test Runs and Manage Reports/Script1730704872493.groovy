...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 4-Click on link projectLinks FirstProject2 - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 5-Click on link Tests - Navigate to page teamprojecttest-designtest-cases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 6-Click on link Executions2 - Navigate to page teamprojecttest-runs.png')

"Step 7: Click on div testRunInfo (UntitledTestRun)"
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 7-Click on div testRunInfo UntitledTestRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 8-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 9-Click on link Files - Navigate to page teamprojecttest-runs.png')

"Step 10: Click on div testRunInfo (UntitledTestRun2)"
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 10-Click on div testRunInfo UntitledTestRun2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 11-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 12-Click on link Files2 - Navigate to page teamprojectexecutionsfiles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 13-Click on link Executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 15-Click on button sessionControls Sessions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 16-Click on div sortingInfo SortInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 17-Click on div historyInfo HistoryInfo.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 18-Click on div TestExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 19-Click on div testRunDetails UntitledTestRun3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 20-Click on button Details - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 21-Click on link Files3 - Navigate to page teamprojectexecutionsfiles.png')

"Step 22: Click on link fileReports (FileReport)"
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 22-Click on link fileReports FileReport.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 23-Click on button DownloadFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 24-Click on button CompressFile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 25-Click on link ExportExecution.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 26-Click on link pageLinks Page2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC191/Step 27-Click on link pageLinks Page3.png')

"Step 28: Click on link fileReports (HTMLReport) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/files?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions_files/link_fileReports"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions_files/link_fileReports', ['link_fileReports_trNthChild': link_fileReports_trNthChild_1]))

WebUI.takeScreenshot(reportLocation + '/TC191/Step 28-Click on link fileReports HTMLReport - Navigate to page .png')

"Step 29: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC191-Schedule Test Runs and Manage Reports_visual_checkpoint')
