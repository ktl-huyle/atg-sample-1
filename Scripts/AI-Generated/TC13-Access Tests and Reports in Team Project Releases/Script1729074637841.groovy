...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on link Tests - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 5-Click on link Reports2 - Navigate to page team project releasesteamprojectreleases.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on link Tests - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 7-Click on link Reports2 - Navigate to page team project overviewteamprojectoverview.png')
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 8-Click on link TestRuns2 - Navigate to page team project executionsteamprojectexecutions.png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Access Tests and Reports in Team Project Releases_visual_checkpoint')
