...
"Step 18: Click on div urlLinks (URLLink)"
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 18-Click on div urlLinks URLLink.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_organization_settings_truetest/link_projectLinks"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_settings_truetest/link_projectLinks', ['link_projectLinks_internalRoleLinkName': link_projectLinks_internalRoleLinkName_1, 'project_id': project_id_1, 'team_id': team_id_1]))
...
"Step 27: Click on p userJourneys (VerifyNavigationToHome)"
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 27-Click on p userJourneys VerifyNavigationToHome.png')
...
"Step 29: Click on p userJourneys (VerifyInternetBundles)"
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 29-Click on p userJourneys VerifyInternetBundles.png')
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 30-Click on button detailFlowPanels ShowDetails.png')
...
"Step 34: Click on p userJourneys (NavigateAndInteract)"
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 34-Click on p userJourneys NavigateAndInteract.png')
...
WebUI.takeScreenshot(reportLocation + '/TC52/Step 35-Click on button detailFlowPanels ShowDetailFlowPanel.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_detailFlowPanels"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_truetest_user_journeys_aut/button_detailFlowPanels', ['button_detailFlowPanels_class': button_detailFlowPanels_class_2, 'button_detailFlowPanels_divNthChild': button_detailFlowPanels_divNthChild_2]))

WebUI.takeScreenshot(reportLocation + '/TC52/Step 38-Click on button detailFlowPanels ShowDetailFlowPanel2 - Navigate to page .png')

"Step 39: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC52-Export User Journeys and Manage Flows in TrueTest_visual_checkpoint')
