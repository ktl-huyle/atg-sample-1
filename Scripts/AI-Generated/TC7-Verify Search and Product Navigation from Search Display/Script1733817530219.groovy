...
WebUI.setText(findTestObject('AI-Generated/Page_SearchDisplay/input_SearchTerm5'), input_SearchTerm2)

WebUI.takeScreenshot(reportLocation + '/TC7/Step 5-Enter input value in input SearchTerm2.png')

"Step 6: Click on link exclusiveItems (DryEraseMarkers9) -> Navigate to page '/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/SearchDisplay?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_SearchDisplay/link_exclusiveItems"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_SearchDisplay/link_exclusiveItems', ['link_exclusiveItems_internalRoleLinkName': link_exclusiveItems_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC7/Step 6-Click on link exclusiveItems DryEraseMarkers9 - Navigate to page .png')
