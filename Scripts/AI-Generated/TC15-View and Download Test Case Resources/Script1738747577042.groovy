...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 2-Click on pre failedTestCases ErrorMessage.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC15-View and Download Test Case Resources_visual_checkpoint')
