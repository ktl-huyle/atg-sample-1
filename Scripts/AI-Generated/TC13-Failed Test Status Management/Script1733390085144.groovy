...
"Step 4: Click on div failedTestRunClaims (FailedTestRun6)"
...
WebUI.takeScreenshot(reportLocation + '/TC13/Step 4-Click on div failedTestRunClaims FailedTestRun6.png')
...
"Step 6: Click on div failedTestRunClaims (FailedTestRun6) -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestRunClaims"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/div_failedTestRunClaims', ['div_failedTestRunClaims_class': div_failedTestRunClaims_class_1, 'div_failedTestRunClaims_internalRoleButtonName': div_failedTestRunClaims_internalRoleButtonName_1]))

WebUI.takeScreenshot(reportLocation + '/TC13/Step 6-Click on div failedTestRunClaims FailedTestRun6 - Navigate to page .png')
