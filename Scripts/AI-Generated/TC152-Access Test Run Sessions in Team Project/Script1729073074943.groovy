...
WebUI.takeScreenshot(reportLocation + '/TC152/Step 4-Click on link Executions3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC152/Step 5-Click on header testRunDetails EPPsAutomationTestCaseRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC152/Step 6-Click on button Sessions - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC152-Access Test Run Sessions in Team Project_visual_checkpoint')
