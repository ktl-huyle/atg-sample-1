...
WebUI.takeScreenshot(reportLocation + '/TC116/Step 4-Click on div WelcomeMessage.png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC116-Verify Welcome Page After Login_visual_checkpoint')
