...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 2-Click on span ProfileAll.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 3-Click on input FilterByProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 4-Enter input value in input FilterByProfile.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 5-Click on button Update.png')

"Step 6: Click on link moreProjects (MoreProjects)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project/link_moreProjects"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_moreProjects', ['link_moreProjects_internalRoleLinkName': link_moreProjects_internalRoleLinkName]))

WebUI.takeScreenshot(reportLocation + '/TC18/Step 6-Click on link moreProjects MoreProjects.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 7-Click on div CreatedWithSketchtool.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 8-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 9-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 10-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 11-Click on button customActions CustomAction2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 12-Click on button customActions CustomAction2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 13-Click on button customActions CustomAction.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 14-Click on pre WebElementTooltip.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 15-Click on div ThumbnailImage.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 16-Click on button showSlides ShowSlide.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 17-Click on button showSlides ShowSlide2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 18-Click on button showSlides ShowSlide3.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 19-Click on button showSlides ShowSlide4.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 20-Click on button showSlides ShowSlide5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 21-Click on button showSlides ShowSlide6.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 22-Click on button showSlides ShowSlide7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 23-Click on button showSlides ShowSlide8.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 24-Click on button showSlides ShowSlide9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 25-Click on button Close.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 26-Click on form ReportDefect.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 27-Click on div SummaryWebElement.png')
...
WebUI.takeScreenshot(reportLocation + '/TC18/Step 28-Click on div CustomContent - Navigate to page .png')

"Step 29: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC18-Filter and Manage Custom Actions in Team Project_visual_checkpoint')
