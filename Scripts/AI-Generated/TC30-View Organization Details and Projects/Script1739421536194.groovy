...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 2-Click on span DXCPracticeOracle.png')

"Step 3: Click on div currentOrganization (CurrentDP)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/div_currentOrganization', ['div_currentOrganization_internalHasText': div_currentOrganization_internalHasText]))

WebUI.takeScreenshot(reportLocation + '/TC30/Step 3-Click on div currentOrganization CurrentDP.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 4-Click on link organizationDetails OJOracleJDE - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 5-Click on button OracleJDE.png')
...
WebUI.takeScreenshot(reportLocation + '/TC30/Step 6-Click on link ViewAllProjects - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC30-View Organization Details and Projects_visual_checkpoint')
