...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project/link_testItems', ['link_testItems_nthChild': link_testItems_nthChild, 'path_param_5': path_param_5, 'path_param_6': path_param_6, 'team_id': team_id_1, 'project_id': project_id_1]))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites', ['link_testSuites_internalRoleLinkName': link_testSuites_internalRoleLinkName, 'path_param_5': path_param_5_1, 'path_param_6': path_param_6_1, 'team_id': team_id_2, 'project_id': project_id_2]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_details/link_testSuites', ['link_testSuites_internalRoleLinkName': link_testSuites_internalRoleLinkName_1, 'path_param_5': path_param_5_2, 'path_param_6': path_param_6_2, 'team_id': team_id_3, 'project_id': project_id_3]))
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlert"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlert', ['button_closeAlert_class': button_closeAlert_class]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 39-Click on button closeAlert Close.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlert"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_requirements/button_closeAlert', ['button_closeAlert_class': button_closeAlert_class_1]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 41-Click on button closeAlert AlertClose.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/link_calendarOptions"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/link_calendarOptions', ['link_calendarOptions_internalRoleLinkName': link_calendarOptions_internalRoleLinkName, 'path_param_5': path_param_5_3, 'team_id': team_id_4, 'project_id': project_id_4]))

WebUI.takeScreenshot(reportLocation + '/TC22/Step 56-Click on link calendarOptions VisualTesting - Navigate to page team projectteamproject.png')

"Step 57: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Jira Integration and Verify Project_visual_checkpoint')
