...
"Step 4: Click on link testCaseExecutions (ForumPosting) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC81/Step 4-Click on link testCaseExecutions ForumPosting - Navigate to page teamprojectexecutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC81/Step 5-Click on link TestRuns - Navigate to page teamproject.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC81-View Test Case Executions in Team Project_visual_checkpoint')
