...
WebUI.takeScreenshot(reportLocation + '/TC75/Step 4-Click on button object.png')
...
WebUI.takeScreenshot(reportLocation + '/TC75/Step 5-Click on button object2 - Navigate to page teamprojectexecutionstest-result.png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC75-Verify Test Result Re runs_visual_checkpoint')
