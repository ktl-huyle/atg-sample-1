...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 4-Click on link Executions7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 5-Click on link Executions7.png')

"Step 6: Click on link Schedules -> Navigate to page 'team project grid#team/{*}/project/{*}/grid'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/{.*}/project/{.*}/{.*}?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project/link_Schedules'))

WebUI.takeScreenshot(reportLocation + '/TC170/Step 6-Click on link Schedules - Navigate to page team project gridteamprojectgrid.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 7-Click on link Settings - Navigate to page team project settingsteamprojectsettings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 8-Click on link TestEnvironments - Navigate to page team project agentteamprojectagent.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 9-Click on link ScriptRepositories - Navigate to page team projectteamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC170/Step 10-Click on link Executions8.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC170-Verify Project Links and Test Environments_visual_checkpoint')
