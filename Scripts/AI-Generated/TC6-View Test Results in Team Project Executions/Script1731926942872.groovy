...
"Step 5: Click on link testSuiteOptions (CPACDECPreapprovalBindTestSuite) -> Navigate to page 'team/*/project/*/executions/*'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_design_test_suites/link_testSuiteOptions', ['link_testSuiteOptions_internalRoleRowName': link_testSuiteOptions_internalRoleRowName, 'executions_id': executions_id, 'team_id': team_id_1, 'project_id': project_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Click on link testSuiteOptions CPACDECPreapprovalBindTestSuite - Navigate to page teamprojectexecutions.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-View Test Results in Team Project Executions_visual_checkpoint')
