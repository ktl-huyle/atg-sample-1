...
"Step 6: Create a new API key for application access and manage settings"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC19-Create and Manage API Key Actions_visual_checkpoint')
