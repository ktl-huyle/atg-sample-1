...
"Step 2: Click on div testRunComponents (ParallelSuite)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 2-Click on div testRunComponents ParallelSuite.png')

"Step 3: Click on div testRunComponents (ParallelSuite2)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 3-Click on div testRunComponents ParallelSuite2.png')

"Step 4: Click on div testRunComponents (ParallelSuite3)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + 'team/.*/project/.*/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunComponents"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_detail/div_testRunComponents', ['div_testRunComponents_internalRoleCellName': div_testRunComponents_internalRoleCellName_2]))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on div testRunComponents ParallelSuite3.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Manage Test Run Components and Settings_visual_checkpoint')
