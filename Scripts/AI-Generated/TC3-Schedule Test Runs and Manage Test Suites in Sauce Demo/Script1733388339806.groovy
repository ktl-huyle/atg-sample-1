...
"Step 4: Click on link projectDetails (projectDetails) -> Navigate to page 'team/*/project/*'"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on link projectDetails projectDetails - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on link Executions3 - Navigate to page teamprojecttest-runs.png')
...
"Step 9: Click on link ClickHereToRefresh2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/link_ClickHereToRefresh2'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 9-Click on link ClickHereToRefresh2.png')

"Step 10: Click on div SelectTestSuite2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/div_SelectTestSuite2'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 10-Click on div SelectTestSuite2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 13-Click on link TestSuites2 - Navigate to page teamprojecttest-designtest-suites.png')

"Step 14: Click on div testSuiteItems (testSuiteItems)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 14-Click on div testSuiteItems testSuiteItems.png')

"Step 15: Click on div testSuiteItems (testSuiteItems2)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 15-Click on div testSuiteItems testSuiteItems2.png')

"Step 16: Click on div testSuiteItems (testSuiteItems3)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 16-Click on div testSuiteItems testSuiteItems3.png')

"Step 17: Click on div testSuiteItems (testSuiteItems4)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 17-Click on div testSuiteItems testSuiteItems4.png')

"Step 18: Click on div testSuiteItems (testSuiteItems5)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 18-Click on div testSuiteItems testSuiteItems5.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 22-Click on div TestSuites.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 26-Click on div SelectEnvironment2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 27-Click on div TestSuites2.png')
...
"Step 29: Click on div menuItems (menuItems)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/div_menuItems'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 29-Click on div menuItems menuItems.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 31-Click on div SelectValueContainer.png')
...
"Step 44: Click on button closeActions (closeActions)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 44-Click on button closeActions closeActions.png')

"Step 45: Click on button closeActions (closeActions2)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 45-Click on button closeActions closeActions2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 46-Click on div SubscribedTestCloudSessions.png')
...
"Step 48: Click on p sessionDetails (sessionDetails)"
...
WebUI.takeScreenshot(reportLocation + '/TC3/Step 48-Click on p sessionDetails sessionDetails.png')

"Step 49: Click on div menuItems (menuItems2)"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_test_runs/div_menuItems'))

WebUI.takeScreenshot(reportLocation + '/TC3/Step 49-Click on div menuItems menuItems2.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Schedule Test Runs and Manage Test Suites in Sauce Demo_visual_checkpoint')
