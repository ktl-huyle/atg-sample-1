...
WebUI.takeScreenshot(reportLocation + '/TC364/Step 4-Click on link executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC364/Step 5-Click on link executions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC364/Step 6-Click on link schedules - Navigate to page teamproject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC364/Step 7-Click on link settings.png')
...
WebUI.takeScreenshot(reportLocation + '/TC364/Step 8-Click on link projectNavigation testEnvironments.png')
...
WebUI.takeScreenshot(reportLocation + '/TC364/Step 9-Click on link projectNavigation scriptRepositories.png')
...
WebUI.takeScreenshot(reportLocation + '/TC364/Step 10-Click on link executions - Navigate to page teamprojecttest-runs.png')

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC364-Access Executions and Schedules in Team Project Test Runs_visual_checkpoint')
