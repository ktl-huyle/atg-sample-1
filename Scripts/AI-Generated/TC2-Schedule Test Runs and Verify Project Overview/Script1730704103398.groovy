...
"Step 4: Schedule a test run and select the testing environment."
...
"Step 13: Schedule a test run and select the testing environment."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Schedule Test Runs and Verify Project Overview_visual_checkpoint')
