...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on div failedExecutions FailedED - Navigate to page .png')

"Step 5: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Sorting and Navigation from Failed Executions to Home Page_visual_checkpoint')
