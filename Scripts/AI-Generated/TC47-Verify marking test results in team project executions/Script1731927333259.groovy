...
"Step 4: Mark test result as passed after execution"
...
"Step 18: Mark test result as passed after execution"
...
"Step 48: Click on link insightlyExecution (InsightlyExecution)"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_organization_home/link_insightlyExecution', ['link_insightlyExecution_internalRoleLinkName': link_insightlyExecution_internalRoleLinkName, 'team_id': team_id, 'project_id': project_id, 'executions_id': executions_id]))

WebUI.takeScreenshot(reportLocation + '/TC47/Step 48-Click on link insightlyExecution InsightlyExecution.png')

"Step 49: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC47-Verify marking test results in team project executions_visual_checkpoint')
