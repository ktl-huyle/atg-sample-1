...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 4-Click on div failedTests FailedC17094.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 5-Click on link TestResult - Navigate to page teamprojectexecutionstest-result.png')
...
WebUI.takeScreenshot(reportLocation + '/TC125/Step 6-Click on item YogiyoBaseDeleteCart.png')

"Step 7: Click on item SketchtoolLocationPage -> Navigate to page ''"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*/test-result/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_executions_test_result/item_SketchtoolLocationPage'))

WebUI.takeScreenshot(reportLocation + '/TC125/Step 7-Click on item SketchtoolLocationPage - Navigate to page .png')

"Step 8: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC125-Review Failed Test Results and Verify Home Page_visual_checkpoint')
