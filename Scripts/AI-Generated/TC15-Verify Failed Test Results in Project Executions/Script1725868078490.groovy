...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 4-Click on div failedC2841VerifyIfSyncToPsaisSuccessful.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 5-Click on div infoSidebarHeaderCloseButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC15/Step 6-Click on div failedC3190VerifyCreateAndDeleteClientsUi - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC15-Verify Failed Test Results in Project Executions_visual_checkpoint')
