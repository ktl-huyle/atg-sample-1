...
"Step 4: Click on link dynamicObject (UntitledTestRun) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_dynamicObject', ['team_id': team_id, 'plan_id': plan_id, 'project_id': project_id]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 4-Click on link dynamicObject UntitledTestRun - Navigate to page teamprojectgridplanjob.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_execution', ['link_execution_internalRoleLinkName': link_execution_internalRoleLinkName, 'team_id': team_id_1, 'project_id': project_id_1, 'executions_id': executions_id]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 5-Click on link execution execution - Navigate to page teamprojectexecutions.png')
...
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_2', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName, 'team_id': team_id_2, 'plan_id': plan_id_1, 'job_id': job_id, 'project_id': project_id_2]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 6-Click on link executionDetails JobLink - Navigate to page teamprojectgridplanjob.png')
...
"Step 10: Click on div testRunItems (testRunItems7)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 10-Click on div testRunItems testRunItems7.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 13-Click on div thumbnailItems - Navigate to page teamprojecttest-runs.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 18-Click on link testProjects testProjects3 - Navigate to page teamprojecttest-project.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 22-Click on div testCases testCases2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 25-Click on div TestCaseSummary.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 35-Click on div TestSuitesAPI.png')

"Step 36: Click on button Save2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/button_Save2_1'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 36-Click on button Save2.png')
...
"Step 39: Click on div testRunItems (testRunItems8)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 39-Click on div testRunItems testRunItems8.png')

"Step 40: Click on div testRunItems (testRunItems9)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 40-Click on div testRunItems testRunItems9.png')
...
"Step 46: Click on div testRunItems (testRunItems9)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 46-Click on div testRunItems testRunItems9.png')

"Step 47: Click on div testRunItems (testRunItems9)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 47-Click on div testRunItems testRunItems9.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 54-Click on image TestResult.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 55-Click on image TestResult.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 56-Click on image TestResult.png')
...
"Step 59: Click on div testRunItems (testRunItems10)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 59-Click on div testRunItems testRunItems10.png')
...
"Step 62: Click on div testRunItems (testRunItems10)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 62-Click on div testRunItems testRunItems10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 63-Click on header testRun testRun.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 64-Click on header testRun testRun.png')

"Step 65: Click on div testRunItems (testRunItems10)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 65-Click on div testRunItems testRunItems10.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 67-Click on div thumbnailItems thumbnailItems2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 72-Click on span logItems logItems2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 74-Click on div thumbnailItems dynamicObject.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 84-Click on div TestSuitesAPI.png')

"Step 85: Click on button Save2"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/test-runs?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_team_project_test_runs/button_Save2_1'))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 85-Click on button Save2.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 87-Click on header testRun testRun2.png')

"Step 88: Click on div testRunItems (testRunItems11)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 88-Click on div testRunItems testRunItems11.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 89-Click on button closeActions closeActions3.png')
...
"Step 91: Click on div testRunItems (testRunItems12)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 91-Click on div testRunItems testRunItems12.png')
...
"Step 94: Click on div testRunItems (testRunItems12)"
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 94-Click on div testRunItems testRunItems12.png')
...
"Step 97: Click on link dynamicObject (dynamicObject) -> Navigate to page 'team/*/project/*/grid/plan/*/job'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/grid?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid/link_dynamicObject"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid/link_dynamicObject', ['team_id': team_id_4, 'plan_id': plan_id_2, 'project_id': project_id_4]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 97-Click on link dynamicObject dynamicObject - Navigate to page teamprojectgridplanjob.png')
...
WebUI.takeScreenshot(reportLocation + '/TC24/Step 98-Click on div TestPlanJob.png')
...
// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_execution"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_grid_plan_job/link_execution', ['link_execution_internalRoleLinkName': link_execution_internalRoleLinkName_1, 'team_id': team_id_5, 'project_id': project_id_5, 'executions_id': executions_id_1]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 99-Click on link execution execution2 - Navigate to page teamprojectexecutions.png')

"Step 100: Click on link executionDetails (executionDetails5) -> Navigate to page 'team/*/project/*/grid/plan/*/job/*'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/team/.*/project/.*/executions/.*?/?(?:#.*)?(?:\\?.*)?$', true)

// Bind values to the variables in the locators of "AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_2"
WebUI.enhancedClick(findTestObject('AI-Generated/Dynamic Objects/Page_team_project_executions/link_executionDetails_2', ['link_executionDetails_internalRoleLinkName': link_executionDetails_internalRoleLinkName_1, 'team_id': team_id_6, 'plan_id': plan_id_3, 'job_id': job_id_1, 'project_id': project_id_6]))

WebUI.takeScreenshot(reportLocation + '/TC24/Step 100-Click on link executionDetails executionDetails5 - Navigate to page teamprojectgridplanjob.png')

"Step 101: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC24-Navigate Team Project Grid and Verify Page_visual_checkpoint')
